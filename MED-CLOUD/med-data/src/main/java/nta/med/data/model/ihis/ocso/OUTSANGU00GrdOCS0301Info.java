...
public class OUTSANGU00GrdOCS0301Info {
	...
	public OUTSANGU00GrdOCS0301Info(String memb, Double pkSeq, String yaksokGubun, String yaksokGubunName,
			String yaksokCode, String yaksokName, String inputTab, String pkYaksok, String inputTabName) {
		super();
		this.memb = memb;
		this.pkSeq = pkSeq;

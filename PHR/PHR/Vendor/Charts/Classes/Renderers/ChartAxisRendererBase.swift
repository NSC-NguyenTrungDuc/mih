...
public class ChartAxisRendererBase: ChartRendererBase
{
    ...
    /// Draws the rangeView belonging to the axis.
    public func renderRangeView(context context: CGContext)
    {
        fatalError("renderRangeView() cannot be called on ChartAxisRendererBase")
    }

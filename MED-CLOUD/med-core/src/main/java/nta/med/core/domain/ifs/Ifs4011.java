...
/**
 * The persistent class for the IFS4011 database table.
 * 
 */
@Entity
@NamedQuery(name="Ifs4011.findAll", query="SELECT i FROM Ifs4011 i")
public class Ifs4011 extends BaseEntity {
	...
	public double getFkifs3014() {
		return this.fkifs3014;
	}

	public void setFkifs3014(double fkifs3014) {
		this.fkifs3014 = fkifs3014;
	}
	...
	public double getPkifs4011() {
		return this.pkifs4011;
	}

	public void setPkifs4011(double pkifs4011) {
		this.pkifs4011 = pkifs4011;
	}

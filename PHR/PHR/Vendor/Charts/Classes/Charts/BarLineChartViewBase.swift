...
public class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    /// Quytm add to make Highlight Click
    public var circleHighlightColor: UIColor = UIColor.whiteColor()
    public var clickCircleHighlightColor: Bool = true
    ...
    public override func drawRect(rect: CGRect)
    {
        ...
        /// @QuyTM : Add to call function: Draw a rectangle base on [min] and [max] value and [color] depend on Axis's value
        _leftYAxisRenderer?.renderRangeView(context: context)
        _rightYAxisRenderer?.renderRangeView(context: context)

...
/**
 * The persistent class for the ADM9595 database table.
 * 
 */
@Entity
@NamedQuery(name="Adm9595.findAll", query="SELECT a FROM Adm9595 a")
public class Adm9595 extends BaseEntity {

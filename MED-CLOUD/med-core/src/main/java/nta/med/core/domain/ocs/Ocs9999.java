...
/**
 * The persistent class for the OCS9999 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs9999.findAll", query="SELECT o FROM Ocs9999 o")
public class Ocs9999 extends BaseEntity {

...
/**
 * The persistent class for the PHY8002 database table.
 * 
 */
@Entity
@Table(name="PHY8002")
public class Phy8002 extends BaseEntity {
	...
	private Date crTime;
	private String disuseAdl;
	private String disuseContents;
	private Double disuseFimbi;
	private String disuseGasyou;
	private String disuseKainyu;
	private String disuseKaizen;
	...
	private Date syujyutubi;
	private String taboo;
	private String tantoui;
	private Date updDate;
	private String userId;
	private Date yoinSindanDate;
	private Date yoinStartDate;
	...
	@Column(name="DISUSE_ADL")
	public String getDisuseAdl() {
		return this.disuseAdl;
	}

	public void setDisuseAdl(String disuseAdl) {
		this.disuseAdl = disuseAdl;
	}


	@Column(name="DISUSE_CONTENTS")
	public String getDisuseContents() {
		return this.disuseContents;
	}

	public void setDisuseContents(String disuseContents) {
		this.disuseContents = disuseContents;
	}


	@Column(name="DISUSE_FIMBI")
	public Double getDisuseFimbi() {
		return this.disuseFimbi;
	}

	public void setDisuseFimbi(Double disuseFimbi) {
		this.disuseFimbi = disuseFimbi;
	}


	@Column(name="DISUSE_GASYOU")
	public String getDisuseGasyou() {
		return this.disuseGasyou;
	}

	public void setDisuseGasyou(String disuseGasyou) {
		this.disuseGasyou = disuseGasyou;
	}


	@Column(name="DISUSE_KAINYU")
	public String getDisuseKainyu() {
		return this.disuseKainyu;
	}

	public void setDisuseKainyu(String disuseKainyu) {
		this.disuseKainyu = disuseKainyu;
	}


	@Column(name="DISUSE_KAIZEN")
	public String getDisuseKaizen() {
		return this.disuseKaizen;
	}

	public void setDisuseKaizen(String disuseKaizen) {
		this.disuseKaizen = disuseKaizen;
	}
	...
	public Double getImageSeq() {
		return this.imageSeq;
	}

	public void setImageSeq(Double imageSeq) {
	...
	@Column(name="KE_FLAG")
	public String getKeFlag() {
		return this.keFlag;
	}

	public void setKeFlag(String keFlag) {
		this.keFlag = keFlag;
	}
	...
	@Temporal(TemporalType.TIMESTAMP)
	public Date getKyuseizouakubi() {
		return this.kyuseizouakubi;
	}

	public void setKyuseizouakubi(Date kyuseizouakubi) {
	...
	public Double getPkphy8002() {
		return this.pkphy8002;
	}

	public void setPkphy8002(Double pkphy8002) {
		this.pkphy8002 = pkphy8002;
	}
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name="SYUJYUTUBI")
	public Date getSyujyutubi() {
		return this.syujyutubi;
	}

	public void setSyujyutubi(Date syujyutubi) {
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name="YOIN_SINDAN_DATE")
	public Date getYoinSindanDate() {
		return this.yoinSindanDate;
	}

	public void setYoinSindanDate(Date yoinSindanDate) {
		this.yoinSindanDate = yoinSindanDate;
	}


	@Temporal(TemporalType.TIMESTAMP)
	@Column(name="YOIN_START_DATE")
	public Date getYoinStartDate() {
		return this.yoinStartDate;
	}

	public void setYoinStartDate(Date yoinStartDate) {
		this.yoinStartDate = yoinStartDate;
	}

...
public class INPBATCHTRANSlayOut0101Info {
	...
	public INPBATCHTRANSlayOut0101Info(String suname, String suname2, String birth, String tel, String sex, Integer age,
			String ifValidYn) {
		super();
		this.suname = suname;

...
import nta.med.service.ihis.proto.NuriServiceProto.NUR1123U00grdMasterRequest;

@Service                                                                                                          
@Scope("prototype")
public class NUR1123U00grdMasterHandler extends ScreenHandler<NuriServiceProto.NUR1123U00grdMasterRequest, SystemServiceProto.ComboResponse> {                     
	...
	public ComboResponse handle(Vertx vertx, String clientId, String sessionId, long contextId,
			NUR1123U00grdMasterRequest request) throws Exception {
		...
		if(!CollectionUtils.isEmpty(listInfo)){
			for (Nur0102 nur0102 : listInfo) {
				CommonModelProto.ComboListItemInfo.Builder info = CommonModelProto.ComboListItemInfo.newBuilder()
						.setCode(nur0102.getCode() == null ? "" : nur0102.getCode())

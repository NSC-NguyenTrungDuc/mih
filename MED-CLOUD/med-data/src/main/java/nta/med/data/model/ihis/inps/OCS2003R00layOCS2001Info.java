...
public class OCS2003R00layOCS2001Info {
	...
	public OCS2003R00layOCS2001Info(String juSangYn, String sangCode, Double ser, String disSangName,
			Date sangStartDate, Date sangEndDate, String sangEndSayu, String sangName, String preModifierName,
			String postModifierName, String endYn) {
		super();

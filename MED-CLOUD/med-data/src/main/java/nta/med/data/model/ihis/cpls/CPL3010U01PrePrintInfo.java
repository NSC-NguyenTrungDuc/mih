...
public class CPL3010U01PrePrintInfo {
	...
	private String nyoRyang        ;
	private String nyoDanui        ;
	private String emergencyYn     ;
	public CPL3010U01PrePrintInfo(String partJubsuDate, String bunho,
			String suname2, String hangmogCode, String hangmogName,
			String specimenName, String gwaName, String doctorName, String sex,
			Integer age, String specimenSer, String nyoRyang, String nyoDanui,
			String emergencyYn) {
		super();
		...
		this.nyoRyang = nyoRyang;
		this.nyoDanui = nyoDanui;
	...
	public String getNyoRyang() {
		return nyoRyang;
	}
	public void setNyoRyang(String nyoRyang) {
		this.nyoRyang = nyoRyang;
	}
	public String getNyoDanui() {
		return nyoDanui;
	}
	public void setNyoDanui(String nyoDanui) {
		this.nyoDanui = nyoDanui;
	}

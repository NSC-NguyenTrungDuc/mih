...
import nta.med.service.ihis.proto.PhysServiceProto.PHY8002U00GrdQueryRequest;
...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class PHY8002U00GrdQueryHandler
	extends ScreenHandler<PhysServiceProto.PHY8002U00GrdQueryRequest, PhysServiceProto.PHY8002U00GrdQueryResponse> {                     
	@Resource                                                                                                       
	...
	public PHY8002U00GrdQueryResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId, PHY8002U00GrdQueryRequest request)
			throws Exception {                                                                   
  	   	PhysServiceProto.PHY8002U00GrdQueryResponse.Builder response = PhysServiceProto.PHY8002U00GrdQueryResponse.newBuilder();                      
		List<Ocs0132> listItem = ocs0132Repository.getByCodeType(getHospitalCode(vertx, sessionId), getLanguage(vertx, sessionId), request.getCodeType());

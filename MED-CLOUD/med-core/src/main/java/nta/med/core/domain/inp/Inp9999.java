...
/**
 * The persistent class for the INP9999 database table.
 * 
 */
@Entity
@NamedQuery(name="Inp9999.findAll", query="SELECT i FROM Inp9999 i")
public class Inp9999 extends BaseEntity {

...
public class OCS6010U10PopupMAgrdOCS2016Info {
	...
	public OCS6010U10PopupMAgrdOCS2016Info(Double fkocs2015, Double pkocs2016, Double seq, String hangmogCode,
			Double suryang, Double nalsu, String ordDanui, String bogyongCode, String jusaCode, String jusaSpdGubun,
			Double dv, String dvTime, Double bomSourceKey, String bomYn, String hangmogName, Double fkocs2003) {
		super();

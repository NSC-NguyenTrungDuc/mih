package nta.med.ext.phr.restful;

import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.jaxrs.json.JacksonJsonProvider;
import com.fasterxml.jackson.jaxrs.xml.JacksonXMLProvider;
import nta.med.common.glossary.Lifecyclet;
import nta.med.ext.phr.restful.support.CORSResponseFilter;
 ...
 * @author dainguyen
 */
public class PhrApplication extends Lifecyclet {

	private static final Log LOGGER = LogFactory.getLog(PhrApplication.class);
    ...
    public PhrApplication(String baseUri, boolean useSsl, String env, String sslPassword) {
    ...
    protected void doStart() throws Exception {
        ...
        server = startServer();
        LOGGER.info(String.format("Phr restful app started with WADL available at %sapplication.wadl", baseUri));
    }
    ...
    final class XResourceConfig extends ResourceConfig {
        ...
        public XResourceConfig() {
            ...
            packages("nta.med.ext.phr.restful");
           // packages("org.glassfish.jersey.examples.multipart");
            property(ServerProperties.METAINF_SERVICES_LOOKUP_DISABLE, true);
            property("contextConfigLocation", "classpath:/META-INF/spring/spring-master-phr.xml");

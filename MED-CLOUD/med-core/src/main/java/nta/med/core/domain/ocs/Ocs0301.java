...
/**
 * The persistent class for the OCS0301 database table.
 * 
 */
@Entity
@Table(name="OCS0301")
public class Ocs0301 extends BaseEntity {
	...
	@Column(name="YAKSOK_NAME")
	public String getYaksokName() {
		return this.yaksokName;
	}
	...
	@Column(name="YAKSOK_REMARK")
	public String getYaksokRemark() {
		return this.yaksokRemark;
	}

	public void setYaksokRemark(String yaksokRemark) {
		this.yaksokRemark = yaksokRemark;
	}

...
- (void)awakeFromNib
{
    ...
    self.cellBottomLabel.font = [UIFont boldSystemFontOfSize:16.0f];
    self.cellBottomLabel.textColor = [UIColor colorWithRed:110.0f/255.0f green:190.0f/255.0f blue:227.0f/255.0f alpha:1];

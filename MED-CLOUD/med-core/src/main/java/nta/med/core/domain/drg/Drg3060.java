...
/**
 * The persistent class for the DRG3060 database table.
 * 
 */
@Entity
@Table(name = "DRG3060")
public class Drg3060 extends BaseEntity {
	...
	public Double getPkocs3060() {
		return this.pkocs3060;
	}

	public void setPkocs3060(Double pkocs3060) {
		this.pkocs3060 = pkocs3060;
	}

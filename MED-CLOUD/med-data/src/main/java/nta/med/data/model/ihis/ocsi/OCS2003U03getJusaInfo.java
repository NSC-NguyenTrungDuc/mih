...
public class OCS2003U03getJusaInfo {
	...
	private String subulDanuiNam;
	private String jusaName;
	private String bogyongName;
	private String jusaNalsu;
	private String dataGubun;
	private String hodongOrdName;
	private String key;
	private String maxBannabYn;
	private String bannabYn;
	private String fkocs2003;

	public OCS2003U03getJusaInfo(String jaeryoCode, String nalsu, String divide, String orderSuryang,
			String subulSuryang, String ordSuryang, String orderDanui, String subulDanui, String bunryu1,
			String bunryu2, String bunryu3, String bunryu4, String remark, String dvTime, String dv, String bunryu6,
			String mixGroup, String dv1, String dv2, String dv3, String dv4, String dv5, String hubalChangeYn,
			String pharmacy, String jusaSpdGubun, String drgPackYn, String jusa, String jaeryoName, String danuiName,
			String subulDanuiNam, String jusaName, String bogyongName, String jusaNalsu, String dataGubun,
			String hodongOrdName, String key, String maxBannabYn, String bannabYn, String fkocs2003) {
		super();
		...
		this.subulDanuiNam = subulDanuiNam;
		this.jusaName = jusaName;
		this.bogyongName = bogyongName;
		this.jusaNalsu = jusaNalsu;
	...
	public String getSubulDanuiNam() {
		return subulDanuiNam;
	}

	public void setSubulDanuiNam(String subulDanuiNam) {
		this.subulDanuiNam = subulDanuiNam;
	}
	...
	public String getJusaNalsu() {
		return jusaNalsu;
	}

	public void setJusaNalsu(String jusaNalsu) {
		this.jusaNalsu = jusaNalsu;
	}
	...
	public String getFkocs2003() {
		return fkocs2003;
	}

	public void setFkocs2003(String fkocs2003) {
		this.fkocs2003 = fkocs2003;
	}

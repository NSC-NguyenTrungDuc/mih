...
public class OCS6010U10frmDirectActinggrdOCS2015Info {
	...
	public OCS6010U10frmDirectActinggrdOCS2015Info(String bunho, Double fkinp1001, Date orderDate, String inputGubun,
			String inputId, Double pkSeq, Double seq, Date actDate, String actId, String userNm, String actResultCode,
			String actResultText, Double pkocs2015, String inputGwa, String inputDoctor, String updDate,
			String dataRowState) {
		super();
		this.bunho = bunho;

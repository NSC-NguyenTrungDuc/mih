...
namespace ORCA
{
    public class HealthInsuranceModuleItem
    {
        ...
        private List<PublicHeathInsuranceItemInfo> _publicHealthInsuranceItem;
        ...
        public List<PublicHeathInsuranceItemInfo> PublicHeathInsuranceItem
        {
        ...
        {
            _publicHealthInsuranceItem = new List<PublicHeathInsuranceItemInfo>();
        }
    }
}

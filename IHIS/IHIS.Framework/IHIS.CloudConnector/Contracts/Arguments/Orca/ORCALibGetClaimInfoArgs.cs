...
{[Serializable]
    public class ORCALibGetClaimInfoArgs : IContractArgs
    {
    protected bool Equals(ORCALibGetClaimInfoArgs other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((ORCALibGetClaimInfoArgs) obj);
    }
    ...
    private String _hospCode;
        ...
        public ORCALibGetClaimInfoArgs() { }

        public ORCALibGetClaimInfoArgs(String hospCode, String fkoif1101)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORCALibGetClaimInfoRequest();
        }
    }
}
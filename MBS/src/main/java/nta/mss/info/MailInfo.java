...
public class MailInfo implements Serializable{
	...
	/** The link survey and quick Movie talk */
	private String QuicklinkMovieTalk;
	private String Linksurvey;
	
	private String dieaseName;
	private String statusOfDisease;
	private String latestGoTime;
	...
	public String getLatestGoTime() {
		return latestGoTime;
	}

	public void setLatestGoTime(String latestGoTime) {
		this.latestGoTime = latestGoTime;
	}
	...
	public String getQuicklinkMovieTalk() {
		return QuicklinkMovieTalk;
	}

	public void setQuicklinkMovieTalk(String quicklinkMovieTalk) {
		QuicklinkMovieTalk = quicklinkMovieTalk;
	}

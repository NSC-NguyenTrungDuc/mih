...
/**
 * The persistent class for the OCS2053 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs2053.findAll", query="SELECT o FROM Ocs2053 o")
public class Ocs2053 extends BaseEntity {

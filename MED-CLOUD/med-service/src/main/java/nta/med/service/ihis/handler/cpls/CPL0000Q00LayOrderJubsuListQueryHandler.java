...
import nta.med.service.ihis.proto.CplsServiceProto.CPL0000Q00LayOrderJubsuListQueryRequest;
...
@Service
@Scope("prototype")
public class CPL0000Q00LayOrderJubsuListQueryHandler  extends ScreenHandler<CplsServiceProto.CPL0000Q00LayOrderJubsuListQueryRequest, CplsServiceProto.CPL0000Q00LayOrderResponse> {
	private static final Log LOG = LogFactory.getLog(CPL0000Q00LayOrderJubsuListQueryHandler.class);
	@Resource
	...
	public CPL0000Q00LayOrderResponse handle(Vertx vertx, String clientId,
			...
			CPL0000Q00LayOrderJubsuListQueryRequest request) throws Exception {
		CplsServiceProto.CPL0000Q00LayOrderResponse.Builder response = CplsServiceProto.CPL0000Q00LayOrderResponse.newBuilder();
        List<CPL0000Q00LayOrderListItemInfo> listItem = cpl2010Repository.getCPL0000Q00LayOrderJubsuList(getHospitalCode(vertx, sessionId), getLanguage(vertx, sessionId), request.getBunho());

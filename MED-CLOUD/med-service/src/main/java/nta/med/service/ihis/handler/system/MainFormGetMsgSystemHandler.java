...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class MainFormGetMsgSystemHandler extends ScreenHandler<SystemServiceProto.MainFormGetMsgSystemRequest, SystemServiceProto.MainFormGetMsgSystemResponse>{                     
	private static final Log LOGGER = LogFactory.getLog(MainFormGetMsgSystemHandler.class);                                    
	@Resource                                                                                                       
	private Adm0100Repository adm0100Repository;                                                                    

	@Override
	@Transactional(readOnly = true)
	public SystemServiceProto.MainFormGetMsgSystemResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId,
			SystemServiceProto.MainFormGetMsgSystemRequest request) throws Exception {
		SystemServiceProto.MainFormGetMsgSystemResponse.Builder response = SystemServiceProto.MainFormGetMsgSystemResponse.newBuilder();

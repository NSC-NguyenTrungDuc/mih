 ...
 * @author vnc.tuyen
 */
public class INP1003U00grdInpReserInfo {
    ...
    private String ipwonRtnName;
    private String tel1;
    private String tel2;
    private String reserEndType;
    private String susulReserYn;
    private String remark;
    private String pkinp1003;
    private String junpyoDate;
    private String hoDong;
    private String bedNo;
    private String ipwonMokjuk;
    private String reserFkinp1001;
    private String ipwonsiOrderYn;
    private String jisiDoctor;
    private String jisiDoctorName;
    private String sangBigo;
    private String sogyeYn;
    private String hopeRoom;
    private String userId;
    
	public INP1003U00grdInpReserInfo(String reserDate, String bunho, String suname, String gwa, String gwaName,
			String hoCode, String doctor, String doctorName, String ipwonRtn2, String ipwonRtnName, String tel1,
			String tel2, String reserEndType, String susulReserYn, String remark, String pkinp1003, String junpyoDate,
			String hoDong, String bedNo, String ipwonMokjuk, String reserFkinp1001, String ipwonsiOrderYn,
			String jisiDoctor, String jisiDoctorName, String sangBigo, String sogyeYn, String hopeRoom, String userId) {
		super();
		...
		this.ipwonRtnName = ipwonRtnName;
		this.tel1 = tel1;
		this.tel2 = tel2;
		...
		this.jisiDoctorName = jisiDoctorName;
	...
	public String getIpwonRtnName() {
		return ipwonRtnName;
	}
	public void setIpwonRtnName(String ipwonRtnName) {
		this.ipwonRtnName = ipwonRtnName;
	}
	...
	public String getPkinp1003() {
		return pkinp1003;
	}
	public void setPkinp1003(String pkinp1003) {
		this.pkinp1003 = pkinp1003;
	}
	public String getJunpyoDate() {
		return junpyoDate;
	}
	public void setJunpyoDate(String junpyoDate) {
		this.junpyoDate = junpyoDate;
	}
	...
	public String getReserFkinp1001() {
		return reserFkinp1001;
	}
	public void setReserFkinp1001(String reserFkinp1001) {
		this.reserFkinp1001 = reserFkinp1001;
	}
	...
	public String getJisiDoctorName() {
		return jisiDoctorName;
	}
	public void setJisiDoctorName(String jisiDoctorName) {
		this.jisiDoctorName = jisiDoctorName;
	}

...
@interface StandardFoodAddViewController : Base2ViewController <MDTabBarDelegate, PHRSliderDelegate>
...
@property (assign, nonatomic) FoodType addContentType;
@property (nonatomic,copy) void(^AddCallBack)(FoodType selectedType);

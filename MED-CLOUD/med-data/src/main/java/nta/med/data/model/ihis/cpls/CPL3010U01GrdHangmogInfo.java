...
public class CPL3010U01GrdHangmogInfo {
	...
	public CPL3010U01GrdHangmogInfo(String recodeGubun, String centerCode,
			String requestKey, String hospitalCode, String hangmogCode,
			String sanCode, String specimenCode, String emergency,
			String emptyString, String specimenSer, String jundalGubunName,
			String gumsaName, String specimenName) {
		super();

...
/**
 * The persistent class for the IFS3014 database table.
 * 
 */
@Entity
@NamedQuery(name="Ifs3014.findAll", query="SELECT i FROM Ifs3014 i")
public class Ifs3014 extends BaseEntity {
	...
	public double getPkifs3014() {
		return this.pkifs3014;
	}

	public void setPkifs3014(double pkifs3014) {
		this.pkifs3014 = pkifs3014;
	}

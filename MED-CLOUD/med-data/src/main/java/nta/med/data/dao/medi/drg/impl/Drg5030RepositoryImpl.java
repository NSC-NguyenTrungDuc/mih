...
import nta.med.data.dao.medi.drg.Drg5030RepositoryCustom;

/**
 * @author dainguyen.
 */
public class Drg5030RepositoryImpl implements Drg5030RepositoryCustom {
private static final Log LOG = LogFactory.getLog(Drg5010RepositoryImpl.class);
	...
	public Double callPrJihDrgDrg5030Insert(String hospitalCode, Date jubsuDate, String drgBunho, String dataDubun, String inOutGubun, String bunho, Integer fk) {
		StoredProcedureQuery  query = entityManager.createStoredProcedureQuery("PR_JIH_INJ_DRG5030_INSERT");

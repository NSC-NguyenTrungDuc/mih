...
{
    public class ORDERTRANSAPIReTransferOrdersArgs : IContractArgs
    {
        ...
        public ORDERTRANSAPIReTransferOrdersArgs() { }

        public ORDERTRANSAPIReTransferOrdersArgs(String bunho, String pkout1001, String performDate, String orcaIp, String orcaPort, String orcaUser, String orcaPassword, List<ORDERTRANSAPIHangmogInfo> hangmogItem)
        {
            this._bunho = bunho;
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORDERTRANSAPIReTransferOrdersRequest();
        }
    }
}
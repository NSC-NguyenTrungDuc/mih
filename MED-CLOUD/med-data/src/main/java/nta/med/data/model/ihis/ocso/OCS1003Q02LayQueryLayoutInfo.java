...
public class OCS1003Q02LayQueryLayoutInfo {
    ...
    private String powerCheck ;
    private String imsiDrugYn ;
    private String orderByKey;
	public OCS1003Q02LayQueryLayoutInfo(Double inOutKey, Double pkocskey,
			String bunho, String orderDate, String gwa, String doctor,
			String resident, String naewonType, Double jubsuNo, String inputId,
			...
			String actingTime, Double actingDay, String resultDate,
			String dcGubun, String dcYn, String bannabYn, String bannabConfirm,
			Double sourceOrdKey, String ocsFlag, String sgCode, Date sgYmd,
			String ioGubun, String afterActYn, String bichiYn, Double drgBunho,
			String subSusul, String printYn, String chisik, String telYn,
			String orderGubunBas, String inputControl, String sugaYn,
			String jaeryoYn, String wonyoiCheck, String emergencyCheck,
			String specimenCheck, String portableYn2, String bulyongCheck,
			String sunabCheck, String dcCheck, String dcGubunCheck,
			String confirmCheck, String reserYnCheck, String chisikYn,
			String ndayYn, String defaultJaeryoJundalYn,
			...
			String regularYn, Double sortFkocskey, String childYn,
			String ifInputControl, String slipName, Double orgKey,
			Double parentKey, String bunCode, Double dv5, Double dv6,
			Double dv7, Double dv8, String wonnaeDrgYn,
			String hubalChangeCheck, String drgPackCheck, String pharmacyCheck,
			String powerCheck, String imsiDrugYn, String orderByKey) {
		super();
	...
	public String getPowerCheck() {
		return powerCheck;
	}
	public void setPowerCheck(String powerCheck) {
		this.powerCheck = powerCheck;
	}

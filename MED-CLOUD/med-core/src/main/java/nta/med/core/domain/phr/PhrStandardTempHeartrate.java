...
/**
 * The persistent class for the phr_standard_temp_heartrate database table.
 * 
 */
@Entity
@Table(name="PHR_STANDARD_TEMP_HEARTRATE")
@NamedQuery(name="PhrStandardTempHeartrate.findAll", query="SELECT p FROM PhrStandardTempHeartrate p")
public class PhrStandardTempHeartrate extends PhrBaseEntity implements Serializable {
	...
	public PhrStandardTempHeartrate() {
	}

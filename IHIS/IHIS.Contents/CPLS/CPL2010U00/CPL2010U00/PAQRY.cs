...
namespace IHIS.CPLS
{
	...
	public class PAQRY : IHIS.Framework.XForm
	{
		...
		public PAQRY(string aOrderDate, string aJubsuYn)
		{
            ...
            if (aJubsuYn == "Y")
            {
                lbTitle.Text = Resources.TEXT8;
                lbTitle.ForeColor = new XColor(Color.Crimson);
            }
            else
            {
                lbTitle.Text = Resources.TEXT9;
		...
		private void InitializeComponent()
		{
            ...
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Query, System.Windows.Forms.Shortcut.F5, global::IHIS.CPLS.Properties.Resources.TEXT5, -1, global::IHIS.CPLS.Properties.Resources.TEXT5),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Process, System.Windows.Forms.Shortcut.F12, global::IHIS.CPLS.Properties.Resources.TEXT10, -1, "HotPink"),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Close, System.Windows.Forms.Shortcut.None, global::IHIS.CPLS.Properties.Resources.TEXT5, -1, global::IHIS.CPLS.Properties.Resources.TEXT5)});

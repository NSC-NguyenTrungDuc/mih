...
public class NavigationItem {
	...
	private boolean hideOnKcck;
	private boolean notIsMovieTalk;	
	...
	public NavigationItem(NavigationItem item) {
		...
		this.hideOnKcck = item.hideOnKcck;
		this.notIsMovieTalk = item.notIsMovieTalk;
	}
	
	public boolean isNotIsMovieTalk() {
		return notIsMovieTalk;
	}

	public void setNotIsMovieTalk(boolean notIsMovieTalk) {
		this.notIsMovieTalk = notIsMovieTalk;
	}

	public boolean isHideOnKcck() {
		return hideOnKcck;
	}

	public void setHideOnKcck(boolean hideOnKcck) {
		this.hideOnKcck = hideOnKcck;
	}

		...
		<div class="row">
            ...
            <div class="col-md-5 col-xs-offset-4">
            	<div class="error-page" align="center">  
                    ...
                    <h2 class="error-type">500<span><spring:message code="general.error.500.msg"/></span></h2>   
                    
                    <p class="error-reason"><spring:message code="general.error.500.error.reason"/><br /><a href="<c:url value='/booking-manage/search-booking' />" ><spring:message code="general.error.500.home.page"/></a><spring:message code="general.error.500.go.our"/><a href="javascript:history.back()"><spring:message code="general.error.500.previours"/></a><spring:message code="general.error.500.go.previours"/></p>     
                </div>                                
            </div>
		</div>
	</div>

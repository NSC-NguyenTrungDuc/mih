...
namespace IHIS.BASS
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class IFS0003U03 : IHIS.Framework.XScreen
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IFS0003U03));
            ...
            this.dbxSearchGubunName.Font = null;
            ...
            this.xDateMapGubunYmd.Font = null;
        ...
        private void fbxSearchGubun_FindClick(object sender, CancelEventArgs e)
        {
            ...
            switch (control.Name)
            {
                case "fbxSearchGubun":
                    ...
                    this.fwkCommon.SetBindVarValue("f_code_type", "MAP_GUBUN_JIH");
                    break;
            }
        }
...
//                                               AND A.CODE        = :f_code ";
                    ...
                    this.layCommon.SetBindVarValue("f_code_type", "MAP_GUBUN_JIH");
                ...
                case FunctionType.Update:
                    ...
                    if (!TypeCheck.IsNull(res.MapGubun + res.MapGubunYmd))
                    {
                        XMessageBox.Show(Properties.Resources.MSG1 + res.MapGubun + Properties.Resources.MSG2 +
                                         Properties.Resources.MSG3 + res.MapGubunYmd + Properties.Resources.MSG4 +
                                        Properties.Resources.MSG5, Properties.Resources.MSGCAP1, MessageBoxIcon.Warning);
                        return;
                    }
                    ...
                    if (res.ExecutionStatus == ExecutionStatus.Success && res.Result)
                    {
                        ...
                        this.mCap = Properties.Resources.MSGCAP2;
                        XMessageBox.Show(this.mMsg, this.mCap, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    else
                    {
                        ...
                        if (Service.ErrFullMsg == "")
                        {
                            string mesg = Properties.Resources.MSG7;
                            this.mMsg = this.mCheck + mesg;
...
//        {
//            IFS0003U03 parent = null;

//            public XSavePeformer(IFS0003U03 parent)
//            {
//                this.parent = parent;
//            }

...
import nta.med.data.dao.phr.StandardHealthBfpRepositoryCustom;
import nta.med.data.model.phr.HealthBfpInfo;

public class StandardHealthBfpRepositoryImpl implements StandardHealthBfpRepositoryCustom {

	@PersistenceContext
	private EntityManager entityManager;
	
	@Override
	public List<HealthBfpInfo> getPhrStandardHealthBfpByprofileIdAndType(Long profileId, Long durationType) {
		
		StringBuilder sql = new StringBuilder();
		sql.append("     SELECT                                                                                                                                             ");
		sql.append("       A.ID,                                                                                                                                            ");
		sql.append("       A.DATETIME_RECORD DATETIME_RECORD,                                                      	                                                        ");
		sql.append("      AVG(A.PERC_FAT),                                                                                                                                      ");
		sql.append("       A.NOTE,                                                                                                                                          ");
		...
		sql.append("      COUNT(A.PERC_FAT)                                                                                           											");
		sql.append("     FROM PHR_STANDARD_HEALTH_BFP A                                                                                                                  	");
...
//				sql.append("             )                                                                                                                                  ");
		...
		List<HealthBfpInfo> standardHealthHeights = new JpaResultMapper().list(query, HealthBfpInfo.class);

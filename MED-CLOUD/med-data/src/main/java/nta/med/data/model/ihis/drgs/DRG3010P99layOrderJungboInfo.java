...
public class DRG3010P99layOrderJungboInfo {
	private String seq1;
	private String seq2;
	...
	public DRG3010P99layOrderJungboInfo(String seq1, String seq2, String text1, String text2, String text3, String remark, String barDrgBunho, String bunho){
		this.seq1 = seq1;
		this.seq2 = seq2;
		this.text1 = text1;
		this.text2 = text2;

...
public enum MailCode {
	...
	/** The booking new online completed. */
	BOOKING_NEW_ONLINE_COMPLETED("BOOKING_NEW_ONLINE_COMPLETED"),
	
	/** The booking new online completed no link survey. */
	BOOKING_NEW_ONLINE_COMPLETED_1("BOOKING_NEW_ONLINE_COMPLETED_1"),

...
public class Ocs3003Q10GrdSangListItemInfo {
	...
	public Ocs3003Q10GrdSangListItemInfo(String juSangYn, String sangCode,
			String gwaName, Double ser, String disSangName, Date sangStartDate,
			Date sangEndDate, String sangEndSayuName, String sangEndSayu,
			String bunho, Date naewonDate, String gwa, String doctor,
			String naewonType, Double jubsuNo, Double pkOrder, String sangName,
			String preModifier1, String preModifier2, String preModifier3,
			String preModifier4, String preModifier5, String preModifier6,
			String preModifier7, String preModifier8, String preModifier9,
			String preModifier10, String preModifierName, String postModifier1,
			String postModifier2, String postModifier3, String postModifier4,
			String postModifier5, String postModifier6, String postModifier7,
			String postModifier8, String postModifier9, String postModifier10,
			String postModifierName, Date sangJindanDate, String endYn,
			String orderByKey) {
		super();

...
- (void)awakeFromNib
{
    ...
    [self.loadButton setTitle:kLocalizedString(@"load_earlier_messages") forState:UIControlStateNormal];
    [self.loadButton setTitleColor:[UIColor redColor] forState:UIControlStateNormal];

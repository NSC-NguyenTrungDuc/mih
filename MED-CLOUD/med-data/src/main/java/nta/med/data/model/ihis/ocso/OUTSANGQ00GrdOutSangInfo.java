...
public class OUTSANGQ00GrdOutSangInfo {
	...
	public OUTSANGQ00GrdOutSangInfo(String bunho, String gwa, String gwaName,
			String ioGubun, Double pkSeq, Date naewonDate, String doctor,
			String naewonType, Double jubsuNo, Double fkinp1001,
			String inputId, String sangCode, String sangName,
			String disSangName, String juSangYn, Date sangStartDate,
			Date sangEndDate, String sangEndSayu, String sangEndSayuName,
			Double ser, String preModifier1, String preModifier2,
			String preModifier3, String preModifier4, String preModifier5,
			String preModifier6, String preModifier7, String preModifier8,
			String preModifier9, String preModifier10, String preModifierName,
			String postModifier1, String postModifier2, String postModifier3,
			String postModifier4, String postModifier5, String postModifier6,
			String postModifier7, String postModifier8, String postModifier9,
			String postModifier10, String postModifierName, String selected,
			Double pkoutsang, Date sangJindanDate, String contKey) {
		super();
		this.bunho = bunho;
		this.gwa = gwa;

...
@Service                                                                                                          
@Scope("prototype")
public class NUR6011U01grdNur6012CopyHandler extends ScreenHandler<NuriServiceProto.NUR6011U01grdNur6012CopyRequest, NuriServiceProto.NUR6011U01grdNur6012Response> {   
	...
	public NuriServiceProto.NUR6011U01grdNur6012Response handle(Vertx vertx, String clientId, String sessionId, long contextId,
			NuriServiceProto.NUR6011U01grdNur6012CopyRequest request) throws Exception {
		...
		List<NUR6011U01grdNur6012Info> result = nur6012Repository.getNUR6011U01grdNur6012Info(hospCode, request.getBunho(), request.getFromDate(),
				request.getBedsoreBuwi(), request.getAssessorDate(), startNum, offset, true);

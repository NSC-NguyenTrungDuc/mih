...
public class FindPatientInfo {
    ...
    private String lastCommingDate;
    private String ipwonYn;
    private String treatmentArea;
    private String tel;
	public FindPatientInfo(String patientCode, String patientName,
			String patientName2, String sex, String birth,
			String lastCommingDate, String ipwonYn, String treatmentArea,
			String tel) {
		super();
	...
	public String getLastCommingDate() {
		return lastCommingDate;
	}
	public void setLastCommingDate(String lastCommingDate) {
		this.lastCommingDate = lastCommingDate;
	}

...
public class NUR1020Q00grdPalistInfo {
	...
	public NUR1020Q00grdPalistInfo(String hoCode, String bunho, String suName, Double pkinp1001, String ageSex,
			Date ipwonDate, String doctorName) {
		super();
		this.hoCode = hoCode;
		this.bunho = bunho;
		this.suName = suName;

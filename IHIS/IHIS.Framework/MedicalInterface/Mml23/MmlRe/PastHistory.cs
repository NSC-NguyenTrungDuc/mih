...
namespace IHIS.Framework.Mml23.MmlRe
{
    public class PastHistory
    {
        ...
        public PastHistory(XmlNode node)
        {
            ExRef = new List<ExternalReference>();
        ...
        private void LoadFromXml(XmlNode node)
        {
            ...
            //XmlNode subnode = node.SelectSingleNode("mmlRe:pastHistory", nsmgr);
        ...
        {
            XmlElement node = doc.CreateElement(NameSpacePrefix, "pastHistory", NameSpaceURI);

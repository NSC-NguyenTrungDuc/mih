...
/**
 * The persistent class for the OCS1053 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs1053.findAll", query="SELECT o FROM Ocs1053 o")
public class Ocs1053 extends BaseEntity {

...
namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U44 : Form
    {
            ...
            : this()
        {
            ...
            this.bunho = patientModelInfo.PatientId;
            InitGrdViewer(mml, patientModelInfo, dicCommentInfo);
            /*DataProvider.Instance.TagDisplayModeSetup(barTagOptions);#1#
            LoadCboDisplayTag();*/
            LoadFormOCS2015U44(mml, record_id, patientModelInfo, dicCommentInfo);
        }
        ...
        private void btnSaveEmrRecordn_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.txtComment.Text.Trim()))
            {
                ...
                lbError.Text = Resources.CONTENT_BLANK_WARN;
            ...
            string emailFlg = chkSentMail.Checked ? "1" : "0";
            ...
            string recordLog = txtComment.Text.Trim();
            ...
            /*args.Metadata = this.ucGrid.GetDicCommentInfo(true);*/

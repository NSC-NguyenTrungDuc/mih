...
import nta.med.service.ihis.proto.OcsaServiceProto.OCS0103U14FormLoadRequest;
import nta.med.service.ihis.proto.OcsaServiceProto.OCS0103U14FormLoadResponse;
...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class OCS0103U14FormLoadHandler 
	extends ScreenHandler<OcsaServiceProto.OCS0103U14FormLoadRequest, OcsaServiceProto.OCS0103U14FormLoadResponse> {                     
	private static final Log LOGGER = LogFactory.getLog(OCS0103U14FormLoadHandler.class);                                    
	@Resource                                                                                                       
	...
	public OCS0103U14FormLoadResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId, OCS0103U14FormLoadRequest request)
			throws Exception {                                                                 
  	   	OcsaServiceProto.OCS0103U14FormLoadResponse.Builder response = OcsaServiceProto.OCS0103U14FormLoadResponse.newBuilder();                      
		...
		if(!CollectionUtils.isEmpty(listUserTab)){
			for(LoadOftenUsedTabResponseInfo item : listUserTab){
				...
				response.addLoadOfterUsedTabResponseInfo(info);
			}
		}

...
/**
 * The persistent class for the IFS3031 database table.
 * 
 */
@Entity
@NamedQuery(name="Ifs3031.findAll", query="SELECT i FROM Ifs3031 i")
public class Ifs3031 extends BaseEntity {
	...
	public double getPkifs3031() {
		return this.pkifs3031;
	}

	public void setPkifs3031(double pkifs3031) {
		this.pkifs3031 = pkifs3031;
	}

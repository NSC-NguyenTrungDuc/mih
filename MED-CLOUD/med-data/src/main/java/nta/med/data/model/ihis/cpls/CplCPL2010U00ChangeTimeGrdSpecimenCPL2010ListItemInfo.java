...
public class CplCPL2010U00ChangeTimeGrdSpecimenCPL2010ListItemInfo {
	...
	public CplCPL2010U00ChangeTimeGrdSpecimenCPL2010ListItemInfo(
			Double pkcpl2010, String sunabYn, String jubsuFlag,
			String slipName, String hangmogCode, String gumsaName,
			String specimenCode, String specimenName, String emergency,
			String tubeName, String specimenSer, String commentJuCode,
			Double fkocs1003, String groupGubun, String partJubsuFlag,
			String gumJubsuFlag, String dummy, String modifyYn,
			String modifyYn1, String jundalGubun, String jubsuja,
			Date orderDate, String bunho, Date jubsuDate, String jubsuTime,
			String orderTime) {
		super();

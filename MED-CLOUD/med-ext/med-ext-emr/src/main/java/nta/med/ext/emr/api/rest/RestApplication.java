package nta.med.ext.emr.api.rest;
 ...
 * @author dainguyen.
 */
public class RestApplication extends AbstractApplication<String, String> {
    ...
    protected void doStart() throws Exception {
        ...
        server = startServer();
        LOGGER.info(String.format("Emrapi rest app started with WADL available at %sapplication.wadl", baseUri));
    }
    ...
    public HttpServer startServer() {
        ...
        sslCon.setKeyStoreFile(String.format("%s/cert/emrapi-%s.jks", System.getProperty("configPath"), env));
    ...
    @Override
    protected String verifyAuthorization(String sessionId) {
        return null;
    }
    ...
    final class XResourceConfig extends ResourceConfig {
        ...
        public XResourceConfig() {
            ...
            packages("nta.med.ext.emr");

            property(ServerProperties.METAINF_SERVICES_LOOKUP_DISABLE, true);
            //property("contextConfigLocation", "classpath:/META-INF/spring/spring-master-emr.xml");

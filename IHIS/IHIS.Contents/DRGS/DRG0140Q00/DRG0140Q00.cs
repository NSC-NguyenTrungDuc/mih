...
{
    /// <summary>
    /// DRG0140Q00에 대한 요약 설명입니다.
    /// </summary>
    [ToolboxItem(false)]
    public class DRG0140Q00 : IHIS.Framework.XScreen
    {
        ...
        public DRG0140Q00()
        {
            ...
            //set ParamList
            grdDetail.ParamList = new List<string>(new String[] { "f_code" });
        ...
        private List<object[]> LoadDataGrdDetail(BindVarCollection bc)
        {
            ...
            DRG0140U00GrdDetailResult result = CloudService.Instance.Submit<DRG0140U00GrdDetailResult, DRG0140U00GrdDetailArgs>(args);
            if (result != null)
            {
                foreach (DRG0140U00GrdDetailInfo item in result.GrdDetailItem)
                {
                    object[] objects = 
				{ 
					item.Code, 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DRG0140Q00));
            ...
            this.xEditGridCell1.CellWidth = 97;
            ...
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Process, System.Windows.Forms.Shortcut.F2, global::IHIS.DRGS.Properties.Resources.Btn_Text, 0, "HotPink"),
            ...
            this.grdDetail.RowHeaderBackColor = IHIS.Framework.XColor.XDisplayBoxGradientEndColor;
            ...
            this.xEditGridCell5.HeaderGradientEnd = IHIS.Framework.XColor.XGridSelectedCellBackColor;
            ...
            this.xEditGridCell6.CellWidth = 250;
            this.xEditGridCell6.Col = 2;
            this.xEditGridCell6.ExecuteQuery = null;
            this.xEditGridCell6.HeaderGradientEnd = IHIS.Framework.XColor.XGridSelectedCellBackColor;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!TypeCheck.IsNull(OpenParam) && this.OpenParam.Contains("pre_small_code"))
            {
                string code = this.OpenParam["pre_small_code"].ToString();

                for (int i = 0; i < grdMaster.RowCount; i++)
                {
                    if (code == grdMaster.GetItemString(i, "code"))
                    {
        ...
        private void btnList_ButtonClick(object sender, IHIS.Framework.ButtonClickEventArgs e)
        {
            switch (e.Func)
            {
                ...
                case FunctionType.Process:
                    ...
                    commandParams.Add("pre_small_code", grdDetail.GetItemString(grdDetail.CurrentRowNumber, "code"));
                    commandParams.Add("small_code", grdDetail.GetItemString(grdDetail.CurrentRowNumber, "code1"));

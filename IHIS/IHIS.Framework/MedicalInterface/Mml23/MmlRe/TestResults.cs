...
namespace IHIS.Framework.Mml23.MmlRe
{
    public class TestResults
    {
        ...
        public TestResults(XmlNode node)
        {
            ExRef = new List<ExternalReference>();
        ...
        private void LoadFromXml(XmlNode node)
        {
            ...
            //XmlNode subnode = node.SelectSingleNode("mmlRe:testResults", nsmgr);
        ...
        {
            XmlElement node = doc.CreateElement(NameSpacePrefix, "testResults", NameSpaceURI);

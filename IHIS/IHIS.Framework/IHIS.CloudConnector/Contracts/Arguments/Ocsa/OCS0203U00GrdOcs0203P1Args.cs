...
{[Serializable]
    ...
    {
    protected bool Equals(OCS0203U00GrdOcs0203P1Args other)
    {
        return string.Equals(_slipCode, other._slipCode) && string.Equals(_hospCode, other._hospCode) && string.Equals(_memb, other._memb);
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((OCS0203U00GrdOcs0203P1Args) obj);
    }

...
namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U00 : XScreen
    {
        ...
        private void btnENDOResult_Click(object sender, EventArgs e)
        {
            ...
            string serializeData = JsonConvert.SerializeObject(schema, settings);
            List<CustomMarkSchema> data = JsonConvert.DeserializeObject<List<CustomMarkSchema>>(serializeData, settings);
            //XMessageBox.Show(data.ToString());
        }
    }
}

...
/**
 * The persistent class for the IFS8003 database table.
 * 
 */
@Entity
@NamedQuery(name="Ifs8003.findAll", query="SELECT i FROM Ifs8003 i")
public class Ifs8003 extends BaseEntity {
	private static final long serialVersionUID = 1L;
	private String dataKubun;
	private double fkOcsIrai;
	private double fkPhySyoubyou;
	...
	@Column(name="FK_PHY_SYOUBYOU")
	public double getFkPhySyoubyou() {
		return this.fkPhySyoubyou;
	}

	public void setFkPhySyoubyou(double fkPhySyoubyou) {
		this.fkPhySyoubyou = fkPhySyoubyou;
	}
	...
	@Column(name="PK_IFS_SYOUBYOU")
	public double getPkIfsSyoubyou() {
		return this.pkIfsSyoubyou;
	}

	public void setPkIfsSyoubyou(double pkIfsSyoubyou) {
		this.pkIfsSyoubyou = pkIfsSyoubyou;
	}

...
public class OcsCHTAPPROVEgrdAPP1001Info {
	...
	private String sangEndSayuName;
	...
	public OcsCHTAPPROVEgrdAPP1001Info(String bunho, String gwa, String gwaName, String ioGubun, String doctor,
			Double fkinp1001, String inputId, String sangCode, String sangName, String disSangName, String juSangYn,
			String sangStartDate, String sangEndDate, String sangEndSayu, String sangEndSayuName, String preModifier1,
			String preModifier2, String preModifier3, String preModifier4, String preModifier5, String preModifier6,
			String preModifier7, String preModifier8, String preModifier9, String preModifier10, String preModifierName,
			String postModifier1, String postModifier2, String postModifier3, String postModifier4,
			String postModifier5, String postModifier6, String postModifier7, String postModifier8,
			String postModifier9, String postModifier10, String postModifierName, String sangJindanDate,
			String userGubun, String insteadYn, String insteadId, String userNmIns, String insteadDate,
			String insteadTime, String approveYn, String approveId, String userNmApp, String approveDate,
			String approveTime, String postapproveYn, Double pkApp1001, String select, String contKey) {
		super();
		this.bunho = bunho;
		this.gwa = gwa;
		...
		this.sangEndSayuName = sangEndSayuName;
	...
	public String getSangEndSayuName() {
		return sangEndSayuName;
	}

	public void setSangEndSayuName(String sangEndSayuName) {
		this.sangEndSayuName = sangEndSayuName;
	}
	...
	public String getSangJindanDate() {
		return sangJindanDate;
	}

	public void setSangJindanDate(String sangJindanDate) {
		this.sangJindanDate = sangJindanDate;
	}
	...
	public String getUserNmIns() {
		return userNmIns;
	}

	public void setUserNmIns(String userNmIns) {
		this.userNmIns = userNmIns;
	}
	...
	public void setInsteadDate(String insteadDate) {
		this.insteadDate = insteadDate;
	}
	...
	public String getUserNmApp() {
		return userNmApp;
	}

	public void setUserNmApp(String userNmApp) {
		this.userNmApp = userNmApp;
	}

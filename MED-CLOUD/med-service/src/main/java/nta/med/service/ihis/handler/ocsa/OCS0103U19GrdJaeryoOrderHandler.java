...
import nta.med.service.ihis.proto.OcsaServiceProto.OCS0103U19GrdJaeryoOrderRequest;
...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class OCS0103U19GrdJaeryoOrderHandler
	extends ScreenHandler<OcsaServiceProto.OCS0103U19GrdJaeryoOrderRequest, OcsaServiceProto.OCS0103U17LoadJaeryoOrderResponse> {                     
	private static final Log LOGGER = LogFactory.getLog(OCS0103U19GrdJaeryoOrderHandler.class);                                    
	@Resource                                                                                                       
	...
	public OCS0103U17LoadJaeryoOrderResponse handle(Vertx vertx,
			...
			OCS0103U19GrdJaeryoOrderRequest request) throws Exception {                                                                 

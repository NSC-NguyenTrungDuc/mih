...
public class NUR1020U00grdPalistInfo {
	...
	public NUR1020U00grdPalistInfo(String hoCode, String bunho, String suName, Double pkinp1001, String ageSex,
			Date ipwonDate, String doctorName, String cycleOrderGroup) {
		super();
		this.hoCode = hoCode;
		this.bunho = bunho;
		this.suName = suName;

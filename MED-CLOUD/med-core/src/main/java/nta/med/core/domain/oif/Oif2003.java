...
/**
 * The persistent class for the OIF2003 database table.
 * 
 */
@Entity
@NamedQuery(name="Oif2003.findAll", query="SELECT o FROM Oif2003 o")
public class Oif2003 extends BaseEntity {

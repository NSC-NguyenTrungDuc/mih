...
{[Serializable]
    public class ORCALibGetClaimDiagnosisArgs : IContractArgs
    {
    protected bool Equals(ORCALibGetClaimDiagnosisArgs other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((ORCALibGetClaimDiagnosisArgs) obj);
    }
    ...
    private String _hospCode;
        ...
        public ORCALibGetClaimDiagnosisArgs() { }

        public ORCALibGetClaimDiagnosisArgs(String hospCode, String fkoif1101)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORCALibGetClaimDiagnosisRequest();
        }
    }
}
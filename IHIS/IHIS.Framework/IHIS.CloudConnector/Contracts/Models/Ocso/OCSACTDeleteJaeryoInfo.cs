...
namespace IHIS.CloudConnector.Contracts.Models.Ocso
{
    public class OCSACTDeleteJaeryoInfo
    {
        ...
        public OCSACTDeleteJaeryoInfo(String pkinv1001, String fkocsXrt, String fkocsInv, String hangmogCode, String suryang, String nalsu, String ordDanui, String pkocs1003)
        {

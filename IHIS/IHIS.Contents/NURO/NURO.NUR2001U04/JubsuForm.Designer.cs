namespace IHIS.NURO
{
    partial class JubsuForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cboGwa.UserSQL = "SELECT A.GWA, A.GWA_NAME\r\n  FROM BAS0260 A\r\n WHERE A.HOSP_CODE = FN_ADM_LOAD_HOSP" +
                "_CODE()\r\n   AND A.BUSEO_GUBUN = \'1\'\r\n   AND SYSDATE BETWEEN A.START_DATE AND A.E" +
                "ND_DATE\r\n ORDER BY A.GWA";
            ...
            this.cboDoctor.UserSQL = "SELECT A.DOCTOR , A.DOCTOR_NAME \r\n  FROM BAS0270 A\r\n WHERE A.HOSP_CODE = FN_ADM_L" +
                "OAD_HOSP_CODE()\r\n   AND A.DOCTOR_GWA = :f_gwa\r\n   AND SYSDATE BETWEEN A.START_DA" +
                "TE AND A.END_DATE\r\n ORDER BY A.DOCTOR";
            ...
            // btnJubsu
            // 
            this.btnJubsu.Image = global::IHIS.NURO.Properties.Resources.전송_16;
            ...
            // btnClose
            // 
            this.btnClose.Image = global::IHIS.NURO.Properties.Resources.종료;
            ...
            this.cboJubsuGubun.UserSQL = "SELECT CODE, CODE_NAME\r\n  FROM BAS0102 A \r\n WHERE A.HOSP_CODE = FN_ADM_LOAD_HOSP_" +
                "CODE() \r\n AND CODE_TYPE = \'JUBSU_GUBUN\'\r\n ORDER BY CODE ";
            // 
            // dbxJubsu
            // 

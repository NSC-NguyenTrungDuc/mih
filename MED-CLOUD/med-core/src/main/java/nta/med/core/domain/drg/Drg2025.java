...
/**
 * The persistent class for the DRG2025 database table.
 * 
 */
@Entity
@NamedQuery(name="Drg2025.findAll", query="SELECT d FROM Drg2025 d")
public class Drg2025 extends BaseEntity {

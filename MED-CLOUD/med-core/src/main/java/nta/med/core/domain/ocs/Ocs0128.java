...
/**
 * The persistent class for the OCS0128 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs0128.findAll", query="SELECT o FROM Ocs0128 o")
public class Ocs0128 extends BaseEntity {

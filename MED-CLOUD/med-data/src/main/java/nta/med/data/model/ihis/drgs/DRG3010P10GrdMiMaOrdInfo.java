...
public class DRG3010P10GrdMiMaOrdInfo {
	...
	public DRG3010P10GrdMiMaOrdInfo(Date orderDate, String mixGroup, String jaeryoCode, String jaeryoName,
			...
			String suname, String drgBunho, Double fkocs2003, String appendYn, String reUseYn, Date hopeDate,
			String hopeTime, String groupSer, String dcYn, String orderGubun, String ifInputControl,
			String broughtDrgYn) {
		super();

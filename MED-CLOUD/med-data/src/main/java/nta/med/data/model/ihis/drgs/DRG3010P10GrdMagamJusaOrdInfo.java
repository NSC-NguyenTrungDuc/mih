...
public class DRG3010P10GrdMagamJusaOrdInfo {
    private String orderDate;
    private String mixGroup;
    private String jaeryoCode;
    private String jaeryoNa;
	...
	public DRG3010P10GrdMagamJusaOrdInfo(String orderDate, String mixGroup, String jaeryoCode, String jaeryoNa,
			String ordSuryang, String dvTime, String dv, String nalsu, String orderDanui, String danuiName,
			String bogyongCode, String bogyongName, String powderYn, String remark, String dv1, String dv2, String dv3,
			String dv4, String dv5, String hubalChangeYn, String pharmacy, String drgPackYn, String jusaName,
			String suname, String drgBunho, String jubsuDate, String bunho, String hoDong, String hopeDate,
			String groupSer, String dcYn, String orderGubun, String querySeq, String bannabYn, String sourceFkocs2003,
			String fkocs2003) {
		super();
		this.orderDate = orderDate;
		this.mixGroup = mixGroup;
		this.jaeryoCode = jaeryoCode;
		this.jaeryoNa = jaeryoNa;
	...
	public String getJaeryoNa() {
		return jaeryoNa;
	}
	public void setJaeryoNa(String jaeryoNa) {
		this.jaeryoNa = jaeryoNa;
	}

...
@interface StandardFoodDetailViewController : Base2ViewController <MDTabBarDelegate,UITableViewDelegate, UITableViewDataSource, SWTableViewCellDelegate,TopMenuDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
@property (assign, nonatomic) FoodType typeIndex;
...
@property (strong, nonatomic) NSMutableArray<FoodItem*> *arrayTableViewData;

...
public class CPL3010U01GrdResultInfo {
	...
	public CPL3010U01GrdResultInfo(String recodeGubun, String centerCode,
			String requestKey, String hangmogCode, String srlCode,
			String specimenCode, String emergency, String emptyString,
			String specimenSer, String jundalGubunName, String labNo,
			String cplResult, String standardYn, String comments,
			String vitros, String resultYn, String gumsaName,
			String specimenName) {
		super();
		this.recodeGubun = recodeGubun;
	...
	public String getRecodeGubun() {
		return recodeGubun;
	}
	public void setRecodeGubun(String recodeGubun) {
		this.recodeGubun = recodeGubun;
	}

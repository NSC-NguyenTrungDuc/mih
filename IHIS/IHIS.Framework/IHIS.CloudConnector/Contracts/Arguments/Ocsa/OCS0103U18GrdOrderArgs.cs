...
{[Serializable]
	...
	{
    protected bool Equals(OCS0103U18GrdOrderArgs other)
    {
        return string.Equals(_memb, other._memb) && string.Equals(_yaksokCode, other._yaksokCode) && string.Equals(_fkInOutKey, other._fkInOutKey) && string.Equals(_inputTab, other._inputTab) && string.Equals(_inputGubun, other._inputGubun);
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((OCS0103U18GrdOrderArgs) obj);
    }

...
{[Serializable]
	...
	{
    protected bool Equals(OCS0103U19InitializeScreenArgs other)
    {
        return Equals(_userOptionInfo, other._userOptionInfo) && Equals(_orderGubunInfo, other._orderGubunInfo) && Equals(_codeInfo, other._codeInfo) && Equals(_suryangInfo, other._suryangInfo) && Equals(_nalsuInfo, other._nalsuInfo) && string.Equals(_orderMode, other._orderMode) && string.Equals(_userGubun, other._userGubun) && string.Equals(_doctor, other._doctor) && string.Equals(_memb, other._memb) && string.Equals(_doctorId, other._doctorId) && string.Equals(_userId, other._userId) && string.Equals(_inputTab, other._inputTab);
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((OCS0103U19InitializeScreenArgs) obj);
    }
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            int hashCode = (_userOptionInfo != null ? _userOptionInfo.GetHashCode() : 0);
            hashCode = (hashCode*397) ^ (_orderGubunInfo != null ? _orderGubunInfo.GetHashCode() : 0);
            hashCode = (hashCode*397) ^ (_codeInfo != null ? _codeInfo.GetHashCode() : 0);

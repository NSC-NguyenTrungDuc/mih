...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class DRG9001R02Lay9001Handler extends ScreenHandler<DrgsServiceProto.DRG9001R02Lay9001Request, DrgsServiceProto.DRG9001R02Lay9001Response> {
	private static final Log LOGGER = LogFactory.getLog(DRG9001R02Lay9001Handler.class);                                    
	@Resource
	private Res0101Repository res0101Repository;

	@Override
	@Transactional(readOnly = true)
	public DrgsServiceProto.DRG9001R02Lay9001Response handle(Vertx vertx, String clientId, String sessionId, long contextId, DrgsServiceProto.DRG9001R02Lay9001Request request) throws Exception {
		DrgsServiceProto.DRG9001R02Lay9001Response.Builder response = DrgsServiceProto.DRG9001R02Lay9001Response.newBuilder();
			List<DRG9001GetLay9001Info> listLay = res0101Repository.getDRG9001R02GetLay9001Info(getHospitalCode(vertx, sessionId), request.getDate());

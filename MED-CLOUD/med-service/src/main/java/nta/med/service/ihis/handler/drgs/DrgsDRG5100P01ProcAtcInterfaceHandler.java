...
@Scope("prototype")
@Transactional
public class DrgsDRG5100P01ProcAtcInterfaceHandler extends CommonHandler<DrgsServiceProto. DrgsDRG5100P01ProcAtcInterfaceRequest, DrgsServiceProto. DrgsDRG5100P01ProcAtcInterfaceResponse> {
	private static final Log LOG = LogFactory.getLog(DrgsDRG5100P01ProcAtcInterfaceHandler.class);
	...
	@Override
	public DrgsServiceProto.DrgsDRG5100P01ProcAtcInterfaceResponse handle(Vertx vertx, String clientId, String sessionId, long contextId, DrgsServiceProto.DrgsDRG5100P01ProcAtcInterfaceRequest request) throws Exception {
		DrgsServiceProto. DrgsDRG5100P01ProcAtcInterfaceResponse.Builder response = DrgsServiceProto. DrgsDRG5100P01ProcAtcInterfaceResponse.newBuilder();
		...
		Double fkdrg4010 = drgMasterInsert(hospitalCode, jubsuDate, drgBunho, request.getDataDubun(),
					request.getIoGubun(), request.getBunho(), fkout1001);

			if(fkdrg4010.equals(-1D)){
				response.setProcAtcInterface(false);
			}else{
				drg2010Repository.updateDrgsDRG5100P01UpdateFkdrg4010InDRG2010(fkdrg4010, hospitalCode, jubsuDate, drgBunho, request.getBunho());

				DrgsDRG5100P01DrgMasterInsertResponseInfo result = drgProcMain(hospitalCode, request.getIoGubun(),
						fkdrg4010, request.getSendYn(), getLanguage(vertx, sessionId));

				if(result.getoFlag().equals("1")){
					response.setProcAtcInterface(true);
					response.setPkdrg4010(fkdrg4010.toString());
					response.setRtnIfsCnt(result.getoFlag());
				}else{
					response.setProcAtcInterface(false);
				}
			}
	...
	public String ifsPad7101(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7101, "MEDI:IFS7101");
	}
	
	public String ifsPad7102(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7102, "MEDI:IFS7102");
	}
	
	public String ifsPad7103(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7103, "MEDI:IFS7103");
	}
	
	public String ifsPad7104(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7104, "MEDI:IFS7104");
	}
	
	public String ifsPad7106(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7106, "MEDI:IFS7106");
	}
	
	public String ifsPad7107(String column, String dataType, String value){
		return fnIfsPad(column, dataType, value, mapIfs7107, "MEDI:IFS7107");
	}
	...
	public DrgsDRG5100P01DrgMasterInsertResponseInfo drgProcMain(String hospCode, String ioGubun, Double masterPk, String sendYn, String language){
		...
		if(sendYn.equals("Y")){
			...
			if(ioGubun.equals("O")){
				listResult = drg2010Repository.getDrgsDRG5100P01CurDrgOrderInfo(hospCode, language,
	        		masterPk, ioGubun);
			}else if(ioGubun.equals("I")){
				listResult = drg3010Repository.getDrgsDRG5100P01CurDrgOrderInfo(hospCode, language,
		        		masterPk, ioGubun);
			}

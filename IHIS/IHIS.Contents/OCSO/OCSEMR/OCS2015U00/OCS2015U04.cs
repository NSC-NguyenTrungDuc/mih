...
namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U04 : UserControl
    {
        public OCS2015U04()
        {
            InitializeComponent();
        ...
        public event BookmarkEventHandler BookmarkEvent;
        ...
        public void DisplayBookmarkHistory(string recordId, string bunho, List<CommentInfo> listBookmark, string gwa, EmrDocket ctlEmrDocker, string hospCodeRefer)
        {
            tvBunho.Nodes.Clear();
        ...
        private void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            if (tvBunho.SelectedNode.Level == 2)
            {
                ...
                {
                    XMessageBox.Show(_resources.GetString("MSG_WRONG_USER_EDITING"));
                }
            }
        }
        ...
        void frm_CommentUpdated(object sender, CommentEventArgs e)
        {
            if (editingNode.Key != null && editingNode.Value != null)
            {
                ...
                {
                    XMessageBox.Show(_resources.GetString("MSG_COMMENT_LENGTH_INVALID"));
                }
            }
        }
        ...
        private bool SubmitChangedBookMark(string recordId, List<CommentInfo> metaData, TreeNode node, bool removeOnSuccess)
        {
            ...
            if (result.ExecutionStatus == ExecutionStatus.Success)
            {
                if (result.Result)
                {
                    ...
                    {
                        BookmarkEvent(this, new BookmarkEventArgs(node.Tag as CommentInfo, removeOnSuccess));
                    }
                    tvBunho.Refresh();
                    return true;
                }
                XMessageBox.Show(_resources.GetString("MSG_SAVE_FAILED"));
            }
        ...
        ComponentResourceManager _resources = new ComponentResourceManager(typeof(OCS2015U04));

        private void tvBunho_ContextMenuStripChanged(object sender, EventArgs e)
        {
        ...
        private void OCS2015U04_MouseHover(object sender, EventArgs e)
        {
        }

        private void OCS2015U04_MouseMove(object sender, MouseEventArgs e)
        {
        }
    ...
    public class BookmarkEventArgs : EventArgs
    {
        ...
        public BookmarkEventArgs(CommentInfo commentInfoParam, bool removeParam)
        {

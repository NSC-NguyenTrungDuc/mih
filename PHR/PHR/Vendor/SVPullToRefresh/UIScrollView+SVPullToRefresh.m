...
//        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"ひっぱって更新...",),
//                       NSLocalizedString(@"はなして更新...",), //(@"リフレッシュするためにリリース...",),
//                       NSLocalizedString(@"お待ちください...",),
//                       nil];
        self.titles = [NSMutableArray arrayWithObjects:kLocalizedString(kPullToRefresh),kLocalizedString(kReleaseToRefresh),kLocalizedString(kLoading), nil];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = NSLocalizedString(@"ひっぱって更新...",);

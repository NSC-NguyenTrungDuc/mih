...
- (void)jsq_configureTextView
{
    ...
    CGFloat cornerRadius = 18.0f;
    //TungNT
    self.backgroundColor = [UIColor colorWithRed:199.0f/255.0f green:237.0f/255.0f blue:255.0f/255.0f alpha:1];
    self.layer.cornerRadius = cornerRadius;
    
    self.scrollIndicatorInsets = UIEdgeInsetsMake(cornerRadius, 0.0f, cornerRadius, 0.0f);
    
    self.textContainerInset = UIEdgeInsetsMake(7.0f, 10.0f, 5.0f, 10.0f);
    ...
    _placeHolder = nil;
    _placeHolderTextColor = PHR_COLOR_GRAY;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([self.text length] == 0 && self.placeHolder) {
        ...
        [self.placeHolder drawInRect:CGRectInset(rect, 15.0f, 8.0f)

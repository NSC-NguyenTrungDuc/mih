...
{
    public class OCSACTGroupedPatientAndOrderArgs : IContractArgs
    {
        ...
        public OCSACTGroupedPatientAndOrderArgs() { }

        public OCSACTGroupedPatientAndOrderArgs(String cboSystem, String cboVal, String cboPart, String fromDate, String toDate, String bunho, String actGubun, String jundalTableCode, String ioGubun, String systemId)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.OCSACTGroupedPatientAndOrderRequest();
        }
    }
}
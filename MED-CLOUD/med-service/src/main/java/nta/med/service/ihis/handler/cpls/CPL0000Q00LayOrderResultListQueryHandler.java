...
import nta.med.service.ihis.proto.CplsServiceProto.CPL0000Q00LayOrderResultListQueryRequest;
...
@Service
@Scope("prototype")
public class CPL0000Q00LayOrderResultListQueryHandler extends ScreenHandler<CPL0000Q00LayOrderResultListQueryRequest, CPL0000Q00LayOrderResponse> {
	@Resource
	...
	public CPL0000Q00LayOrderResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId, CPL0000Q00LayOrderResultListQueryRequest request)
					throws Exception {
        CPL0000Q00LayOrderResponse.Builder response = CPL0000Q00LayOrderResponse.newBuilder();
        List<CPL0000Q00LayOrderListItemInfo> listItem = cpl2010Repository.getCPL0000Q00LayOrderResultList(getHospitalCode(vertx, sessionId), getLanguage(vertx, sessionId), request.getBunho());

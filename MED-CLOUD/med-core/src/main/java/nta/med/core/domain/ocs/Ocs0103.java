...
/**
 * The persistent class for the OCS0103 database table.
 * 
 */
@Entity
@NamedQuery(name = "Ocs0103.findAll", query = "SELECT o FROM Ocs0103 o")
@Table(name = "OCS0103")
public class Ocs0103 extends BaseEntity {

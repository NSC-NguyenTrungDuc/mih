...
public class INPORDERTRANSSelectListSQL0AfterTransInfo {
	...
	public INPORDERTRANSSelectListSQL0AfterTransInfo(Double pkinp1001, String bunho, String suname, Date ipwonDate,
			String ipwonTime, String gwa, String doctor, String gwaName, String doctorName, String hoDong,
			String hoCode, String gubun, Date orderDate, Date actingDate, Double pkinp3010, Date sendDate,
			String toiwonYn) {
		super();

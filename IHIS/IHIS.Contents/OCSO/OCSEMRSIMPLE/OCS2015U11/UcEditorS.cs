...
namespace EmrDocker
{
    public partial class UcEditorS : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UcEditorS(IMainScreen main_screen)
            : this()
        {
        ...
        public void VisiableAllCtrl(bool value)
        {
            ...
            btnInsertPdfItem.Enabled = value;
            btnInsertImage.Enabled = value;
            btnAddComment.Enabled = value;
        ...
        {
            cboTempl2.Location = new Point(4, 3);
            cboTempl2.Size = new Size(90, 21);

            cboDisplay1.Location = new Point(103, 3);
            cboDisplay1.Size = new Size(90, 21);

            btnInsertPdfItem.Location = new Point(201, 3);
            btnInsertPdfItem.Size = new Size(27, 21);

            btnInsertImage.Location = new Point(233, 3);
            btnInsertImage.Size = new Size(27, 21);

            btnAddComment.Location = new Point(266, 3);
            btnAddComment.Size = new Size(27, 21);

            btnPrint.Location = new Point(299, 3);
            btnPrint.Size = new Size(27, 21);
        }
        #endregion

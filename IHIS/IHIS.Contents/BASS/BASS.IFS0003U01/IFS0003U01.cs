...
{
    /// <summary>
    /// IFS0003U01에 대한 요약 설명입니다.
    /// </summary>
    [ToolboxItem(false)]
    public class IFS0003U01 : IHIS.Framework.XScreen
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IFS0003U01));
            ...
            this.Name = "IFS0003U01";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.IFS0003U01_Closing);
            this.Load += new System.EventHandler(this.IFS0003U01_Load);
        ...
        private void IFS0003U01_Load(object sender, EventArgs e)
        {
        ...
        private void fbxSearchGubun_FindClick(object sender, CancelEventArgs e)
        {
            ...
            switch (control.Name)
            {
                case "fbxSearchGubun":
                    ...
                    this.fwkCommon.SetBindVarValue("f_code_type", "MAP_GUBUN_RHM");
                    break;
            }
        }
...
//                                               AND A.CODE        = :f_code ";
                    ...
                    this.layCommon.SetBindVarValue("f_code_type", "MAP_GUBUN_RHM");
...
//                    ocsCommon.SetBindVarValue("f_code", this.grdIFS0003.GetItemString(e.RowNumber, "ocs_code"));
        ...
        private void btnList_ButtonClick(object sender, IHIS.Framework.ButtonClickEventArgs e)
        {
            ...
            switch (e.Func)
            {
                case FunctionType.Update:
                    ...
                    {
                        XMessageBox.Show(Properties.Resources.MSG1 + res.MapGubun + Properties.Resources.MSG2
                                          + res.MapGubunYmd + Properties.Resources.MSG3 , "注意", MessageBoxIcon.Warning);
                        return;
                    }
        ...
        private void IFS0003U01_Closing(object sender, CancelEventArgs e)
        {
...
//        {
//            IFS0003U01 parent = null;

//            public XSavePeformer(IFS0003U01 parent)
//            {
//                this.parent = parent;
//            }

...
/**
 * The persistent class for the OCS6007 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs6007.findAll", query="SELECT o FROM Ocs6007 o")
public class Ocs6007 extends BaseEntity {

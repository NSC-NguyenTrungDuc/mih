...
namespace IHIS.NURO
{
    public partial class JubsuForm : XForm
    {
        ...
        string bunho = "";
        string naewonDate = "";
        private string[] msgOrca = { "00", "K1", "K2", "K3" };
    
        public JubsuForm(string pkout1001, string bunho, string naewonDate)
        {
        ...
        private void btnJubsu_Click(object sender, EventArgs e)
        {
            ...
            args.Bunho = this.bunho;
            args.NaewonDate = this.naewonDate;

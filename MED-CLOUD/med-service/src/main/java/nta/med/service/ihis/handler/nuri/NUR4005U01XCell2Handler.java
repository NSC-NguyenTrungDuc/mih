...
import nta.med.service.ihis.proto.NuriServiceProto.NUR4005U01XCell2Request;
import nta.med.service.ihis.proto.SystemServiceProto;
import nta.med.service.ihis.proto.SystemServiceProto.ComboResponse;

@Service
@Scope("prototype")
public class NUR4005U01XCell2Handler
		extends ScreenHandler<NuriServiceProto.NUR4005U01XCell2Request, SystemServiceProto.ComboResponse> {
	...
	public ComboResponse handle(Vertx vertx, String clientId, String sessionId, long contextId,
			NUR4005U01XCell2Request request) throws Exception {
		...
		List<Nur0102> items = nur0102Repository.findByCodeTypeLanguage(getHospitalCode(vertx, sessionId),
				"NUR_PLAN_EVAL_GUBUN", getLanguage(vertx, sessionId));

...
public class DRG9001R03lay9001RTest extends MessageRequestTest {
    @Test
    public void testDrgsDRG5100P01DsvOrderPrint() throws InterruptedException {
    	DrgsServiceProto.DRG9001R03lay9001RRequest request = DrgsServiceProto.DRG9001R03lay9001RRequest.newBuilder()
    			.setDate("201210")
    			.setHoDong("1")
                .build();

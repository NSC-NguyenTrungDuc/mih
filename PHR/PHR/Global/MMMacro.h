...
#define IS_IPHONE_6 ([[UIScreen mainScreen] nativeBounds].size.height/[[UIScreen mainScreen] nativeScale]) == 667.0f
...
#define MovieTalkManager [MovieTalkConnectionManager sharedInstance]

...
namespace IHIS.CPLS
{
    ...
    public class PicForm : System.Windows.Forms.Form
    {
        ...
        public PicForm(IntPtr dibhandp)
        {
            ...
            Gdip.UploadFile(TempFileName, bmpptr, pixptr);

            SCANUPLOADER.CreateImageFile(ImageHelper.GetImage(TempFileName));
        ...
        private void InitializeComponent()
        {
            ...
            // menuItemUpload
            // 
            this.menuItemUpload.Index = 4;
            this.menuItemUpload.Text = "upload image";
            ...
            this.MinimumSize = new System.Drawing.Size(96, 86);
            this.Name = "PicForm";
            this.Opacity = 0;

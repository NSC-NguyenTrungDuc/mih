...
namespace IHIS.Framework.Mml23.MmlRe
{
    public class Remarks
    {
        ...
        private void LoadFromXml(XmlNode node)
        {
            ...
            //XmlNode subnode = node.SelectSingleNode("mmlRe:remarks", nsmgr);
        ...
        {
            XmlElement node = doc.CreateElement(NameSpacePrefix, "remarks", NameSpaceURI);

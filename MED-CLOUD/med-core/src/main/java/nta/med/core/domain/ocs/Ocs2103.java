...
/**
 * The persistent class for the OCS2103 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs2103.findAll", query="SELECT o FROM Ocs2103 o")
public class Ocs2103 extends BaseEntity {

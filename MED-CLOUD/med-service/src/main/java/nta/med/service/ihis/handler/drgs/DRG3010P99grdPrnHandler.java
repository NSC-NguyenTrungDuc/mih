...
@Service
@Scope("prototype")
public class DRG3010P99grdPrnHandler extends ScreenHandler<DrgsServiceProto.DRG3010P99grdPrnRequest, DrgsServiceProto.DRG3010P99grdPrnResponse>{
	...
	public DrgsServiceProto.DRG3010P99grdPrnResponse handle(Vertx vertx, String clientId, String sessionId, long contextId,
			DrgsServiceProto.DRG3010P99grdPrnRequest request) throws Exception{
		
		DrgsServiceProto.DRG3010P99grdPrnResponse.Builder response = DrgsServiceProto.DRG3010P99grdPrnResponse.newBuilder();
		...
		if(!CollectionUtils.isEmpty(result)){
			for(DRG3010P99grdPrnJusaInfo item : result){
				DrgsModelProto.DRG3010P99grdPrnInfo.Builder info = DrgsModelProto.DRG3010P99grdPrnInfo.newBuilder();
				BeanUtils.copyProperties(item, info, language);
				response.addListGrdprn(info);
			}
		}

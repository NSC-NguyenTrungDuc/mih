...
namespace IHIS.Framework.Mml23.MmlRe
{
    public class FamilyHistory
    {
        ...
        public FamilyHistory(XmlNode node)
        {
            ExRef = new List<ExternalReference>();
        ...
        private void LoadFromXml(XmlNode node)
        {
            ...
            //XmlNode subnode = node.SelectSingleNode("mmlRe:familyHistory", nsmgr);
        ...
        {
            XmlElement node = doc.CreateElement(NameSpacePrefix, "familyHistory", NameSpaceURI);

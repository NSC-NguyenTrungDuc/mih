...
{
    public class ORDERTRANSAPISendDiseaseArgs : IContractArgs
    {
        ...
        public ORDERTRANSAPISendDiseaseArgs() { }

        public ORDERTRANSAPISendDiseaseArgs(String bunho, String pkout1001, String performDate, String orcaIp, String orcaPort, String orcaUser, String orcaPassword)
        {
            this._bunho = bunho;
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORDERTRANSAPISendDiseaseRequest();
        }
    }
}
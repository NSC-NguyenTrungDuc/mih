...
/**
 * The persistent class for the DOC2011 database table.
 * 
 */
@Entity
@NamedQuery(name="Doc2011.findAll", query="SELECT d FROM Doc2011 d")
public class Doc2011 extends BaseEntity {
	...
	public double getPkdoc2011() {
		return this.pkdoc2011;
	}

	public void setPkdoc2011(double pkdoc2011) {
		this.pkdoc2011 = pkdoc2011;
	}

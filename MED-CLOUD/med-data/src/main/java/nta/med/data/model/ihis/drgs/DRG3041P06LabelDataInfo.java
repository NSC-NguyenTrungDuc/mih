...
public class DRG3041P06LabelDataInfo {
	...
	private String cnt;
	public DRG3041P06LabelDataInfo(String bunho, String drgBunho, String orderDateText, String jubsuDate,
			String orderDate, String serialV, String serialText, String suname, String suname2, String sexAge,
			String hoCode, String hoDong, String bogyongName, String cnt) {
		super();
		this.bunho = bunho;

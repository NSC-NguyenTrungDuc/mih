...
public class OCS0301U00LayoutInfo {
	...
	private String defaultJaeryoJundalYn;
	...
	public OCS0301U00LayoutInfo(Double inOutKey, Double pkocskey, String bunho,
			String orderDate, String gwa, String doctor, String resident,
			String naewonType, String jubsuNo, String inputId,
			String inputPart, String inputGwa, String inputDoctor,
			String inputGubun, String inputGubunName, Double groupSer,
			String inputTab, String inputTabName, String orderGubun,
			String orderGubunName, String groupYn, Double seq, String slipCode,
			String hangmogCode, String hangmogName, String specimenCode,
			String specimenName, Double suryang, Double sunabSuryang,
			Double subulSuryang, String ordDanui, String ordDanuiName,
			String dvTime, Double dv, Double dv1, Double dv2, Double dv3,
			Double dv4, Double nalsu, String sunabNalsu, String jusa,
			String jusaName, String jusaSpdGubun, String bogyongCode,
			String bogyongName, String emergency, String jaeryoJundalYn,
			String jundalTable, String jundalPart, String movePart,
			String portableYn, String powderYn, String hubalChangeYn,
			String pharmacy, String drgPackYn, String muhyo, String prnYn,
			String toiwonDrgYn, String prnNurse, String appendYn,
			String orderRemark, String nurseRemark, String comments,
			String mixGroup, Double amt, String pay, String wonyoiOrderYn,
			String dangilGumsaOrderYn, String dangilGumsaResultYn,
			String bomOccurYn, Double bomSourceKey, String displayYn,
			String sunabYn, String sunabDate, String sunabTime,
			String hopeDate, String hopeTime, String nurseConfirmUser,
			String nurseConfirmDate, String nurseConfirmTime,
			String nursePickupUser, String nursePickupDate,
			String nursePickupTime, String nurseHoldUser, String nurseHoldDate,
			String nurseHoldTime, String reserDate, String reserTime,
			String jubsuDate, String jubsuTime, String actingDate,
			String actingTime, String actingDay, String resultDate,
			String dcGubun, String dcYn, String bannabYn, String bannabConfirm,
			String sourceOrdKey, String ocsFlag, String sgCode,
			Timestamp sgYmd, String ioGubun, String afterActYn, String bichiYn,
			String drgBunho, String subSusul, String printYn, String chisik,
			String telYn, String orderGubunBas, String inputControl,
			String sugaYn, String jaeryoYn, String wonyoiCheck,
			String emergencyCheck, String specimenCheck, String portableYn2,
			String bulyongCheck, String sunabCheck, String dcCheck,
			String dcGubunCheck, String confirmCheck, String reserYnCheck,
			String chisikYn, String ndayYn, String defaultJaeryoJundalYn,
			String defaultWonyoiYn, String specificComment,
			String specificCommentName, String specificCommentSysId,
			String specificCommentPgmId, String specificCommentNotNull,
			String specificCommentTableId, String specificCommentColId,
			String donbogYn, String orderGubunBasName, String actDoctor,
			String actBuseo, String actGwa, String homeCareYn,
			String regularYn, String sortFkocskey, String childYn,
			String ifInputControl, String slipName, Double orgKey,
			Double parentKey, String bunCode, String memb, String yaksokCode,
			String wonnaeDrgYn, String hubalChangeCheck, String drgPackCheck,
			String pharmacyCheck, String powderCheck, String jundalTableOut,
			String jundalPartOut, String jundalTableInp, String jundalPartInp,
			String movePartOut, String movePartInp, Double dv5, Double dv6,
			Double dv7, Double dv8, String generalDispYn, String orderByKey) {
		super();
		...
		this.ndayYn = ndayYn;
		this.defaultJaeryoJundalYn = defaultJaeryoJundalYn;
		...
		this.orderGubunBasName = orderGubunBasName;
	...
	public String getActingDay() {
		return actingDay;
	}
	public void setActingDay(String actingDay) {
		this.actingDay = actingDay;
	}
	...
	public String getSourceOrdKey() {
		return sourceOrdKey;
	}
	public void setSourceOrdKey(String sourceOrdKey) {
		this.sourceOrdKey = sourceOrdKey;
	}
	...
	public Timestamp getSgYmd() {
		return sgYmd;
	}
	public void setSgYmd(Timestamp sgYmd) {
		this.sgYmd = sgYmd;
	}
	...
	public String getDefaultJaeryoJundalYn() {
		return defaultJaeryoJundalYn;
	}
	public void setDefaultJaeryoJundalYn(String defaultJaeryoJundalYn) {
		this.defaultJaeryoJundalYn = defaultJaeryoJundalYn;
	}
	...
	public String getOrderGubunBasName() {
		return orderGubunBasName;
	}
	public void setOrderGubunBasName(String orderGubunBasName) {
		this.orderGubunBasName = orderGubunBasName;
	}
	...
	public String getSortFkocskey() {
		return sortFkocskey;
	}
	public void setSortFkocskey(String sortFkocskey) {
		this.sortFkocskey = sortFkocskey;
	}

...
/**
 * The persistent class for the CPL2010 database table.
 * 
 */
@Entity
@NamedQuery(name="Cpl2010.findAll", query="SELECT c FROM Cpl2010 c")
@Table(name = "CPL2010")
public class Cpl2010 extends BaseEntity {

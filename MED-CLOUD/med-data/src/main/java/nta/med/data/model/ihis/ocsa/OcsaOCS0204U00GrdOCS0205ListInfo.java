...
public class OcsaOCS0204U00GrdOCS0205ListInfo {
	...
	public OcsaOCS0204U00GrdOCS0205ListInfo(Double pkSeq, String memb,
			String sangGubun, String sangCode, String disSangName, Double ser,
			String sangName, String preModifier1, String preModifier2,
			...
			String postModifier10, String postModifierName) {
		super();
		this.pkSeq = pkSeq;
		this.memb = memb;

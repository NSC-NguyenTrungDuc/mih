...
public class DRG3010P10GrdJusaDcOrderInfo {
	...
	public DRG3010P10GrdJusaDcOrderInfo(String orderDate, String mixGroup, String jaeryoCode, String jaeryoName,
			...
			String suname, String drgBunho, String fkocs2003, String appendYn, String reUseYn, String hopeDate,
			String hopeTime, String groupSer, String dcYn, String orderGubun, String ifInputControl, String bannabYn,
			String decodeRes) {
		super();
	...
	public void setDecodeRes(String decodeRes) {
		this.decodeRes = decodeRes;
	}

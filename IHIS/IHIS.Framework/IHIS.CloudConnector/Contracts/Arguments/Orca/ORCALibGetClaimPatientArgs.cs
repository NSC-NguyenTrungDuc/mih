...
{[Serializable]
    public class ORCALibGetClaimPatientArgs : IContractArgs
    {
    protected bool Equals(ORCALibGetClaimPatientArgs other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((ORCALibGetClaimPatientArgs) obj);
    }
    ...
    private String _hospCode;
        ...
        public ORCALibGetClaimPatientArgs() { }

        public ORCALibGetClaimPatientArgs(String hospCode, String fkoif1101)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORCALibGetClaimPatientRequest();
        }
    }
}
...
import nta.med.service.ihis.proto.SchsServiceProto.SchsSCH0201Q01ReserListCboRequest;
import nta.med.service.ihis.proto.SchsServiceProto.SchsSCH0201Q01ReserListCboResponse;
...
@Service
@Scope("prototype")
public class SchsSCH0201Q01ReserListCboHandler
	extends ScreenHandler<SchsServiceProto.SchsSCH0201Q01ReserListCboRequest, SchsServiceProto.SchsSCH0201Q01ReserListCboResponse>{
	@Resource
	private Sch0201Repository sch0201Repository;

	@Override
	@Transactional(readOnly=true)
	public SchsSCH0201Q01ReserListCboResponse handle(Vertx vertx,
			String clientId, String sessionId, long contextId,
			SchsSCH0201Q01ReserListCboRequest request) throws Exception {
		 SchsServiceProto.SchsSCH0201Q01ReserListCboResponse.Builder response =  SchsServiceProto.SchsSCH0201Q01ReserListCboResponse.newBuilder();
		 String hospCode = getHospitalCode(vertx, sessionId);
		 if(request.getIsSelectedGumsa()){
			 List<ComboListItemInfo> listCombo=sch0201Repository.getSchsSCH0201Q01SCH0001ComboList(hospCode, request.getJundalTable(), getLanguage(vertx, sessionId));
		...
		List<SchsSCH0201Q01ReserListItemInfo> listResult = sch0201Repository.getSchsSCH0201Q01ReserListItemInfo(hospCode, request.getFromDate(),
        		request.getToDate(),request.getJundalTable(), request.getJundalPart(), request.getChkchecked()); 

...
{[Serializable]
    public class ORCALibGetClaimOrderArgs : IContractArgs
    {
    protected bool Equals(ORCALibGetClaimOrderArgs other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((ORCALibGetClaimOrderArgs) obj);
    }
    ...
    private String _hospCode;
        ...
        public ORCALibGetClaimOrderArgs() { }

        public ORCALibGetClaimOrderArgs(String hospCode, String fkoif1101)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.ORCALibGetClaimOrderRequest();
        }
    }
}
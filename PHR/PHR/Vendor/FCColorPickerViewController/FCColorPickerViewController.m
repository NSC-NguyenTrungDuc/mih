...
- (void)viewDidLoad {
    ...
    [self.btnChoose setTitle:kLocalizedString(kChoose) forState:UIControlStateNormal];
    [self.btnCancel setTitle:kLocalizedString(kCancel) forState:UIControlStateNormal];
}

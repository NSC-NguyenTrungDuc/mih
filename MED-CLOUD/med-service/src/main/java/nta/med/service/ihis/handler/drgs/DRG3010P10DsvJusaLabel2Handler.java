...
import nta.med.service.ihis.proto.DrgsServiceProto.DRG3010P10DsvJusaLabel2Request;
import nta.med.service.ihis.proto.DrgsServiceProto.DRG3010P10DsvJusaLabel2Response;

@Service
@Scope("prototype")
public class DRG3010P10DsvJusaLabel2Handler extends
		ScreenHandler<DrgsServiceProto.DRG3010P10DsvJusaLabel2Request, DrgsServiceProto.DRG3010P10DsvJusaLabel2Response> {
	@Resource
	...
	public DRG3010P10DsvJusaLabel2Response handle(Vertx vertx, String clientId, String sessionId, long contextId,
			DRG3010P10DsvJusaLabel2Request request) throws Exception {

...
/**
 * The persistent class for the OIF1102 database table.
 * 
 */
@Entity
@NamedQuery(name="Oif1102.findAll", query="SELECT o FROM Oif1102 o")
public class Oif1102 extends BaseEntity {

...
/**
 * The persistent class for the DRG3019 database table.
 * 
 */
@Entity
@NamedQuery(name="Drg3019.findAll", query="SELECT d FROM Drg3019 d")
public class Drg3019 extends BaseEntity {

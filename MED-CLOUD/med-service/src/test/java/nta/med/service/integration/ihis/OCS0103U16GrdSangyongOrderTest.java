...
public class OCS0103U16GrdSangyongOrderTest {                                                                                          
	@Autowired                                                                                                             
	...
	public void Test() throws InterruptedException {                                                            
  		OcsaServiceProto.OCS0103U16GrdSangyongOrderRequest request =OcsaServiceProto.OCS0103U16GrdSangyongOrderRequest
			...
			Rpc.RpcMessage rpcMessage = Rpc.RpcMessage                                                                         
					...
					.setVersion("1.0.0")                                                                           
					.setPayloadClass(                                                                                          
							OcsaServiceProto.OCS0103U16GrdSangyongOrderRequest.class                                             
									.getSimpleName())                                                                          
					.setPayloadData(request.toByteString()).build();                                                           

			final CountDownLatch latch = new CountDownLatch(1);                                                                
			vertx.eventBus()                                                                                                   
					.send(OcsaServiceProto.OCS0103U16GrdSangyongOrderRequest.class                                               
							.getSimpleName(),                                                                                  

...
/**
 * The persistent class for the NUR6004 database table.
 * 
 */
@Entity
@NamedQuery(name="Nur6004.findAll", query="SELECT n FROM Nur6004 n")
public class Nur6004 extends BaseEntity {

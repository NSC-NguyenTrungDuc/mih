...
{
    public class INV2003U00SaveINV2003Args : IContractArgs
    {
        ...
        public INV2003U00SaveINV2003Args() { }

        public INV2003U00SaveINV2003Args(String sysDate, String sysId, String updDate, String updId, String hospCode, String pkinv2003, String churiDate, String churiBuseo, String chulgoType, String churiSeq, String jaeryoGubun, String ipchulType, String inOutGubun, String remark, String dataRowState)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.INV2003U00SaveINV2003Request();
        }
    }
}
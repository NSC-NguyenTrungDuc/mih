...
public class OcsoOCS1003P01GridPatientListInfo {
    ...
    private String unapproveYn;
	public OcsoOCS1003P01GridPatientListInfo(String bunho, Date naewonDate,
			String gwa, String doctor, String naewonType, String reserYn,
			String jubsuTime, String arriveTime, String suname, String suname2,
			String sex, Integer age, String gubunName, String gwaName,
			String doctorName, String chojaeName, String jinryoEndYn,
			Double pkNaewon, String naewonYn, String sunnabYn,
			String jubsuGubun, String otherGwa, String consultYn,
			String commonDoctorYn, String gubun, String groupKey,
			String kensaYn, String unapproveYn) {
		super();
		this.bunho = bunho;
	...
	public String getJinryoEndYn() {
		return jinryoEndYn;
	}
	public void setJinryoEndYn(String jinryoEndYn) {
		this.jinryoEndYn = jinryoEndYn;
	}
	...
	public String getUnapproveYn() {
		return unapproveYn;
	}
	public void setUnapproveYn(String unapproveYn) {
		this.unapproveYn = unapproveYn;
	}

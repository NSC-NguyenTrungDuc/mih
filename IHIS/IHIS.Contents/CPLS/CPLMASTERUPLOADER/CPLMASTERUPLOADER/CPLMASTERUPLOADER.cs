...
{
    /// <summary>
    /// CPLMASTERUPLOADER에 대한 요약 설명입니다.
    /// </summary>
    [ToolboxItem(false)]
    public class CPLMASTERUPLOADER : IHIS.Framework.XScreen
    {
        #region Constants

        private const string CPL0101U00 = "CPL0101U00";
        private const string ACT = "MAP_GUBUN_ACT";
        ...
        private IHIS.Framework.XLabel lbFileDirectory;
        private IHIS.Framework.XEditGridCell xEditGridCell17;
        private OpenFileDialog openFileDialog;
        private XButton btnSearchFile;
        private XTextBox txtFileDirectory;
        ...
        private XDatePicker dtpProcDate;
        private XLabel xLabel3;
        private XLabel lbWorkSheet;
        ...
        private XTextBox txtFileText;
        DataTable excelTable = new DataTable();
        #endregion

        public CPLMASTERUPLOADER()
        {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CPLMASTERUPLOADER));
            this.xPanel1 = new IHIS.Framework.XPanel();
            this.xPanel5 = new IHIS.Framework.XPanel();
            this.dataGridView = new System.Windows.Forms.DataGridView();
            this.txtFileText = new IHIS.Framework.XTextBox();
            ...
            this.lbWorkSheet = new IHIS.Framework.XLabel();
            this.dtpProcDate = new IHIS.Framework.XDatePicker();
            ...
            this.lbFileDirectory = new IHIS.Framework.XLabel();
            ...
            this.xPanel5.Controls.Add(this.dataGridView);
            this.xPanel5.Controls.Add(this.txtFileText);
            ...
            // txtFileText
            // 
            this.txtFileText.AccessibleDescription = null;
            this.txtFileText.AccessibleName = null;
            resources.ApplyResources(this.txtFileText, "txtFileText");
            this.txtFileText.BackgroundImage = null;
            this.txtFileText.Name = "txtFileText";
            this.txtFileText.ReadOnly = true;
            this.txtFileText.TabStop = false;
            // 
            // xPanel3
            // 
            ...
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Query, System.Windows.Forms.Shortcut.None, "照会", -1, global::IHIS.CPLS.Properties.Resources.MSG_IF_NO_IF_SELECTED),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Process, System.Windows.Forms.Shortcut.None, "処理", -1, global::IHIS.CPLS.Properties.Resources.MSG_IF_NO_IF_SELECTED),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Close, System.Windows.Forms.Shortcut.None, "閉じる", -1, global::IHIS.CPLS.Properties.Resources.MSG_IF_NO_IF_SELECTED)});
            ...
            this.xPanel2.Controls.Add(this.lbWorkSheet);
            this.xPanel2.Controls.Add(this.dtpProcDate);
            ...
            this.xPanel2.Controls.Add(this.txtFileDirectory);
            this.xPanel2.Controls.Add(this.lbFileDirectory);
            ...
            // cboMasterType
            // 
            this.cboMasterType.AccessibleDescription = null;
            this.cboMasterType.AccessibleName = null;
            resources.ApplyResources(this.cboMasterType, "cboMasterType");
            this.cboMasterType.BackgroundImage = null;
            ...
            this.cboMasterType.SQLType = IHIS.Framework.XComboSQLType.UserSQL;
            this.cboMasterType.UserSQL = resources.GetString("cboMasterType.UserSQL");
            // 
            // xComboItem1
            // 
            ...
            // lbWorkSheet
            // 
            this.lbWorkSheet.AccessibleDescription = null;
            this.lbWorkSheet.AccessibleName = null;
            resources.ApplyResources(this.lbWorkSheet, "lbWorkSheet");
            this.lbWorkSheet.BackGroundPattern = IHIS.Framework.DrawPattern.HorizonGRAD1;
            this.lbWorkSheet.EdgeRounding = false;
            this.lbWorkSheet.Image = null;
            this.lbWorkSheet.Name = "lbWorkSheet";
            // 
            // dtpProcDate
            // 
            this.dtpProcDate.AccessibleDescription = null;
            this.dtpProcDate.AccessibleName = null;
            resources.ApplyResources(this.dtpProcDate, "dtpProcDate");
            this.dtpProcDate.BackgroundImage = null;
            this.dtpProcDate.IsVietnameseYearType = false;
            ...
            // ckbEm
            // 
            this.ckbEm.AccessibleDescription = null;
            this.ckbEm.AccessibleName = null;
            resources.ApplyResources(this.ckbEm, "ckbEm");
            this.ckbEm.BackgroundImage = null;
            this.ckbEm.Name = "ckbEm";
            this.ckbEm.UseVisualStyleBackColor = false;
            // 
            // txtWorkSheet
            // 
            this.txtWorkSheet.AccessibleDescription = null;
            this.txtWorkSheet.AccessibleName = null;
            resources.ApplyResources(this.txtWorkSheet, "txtWorkSheet");
            this.txtWorkSheet.BackgroundImage = null;
            ...
            // lbFileDirectory
            // 
            this.lbFileDirectory.AccessibleDescription = null;
            this.lbFileDirectory.AccessibleName = null;
            resources.ApplyResources(this.lbFileDirectory, "lbFileDirectory");
            this.lbFileDirectory.BackGroundPattern = IHIS.Framework.DrawPattern.HorizonGRAD1;
            this.lbFileDirectory.EdgeRounding = false;
            this.lbFileDirectory.Image = null;
            ...
            this.Font = null;
            this.Name = "CPLMASTERUPLOADER";
            this.ScreenOpen += new IHIS.Framework.XScreenOpenEventHandler(this.CPLMASTERUPLOADER_ScreenOpen);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.dtpProcDate.SetDataValue((EnvironInfo.GetSysDate().ToString("yyyy/MM/dd")));
        }
        #endregion
        ...
        private void btnList_ButtonClick(object sender, IHIS.Framework.ButtonClickEventArgs e)
        {
            switch (e.Func)
            {
                case FunctionType.Query:
                    ...
                    //// Check Master type
                    //if (TypeCheck.IsNull(this.cboMasterType.GetDataValue()))
                    //{
                    ...
                    //if (TypeCheck.IsNull(this.txtFileDirectory.GetDataValue()))
                    //{
                    //    XMessageBox.Show(this.lbFileDirectory.Text + Resources.MSG_002, Resources.CAP_001, MessageBoxIcon.Warning);

                    //    this.txtFileDirectory.Focus();

                    //    return;
                    //}

                    //// Check sheet name
                    //if (TypeCheck.IsNull(this.txtWorkSheet.GetDataValue()))
                    //{
                    //    XMessageBox.Show(this.lbWorkSheet.Text + Resources.MSG_003, Resources.CAP_001, MessageBoxIcon.Warning);

                    //    this.txtWorkSheet.Focus();

                    //    return;
                    //}

                    if (this._screenOpener.Equals(CPL0101U00))
                    {
                        // https://sofiamedix.atlassian.net/browse/MED-16286
                        if (!this.ValidateIFMaster()) return;
                        if (!this.cboMasterType.GetDataValue().Equals(ACT)) return;
                        this.LoadTxtFile();
                    }
                    else
                    {
                        // https://sofiamedix.atlassian.net/browse/MED-16285
                        if (!this.InputChecks()) return;

                        // Load Excel file
                        //excel = new Excel(txtFileDirectory.GetDataValue(), txtWorkSheet.GetDataValue());
                        //excelTable = excel.GetDataTable();
                        excelTable = this.ReadCSV(txtFileDirectory.GetDataValue());
                        this.dataGridView.DataSource = excelTable;
                        
                    }
                    this.dataGridView.Refresh();
                    this.progBar.Value = progBar.Minimum;
                ...
                case FunctionType.Process:
                    ...
                    //if (TypeCheck.IsNull(this.cboMasterType.GetDataValue()))
                    //{
                    //    XMessageBox.Show(Resources.MSG_004, Resources.CAP_001, MessageBoxIcon.Warning);

                    //    return;
                    //}

                    //// Check excel data row
                    //if (excelTable.Rows.Count < 1)
                    //{
                    //    XMessageBox.Show(Resources.MSG_005, Resources.CAP_001, MessageBoxIcon.Warning);
                    ...
                    //// 02 : BML
                    //// 03 : SRL
                    //if (this.cboMasterType.GetDataValue().Equals("00"))
                    //{
                    //    XMessageBox.Show(Resources.MSG_006, Resources.CAP_002, MessageBoxIcon.Information);
                    //    return;

                    //}
                    //else if (this.cboMasterType.GetDataValue().Equals("01"))
                    //{
                    //    XMessageBox.Show(Resources.MSG_006, Resources.CAP_002, MessageBoxIcon.Information);
                    //    return;

                    //}
                    //else if (this.cboMasterType.GetDataValue().Equals("02"))
                    //{
                    //    if (ProcImpBMLMaster())
                    //    {
                    //        XMessageBox.Show(Resources.MSG_007, Resources.CAP_002, MessageBoxIcon.Information);
                    //        return;
                    //    }
                    //}
                    //else if (this.cboMasterType.GetDataValue().Equals("03"))
                    //{
                    //    XMessageBox.Show(Resources.MSG_006, Resources.CAP_002, MessageBoxIcon.Information);
                    //    return;
                    //}
                    //else
                    //{
                    //    XMessageBox.Show(Resources.MSG_008, Resources.CAP_002, MessageBoxIcon.Error);
                    //}
                    ...
                    if (this._screenOpener.Equals(CPL0101U00))
                    {
                        ...
                        // Failed
                        XMessageBox.Show(Resources.MSG_UPLOAD_FAILED, Resources.CAP_002, MessageBoxIcon.Error);
                    }
                    else
                    {
                        // https://sofiamedix.atlassian.net/browse/MED-16285
        ...
        #region Process Import BML Master
        private bool ProcImpBMLMaster()
        {
            ...
            //    // F1  : -                    :ランク
            //    // F2  : -                    :検査案内ページ
            //    // F3  : PARENT_CODE          :親項目コード
            //    // F4  : HANGMOG_CODE         :項目コード
            //    // F5  : SERIAL               :子RPN
            //    // F6  : -                    :項目名
            //    // F7  : GUMSA_NAME_RE        :項目名　半角８
            //    // F8  : GUMSA_NAME           :項目名　全角８
            //    // F9  : -                    :項目名・漢字
            //    // F10 : -                    :検査案内名称

            //    // F11 : GROUP_GUBUN          :分画負荷区分
            //    // F12 : -                    :項目群コード・小分類名
            //    // F13 : -                    :項目群コード・小分類名
            //    // F14 : -                    :主幹部門コード
            //    // F15 : -                    :主管部門名称
            //    // F16 : JLAC10_CODE          :学会コード（１７桁）
            //    // F17 : SPECIMENT_AMT        :必要量
            //    // F18 : TUBE_NAME            :採取容器
            //    // F19 : -                    :提出容器
            //    // F20 : KEEP_MEANS_NAME      :保存
            ...
            //    // F24 : DETAIL_INFO          :測定法
            //    // F25 : -                    :小数点桁数
            //    // F26 : SPECIMEN_CODE        :材料コード
            //    // F27 : SPECIMEN_NAME        :材料名・漢字
            //    // F28 : DANUI                :単位
            //    // F29 : -                    :単位・漢字
            //    // F30 : MEN_FROM_STANDARD    :男・基準値・下

            //    // F31 : MEN_TO_STANDARD      :男・基準値・上
            //    // F32 : -                    :男・基準値範囲
            //    // F33 : -                    :男・基準値範囲・漢字
            //    // F34 : WOMEN_FROM_STANDARD  :女・基準値・下
            //    // F35 : WOMEN_TO_STANDARD    :女・基準値・上
            //    // F36 : -                    :女・基準値範囲
            //    // F37 : -                    :女・基準値範囲・漢字
            //    // F38 : SPECIMEN_CODE2       :材料コード２
            //    // F39 : SPECIMEN_NAME2       :材料名・漢字２
            //    // F40 : DANUI2               :単位２

            //    // F41 : -                    :単位・漢字２
            //    // F42 : MEN_FROM_STANDARD2   :男・基準値・下２
            //    // F43 : MEN_TO_STANDARD2     :男・基準値・上２
            //    // F44 : -                    :男・基準値範囲２
            //    // F45 : -                    :男・基準値範囲・漢字２
            //    // F46 : WOMEN_FROM_STANDARD2 :女・基準値・下２
            //    // F47 : WOMEN_TO_STANDARD2   :女・基準値・上２
            //    // F48 : -                    :女・基準値範囲２
            //    // F49 : -                    :女・基準値範囲・漢字２
            //    // F50 : -                    :???
            ...
            //    if (!TypeCheck.IsNull(dtRow["F4"].ToString()) //HANGMOG_CODE
            //     && !TypeCheck.IsNull(dtRow["F26"].ToString()) //SPECIMEN_CODE
            //     && !TypeCheck.IsNull(dtRow["F27"].ToString())) //SPECIMEN_NAME
            //    {
            //        Hashtable inputList = new Hashtable();

            //        inputList.Add("I_HOSP_CODE", EnvironInfo.HospCode);
            //        inputList.Add("I_USER_ID", UserInfo.UserID);
            //        inputList.Add("I_GROUP_GUBUN", dtRow["F11"].ToString().Trim()); //GROUP_GUBUN
            //        inputList.Add("I_PARENT_CODE", dtRow["F3"].ToString().Trim()); //PARENT_CODE
            //        inputList.Add("I_HANGMOG_CODE", dtRow["F4"].ToString().Trim()); //HANGMOG_CODE
            //        inputList.Add("I_SERIAL", dtRow["F5"].ToString().Trim()); //SERIAL
            //        inputList.Add("I_GUMSA_NAME_RE", dtRow["F7"].ToString().Trim()); //GUMSA_NAME_RE
            //        inputList.Add("I_GUMSA_NAME", dtRow["F8"].ToString().Trim()); //GUMSA_NAME
            //        inputList.Add("I_JLAC10_CODE", dtRow["F16"].ToString().Trim()); //JLAC10_CODE
            //        inputList.Add("I_TUBE_NAME", dtRow["F18"].ToString().Trim()); //TUBE_NAME
            //        inputList.Add("I_KEEP_MEANS_NAME", dtRow["F20"].ToString().Trim()); //KEEP_MEANS_NAME
            //        inputList.Add("I_SPECIMEN_CODE", dtRow["F26"].ToString().Trim()); //SPECIMEN_CODE
            //        inputList.Add("I_SPECIMEN_NAME", dtRow["F27"].ToString().Trim()); //SPECIMEN_NAME
            //        inputList.Add("I_DANUI", dtRow["F28"].ToString().Trim()); //DANUI
            //        inputList.Add("I_MEN_FROM_STANDARD", dtRow["F30"].ToString().Trim()); //MEN_FROM_STANDARD
            //        inputList.Add("I_MEN_TO_STANDARD", dtRow["F31"].ToString().Trim()); //MEN_TO_STANDARD
            //        inputList.Add("I_WOMEN_FROM_STANDARD", dtRow["F34"].ToString().Trim()); //WOMEN_FROM_STANDARD
            //        inputList.Add("I_WOMEN_TO_STANDARD", dtRow["F35"].ToString().Trim()); //WOMEN_TO_STANDARD
            //        inputList.Add("I_SG_CODE1", dtRow["F52"].ToString().Trim()); //SG_CODE
            //        inputList.Add("I_SG_CODE2", dtRow["F57"].ToString().Trim()); //SG_CODE2

            //        //if (TypeCheck.IsDecimal(JapanTextHelper.GetHalfKatakana(dtRow["SPECIMEN_AMT"].ToString().Trim(), false)))
            //        //{
            //        //    inputList.Add("I_SPECIMEN_AMT", dtRow["SPECIMEN_AMT"].ToString().Trim());
            //        //    //inputList.Add("I_DETAIL_INFO", DBNull.Value);
            //        //}
            //        //else
            //        //{
            //        //    inputList.Add("I_SPECIMEN_AMT", DBNull.Value);
            //        //    //if (!TypeCheck.IsNull(dtRow["SPECIMEN_AMT"].ToString().Trim()))
            //        //    //    inputList.Add("I_DETAIL_INFO", "最低必要量 : " + dtRow["SPECIMEN_AMT"].ToString().Trim());
            //        //    //else
            //        //    //    inputList.Add("I_DETAIL_INFO", DBNull.Value);
            //        //}
            ...
            //        if (!TypeCheck.IsNull(dtRow["F17"].ToString().Trim()))
            //            inputList.Add("I_HANGMOG_MARK_NAME", dtRow["F17"].ToString().Trim());
            //        else
            //            inputList.Add("I_HANGMOG_MARK_NAME", DBNull.Value);

            //        inputList.Add("I_DETAIL_INFO", dtRow["F24"].ToString().Trim());                    
            //        inputList.Add("I_EMERGENCY", ckbEm.Checked ? "Y" : "N");
            //        inputList.Add("I_JUKYONG_DATE", this.dtpProcDate.GetDataValue());

            //        Hashtable outputList = new Hashtable();

            //        if (Service.ExecuteProcedure("PR_CPL_BML_UPLOADER", inputList, outputList))
            //        {
            //            if (!TypeCheck.IsNull(dtRow["F38"].ToString())
            //              && !TypeCheck.IsNull(dtRow["F39"].ToString()))
            //            {
            //                inputList.Remove("I_SPECIMEN_CODE");
            //                inputList.Remove("I_SPECIMEN_NAME");
            //                inputList.Add("I_SPECIMEN_CODE", dtRow["F38"].ToString().Trim());
            //                inputList.Add("I_SPECIMEN_NAME", dtRow["F39"].ToString().Trim());
            ...
            List<CPLMASTERUPLOADERPRCplBmlUploaderInfo> lstData = new List<CPLMASTERUPLOADERPRCplBmlUploaderInfo>();
            ...
            foreach (DataRow dtRow in excelTable.Rows)
            {
                 ...
                 && !TypeCheck.IsNull(dtRow["F27"].ToString())) //SPECIMEN_NAME
                {
                    ...
                    CPLMASTERUPLOADERPRCplBmlUploaderInfo item = new CPLMASTERUPLOADERPRCplBmlUploaderInfo();
                    item.GroupGubun        = dtRow["F11"].ToString().Trim();
                    item.ParentCode        = dtRow["F3"].ToString().Trim();
                    item.HangmogCode       = dtRow["F4"].ToString().Trim();
                    item.Serial            = dtRow["F5"].ToString().Trim();
                    item.GumsaNameRe       = dtRow["F7"].ToString().Trim();
                    item.GumsaName         = dtRow["F8"].ToString().Trim();
                    item.Jlac10Code        = dtRow["F16"].ToString().Trim();
                    item.TubeName          = dtRow["F18"].ToString().Trim();
                    item.KeepMeansName     = dtRow["F20"].ToString().Trim();
                    item.SpecimenCode      = dtRow["F26"].ToString().Trim();
                    item.SpecimenName      = dtRow["F27"].ToString().Trim();
                    item.Danui             = dtRow["F28"].ToString().Trim();
                    item.MenFromStandard   = dtRow["F30"].ToString().Trim();
                    item.MenToStandard     = dtRow["F31"].ToString().Trim();
                    item.WomenFromStandard = dtRow["F34"].ToString().Trim();
                    item.WomenToStandard   = dtRow["F35"].ToString().Trim();
                    item.SgCode1           = dtRow["F52"].ToString().Trim();
                    item.SgCode2           = dtRow["F57"].ToString().Trim();
                    item.SpecimenAmt       = "";
                    item.JukyongDate       = this.dtpProcDate.GetDataValue();
                    item.DetailInfo        = dtRow["F24"].ToString().Trim();
                    item.HangmogMarkName   = dtRow["F17"].ToString().Trim();
                    item.Emergency         = ckbEm.Checked ? "Y" : "N";
                    item.SpecimenCode2     = dtRow["F38"].ToString().Trim();
                    item.SpecimenName2     = dtRow["F39"].ToString().Trim();

                    lstData.Add(item);
                }
            }

            CPLMASTERUPLOADERPRCplBmlUploaderArgs args = new CPLMASTERUPLOADERPRCplBmlUploaderArgs();
            args.HospCode = UserInfo.HospCode;
            args.UserId = UserInfo.UserID;
            args.UplItem = lstData;

            if (lstData.Count > 0)
            {
                UpdateResult res = CloudService.Instance.Submit<UpdateResult, CPLMASTERUPLOADERPRCplBmlUploaderArgs>(args);
                progBar.Value = excelTable.Rows.Count;
                rtnVal = res.ExecutionStatus == ExecutionStatus.Success && res.Result;
            }
        ...
        public class Excel
        {
            ...
            public System.Data.DataTable GetDataTable()
            {
                ...
                string strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + _filepath + ";" + "Extended Properties='text;HDR=YES;'";
                string strSel = "SELECT * FROM [" + Path.GetFileName(_filepath) + "$]";
        ...
        {
            private CPLMASTERUPLOADER parent = null;
            public XSavePerformer(CPLMASTERUPLOADER parent)
            {
                this.parent = parent;
            }
...
//                }
        ...
        {
            this.openFileDialog.Filter = this._screenOpener.Equals(CPL0101U00) ? "Text files (*.txt)|*.txt" : "CSV files (*.csv)|*.csv";

            if (this.openFileDialog.ShowDialog() == DialogResult.OK)
            {
                this.txtFileDirectory.SetDataValue(this.openFileDialog.FileName);
            }
        }
        #endregion
        ...
        #region GetCboMstType
        /// <summary>
        /// GetCboMstType
        /// </summary>
        /// <param name="bvc"></param>
        /// <returns></returns>
        private IList<object[]> GetCboMstType(BindVarCollection bvc)
        {
            IList<object[]> lObj = new List<object[]>();

            CPLMASTERUPLOADERCboMstTypeArgs args = new CPLMASTERUPLOADERCboMstTypeArgs();
            args.IsPopup = _screenOpener.Equals(CPL0101U00);
            ComboResult res = CloudService.Instance.Submit<ComboResult, CPLMASTERUPLOADERCboMstTypeArgs>(args);
        ...
        #region https://sofiamedix.atlassian.net/browse/MED-16285

        public IHIS.CloudConnector.Messaging.DataType ProcessType
        {
            get
            {
                IHIS.CloudConnector.Messaging.DataType _processType;

                switch (cboMasterType.GetDataValue())
                {
                    case "1":
                        _processType = IHIS.CloudConnector.Messaging.DataType.ANALYTE_CODE;
                        break;
                    case "2":
                        _processType = IHIS.CloudConnector.Messaging.DataType.IDENTIFICATION_CODE;
                        break;
                    case "3":
                        _processType = IHIS.CloudConnector.Messaging.DataType.SPECIMEN_CODE;
                        break;
                    case "4":
                        _processType = IHIS.CloudConnector.Messaging.DataType.METHODOLOGY_CODE;
                        break;
                    case "5":
                        _processType = IHIS.CloudConnector.Messaging.DataType.RESULTGENERAL_CODE;
                        break;
                    case "6":
                        _processType = IHIS.CloudConnector.Messaging.DataType.MEDISMASTER;
                        break;
                    default:
                        _processType = IHIS.CloudConnector.Messaging.DataType.ANALYTE_CODE;
                        break;
        ...
        {
            string extension = Path.GetExtension(txtFileDirectory.GetDataValue()).ToLower();

            // Accepts excel only
            if (!extension.Equals(".csv"))
            {
                XMessageBox.Show(Resources.MSG_FILE_TYPE_INCORRECT, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.txtFileDirectory.Focus();

                return false;
            }

            // Data type is not selected
            if (TypeCheck.IsNull(cboMasterType.GetDataValue()))
            {
                XMessageBox.Show(Resources.MSG_REQUIRED_DATA_TYPE, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.cboMasterType.Focus();
        ...
        private void AddHeaderToTable(DataTable table)
        {
            DataRow hdrRow = table.NewRow();

            for (int i = 0; i < table.Columns.Count; i++)
            {
                hdrRow[i] = EXCEL_COLUMNS[i];
            }

            // Insert a new row to the top of the table
            table.Rows.InsertAt(hdrRow, 0);
        }

        private DataTable ReadCSV(string csvFile)
        {
            List<string[]> contents = new List<string[]>();
            Encoding enc = Encoding.GetEncoding(932);

            using (StreamReader reader = new StreamReader(csvFile, enc))
            {
                CsvReader csv = new CsvReader(reader);
                csv.Configuration.IgnoreQuotes = false;
                csv.Configuration.HasHeaderRecord = false;
                csv.Configuration.BufferSize = 1024 * 1024 * 1024; // 1GB
                ...
                try
                {
                    ...
                    while (csv.Read())
                    {
                        // Skips 4 rows for Analyte code, Identification code
                        if (((this.ProcessType == IHIS.CloudConnector.Messaging.DataType.ANALYTE_CODE || this.ProcessType == IHIS.CloudConnector.Messaging.DataType.IDENTIFICATION_CODE) && i < 4)
                            || ((this.ProcessType == IHIS.CloudConnector.Messaging.DataType.SPECIMEN_CODE || this.ProcessType == IHIS.CloudConnector.Messaging.DataType.RESULTGENERAL_CODE) && i < 5)
                            || ((this.ProcessType == IHIS.CloudConnector.Messaging.DataType.METHODOLOGY_CODE) && i < 6)
                            || ((this.ProcessType == IHIS.CloudConnector.Messaging.DataType.MEDISMASTER) && i < 7))
                        {
                            i++;
                            continue;
                        }
            ...
            DataTable dt = ConvertListToDataTable(contents);
            return dt;
        }
        ...
        private DataTable ConvertListToDataTable(List<string[]> list)
        {
            ...
            {
                table.Columns.Add(EXCEL_COLUMNS[i]);
            }
        ...
        {
            CPLMASTERUPLOADERProcessArgs args = new CPLMASTERUPLOADERProcessArgs();
            args.Type = this.ProcessType;
            args.Data = File.ReadAllBytes(txtFileDirectory.GetDataValue());
            UpdateResult res = CloudService.Instance.Submit<UpdateResult, CPLMASTERUPLOADERProcessArgs>(args);
        ...
        #region https://sofiamedix.atlassian.net/browse/MED-16286

        private string _screenOpener = "";

        private void CPLMASTERUPLOADER_ScreenOpen(object sender, XScreenOpenEventArgs e)
        {
            if (e.OpenParam != null && e.OpenParam.Contains("opener") && e.OpenParam["opener"].ToString() == CPL0101U00)
            {
                this._screenOpener = e.OpenParam["opener"].ToString();
                this.lbWorkSheet.Visible = false;
                this.txtWorkSheet.Visible = false;
                this.progBar.Visible = false;
                this.Name = Resources.TXT_IF_MASTER_NAME;
            }

            cboMasterType.ParamList = new List<string>(new string[] { "f_is_popup" });
            cboMasterType.ExecuteQuery = GetCboMstType;
            cboMasterType.SetDictDDLB();
        }

        private bool ValidateIFMaster()
        {
            string extension = Path.GetExtension(txtFileDirectory.GetDataValue()).ToLower();

            // No file selected
            if (TypeCheck.IsNull(txtFileDirectory.GetDataValue()))
            {
                XMessageBox.Show(Resources.MSG_IF_REQUIRED_FILE, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.txtFileDirectory.Focus();
            ...
            if (TypeCheck.IsNull(cboMasterType.GetDataValue()))
            {
                XMessageBox.Show(Resources.MSG_IF_NO_IF_SELECTED, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.cboMasterType.Focus();
            ...
            {
                XMessageBox.Show(Resources.MSG_IF_INCORRECT_FILE_TYPE, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                this.txtFileDirectory.Focus();

                return false;
            }

            // File length is not equal to 256 bytes per line (includes full-size and half-size characters)
            string[] contents = File.ReadAllLines(txtFileDirectory.GetDataValue(), Encoding.GetEncoding(932));
            for (int i = 0; i < contents.Length; i++)
            {
                if (contents[i].Length != 220)
                {
                    Service.WriteLog(string.Format("Error at line {0}: {1}", i + 1, contents[i]));
                    XMessageBox.Show(Resources.MSG_IF_INCORRECT_FORMAT, Resources.CAP_WARNING, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    this.txtFileDirectory.Focus();
        ...
        private bool ProcessUploadIFMaster()
        {
            CPLMASTERUPLOADERProcessUploadIFArgs args = new CPLMASTERUPLOADERProcessUploadIFArgs();
            args.Data = File.ReadAllBytes(txtFileDirectory.GetDataValue());
            UpdateResult res = CloudService.Instance.Submit<UpdateResult, CPLMASTERUPLOADERProcessUploadIFArgs>(args);
        ...
        private void LoadTxtFile()
        {
            try
            {
                ...
                txtFileText.BringToFront();
                txtFileText.Dock = DockStyle.Fill;
                xPanel5.Controls.Add(txtFileText);
                xPanel5.ResumeLayout();

                //if (NetInfo.Language == LangMode.Jr)
                //{
                //    txtFileText.Text = File.ReadAllText(txtFileDirectory.GetDataValue(), Encoding.GetEncoding(932));
                //}
                //else
                //{
                //    txtFileText.Text = File.ReadAllText(txtFileDirectory.GetDataValue(), Encoding.GetEncoding("UTF-8"));
                //}
                txtFileText.Text = File.ReadAllText(txtFileDirectory.GetDataValue(), Encoding.GetEncoding(932));
            }
            catch (Exception ex)

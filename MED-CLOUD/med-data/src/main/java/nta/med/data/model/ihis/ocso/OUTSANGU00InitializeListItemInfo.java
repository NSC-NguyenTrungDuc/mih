...
public class OUTSANGU00InitializeListItemInfo {
	...
	public OUTSANGU00InitializeListItemInfo(String bunho, String gwa, String gwaName, String ioGubun, Double pkSeq,
			Date naewonDate, String doctor, String naewonType, Double jubsuNo, Double fkinp1001, String inputId,
			String sangCode, String sangName, String disSangName, String juSangYn, Date sangStartDate, Date sangEndDate,
			String sangEndSayu, String sangEndSayuName, Double ser, String preModifier1, String preModifier2,
			String preModifier3, String preModifier4, String preModifier5, String preModifier6, String preModifier7,
			String preModifier8, String preModifier9, String preModifier10, String preModifierName,
			...
			String postModifier9, String postModifier10, String postModifierName, Date sangJindanDate, String dataGubun,
			String ifDataSendYn, String contKey, BigDecimal emrPermission, String dataRowState) {
		super();
		this.bunho = bunho;
		this.gwa = gwa;

...
namespace IHIS.CloudConnector.Contracts.Models.System
{
    ...
    public class MainMenuItemInfo
    {
        ...
        public MainMenuItemInfo(String groupId, String groupName, String systemId, String systemName, String displayGroupId, String displayGroupName, String description, int groupImageIndex, int systemImageIndex)
        {
            GroupId = groupId;
            GroupName = groupName;
            SystemId = systemId;

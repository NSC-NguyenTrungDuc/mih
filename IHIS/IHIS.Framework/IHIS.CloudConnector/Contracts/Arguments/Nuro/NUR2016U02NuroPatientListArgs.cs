...
{
    public class NUR2016U02NuroPatientListArgs : IContractArgs
    {
        ...
        public NUR2016U02NuroPatientListArgs() { }

        public NUR2016U02NuroPatientListArgs(String hospitalCode, String comingDate, String departmentCode, String doctorCode, String patientCode, String receptionType, String examStatus, String comingStatus, String currentSystemId)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.NUR2016U02NuroPatientListRequest();
        }
    }
}
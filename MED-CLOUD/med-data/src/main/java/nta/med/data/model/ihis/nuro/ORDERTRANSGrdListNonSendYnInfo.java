...
public class ORDERTRANSGrdListNonSendYnInfo {
	...
	private String sendedYn      ;
	private String naewonYn      ;
	private String orderByKey   ;
	private String chojaeName;
	public ORDERTRANSGrdListNonSendYnInfo(Double fkout1001, String bunho,
			String suname, Date actingDate, String gwa, String gwaName,
			String doctor, String doctorName, String gubun, String gubunName,
			String sendedYn, String naewonYn, String orderByKey, String chojaeName) {
		super();
	...
	public String getSendedYn() {
		return sendedYn;
	}
	public void setSendedYn(String sendedYn) {
		this.sendedYn = sendedYn;
	}

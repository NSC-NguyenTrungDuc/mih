...
namespace IHIS.CPLS
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CPL3020U00 : IHIS.Framework.XScreen
    {
        #region 자동생성
...
//        private IHIS.CPLS.GraphResultView graphResultView;
        ...
        public CPL3020U00()
        {
            ...
            this.fwkJundalGubun.ExecuteQuery = ExecuteQueryFwkJundalGubun;

            this.fwkNote.ParamList = new List<string>(new String[] {"f_jundal_gubun"});
            this.fwkNote.ExecuteQuery = ExecuteQueryFwkNote;

            this.grdPa.ParamList = new List<string>(new String[] {"f_gubun", "f_from_date", "f_to_date", "f_jundal_gubun"});
            ...
            this.fwkActor.ExecuteQuery = ExecuteQueryFwkActor;
            ...
            this.dbxTat2.Mask = Resource.MaskText;

            // https://sofiamedix.atlassian.net/browse/MED-12767
            this.fwkResult.FormText = Resource.fwkResultFormText;
            this.fwkNote.FormText = Resource.fwkNoteFormText;
            this.fwkJundalGubun.FormText = Resource.fwkJundalGubunFormText;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CPL3020U00));
            ...
            this.grdResult.ColPerLine = 12;
            this.grdResult.ColResizable = true;
            this.grdResult.Cols = 13;
            ...
            this.xEditGridCell6.CellWidth = 196;
            ...
            this.xEditGridCell9.CellWidth = 93;
            ...
            this.xEditGridCell14.CellWidth = 108;
            ...
            this.fwkNote.FormText = "NOTE照会";
            this.fwkNote.InputSQL = null;
            ...
            this.dbxTat2.Mask = global::IHIS.CPLS.Properties.Resource.MaskText;
            ...
            this.dbxTat1.Mask = global::IHIS.CPLS.Properties.Resource.MaskText;
            ...
            this.xEditGridCell17.CellWidth = 153;
            ...
            this.grdNoteUpdate.HeaderHeights.Add(14);
            ...
            // fbxJundalGubun
            // 
            this.fbxJundalGubun.AutoTabAtMaxLength = true;
            ...
            this.fwkJundalGubun.FormText = "伝達パート照会";
            this.fwkJundalGubun.InputSQL = null;
            ...
            this.findColumnInfo2.ColWidth = 273;
            ...
            // xPanel6
            // 
            this.xPanel6.Controls.Add(this.dbxActor_name);
            this.xPanel6.Controls.Add(this.fbxActor);
            ...
            this.xPanel6.Controls.Add(this.fbxJundalGubun);
            ...
            // findColumnInfo7
            // 
            this.findColumnInfo7.ColName = "user_id";
            ...
            // findColumnInfo8
            // 
            this.findColumnInfo8.ColName = "user_name";
            this.findColumnInfo8.ColWidth = 140;
            ...
            // singleLayoutItem29
            // 
            this.singleLayoutItem29.BindControl = this.dbxJundalGubunName;
            this.singleLayoutItem29.DataName = "jundal_gubun_name";
            // 
            // laySpecimenInfo
            // 
            ...
            // singleLayoutItem32
            // 
            this.singleLayoutItem32.DataName = "note";
            // 
            // dsvNote
            // 
            ...
            // singleLayoutItem33
            // 
            this.singleLayoutItem33.BindControl = this.txtNote;
            this.singleLayoutItem33.DataName = "txtNote";
            // 
            // layNoteUpdate
            // 
            ...
            // multiLayoutItem13
            // 
            this.multiLayoutItem13.DataName = "etc_comment";
            this.multiLayoutItem13.IsUpdItem = true;
            // 
            // singleLayoutItem28
            // 
            this.singleLayoutItem28.BindControl = this.dbxJundalGubunName;
            ...
            // singleLayoutItem31
            // 
            this.singleLayoutItem31.BindControl = this.dbxJundalGubunName;
            this.singleLayoutItem31.DataName = "jundal_gubun";
            // 
            // multiLayoutItem9
            // 
            this.multiLayoutItem9.DataName = "jundal_gubun";
            // 
            // multiLayoutItem10
            // 
            this.multiLayoutItem10.DataName = "specimen_ser";
            // 
            // multiLayoutItem11
            // 
            ...
            this.Name = "CPL3020U00";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.CPL3020U00_Closing);
...
//            this.grdResult.QuerySQL = tQuery;
        ...
        private void CPL3020Q00_Call()
        {
            ...
            openParams.Add("SpecimenCode",
                this.grdResult.GetItemString(this.grdResult.CurrentRowNumber, "specimen_code"));

            XScreen.OpenScreenWithParam(this, "CPLS", "CPL3020Q00", IHIS.Framework.ScreenOpenStyle.PopUpSizable,
        ...
        private void btnList_ButtonClick(object sender, IHIS.Framework.ButtonClickEventArgs e)
        {
            switch (e.Func)
            {
                case FunctionType.Update:
                    mIsSaveSuccess = true;
                    if (this.dbxActor_name.GetDataValue().Length == 0)
                    {
                        // https://sofiamedix.atlassian.net/browse/MED-12171
                        //string msg = "検査者IDを入力してください。";
                        //XMessageBox.Show(msg, "ID入力");
                        XMessageBox.Show(Resource.MSG_001, Resource.CAP_001, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    else if (this.dbxJundalGubunName.GetDataValue().Length == 0)
                    {
                        // https://sofiamedix.atlassian.net/browse/MED-12171
                        //string msg = "伝達パートを入力してください。";
                        //XMessageBox.Show(msg, "伝達パート入力");
                        XMessageBox.Show(Resource.MSG_002, Resource.CAP_001, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    try
                    {
                        ...
                        UpdateResult result = CPL3020U00SavePerformer();
                        ...
                        {
                            XMessageBox.Show(Resource.XMessageBox5, Resource.XMessageBox5_caption,
...
//                        Service.RollbackTransaction();
                        XMessageBox.Show(Resource.XMessageBox + Service.ErrFullMsg,
											Resource.XMessageBox_caption, MessageBoxIcon.Error);
                        mIsSaveSuccess = false;
                    }
        ...
        private void grdResult_GridCellPainting(object sender, IHIS.Framework.XGridCellPaintEventArgs e)
        {
            ...
            if (e.ColName == "standard_yn")
            {
                if (this.grdResult.GetItemString(e.RowNumber, "standard_yn") == "H")
                    e.ForeColor = Color.Red;
                else if (this.grdResult.GetItemString(e.RowNumber, "standard_yn") == "L")
                    e.ForeColor = Color.Blue;
            }

            if ((this.grdResult.GetItemString(e.RowNumber, "group_gubun") == "01") ||
                (this.grdResult.GetItemString(e.RowNumber, "group_gubun") == "03"))
        ...
        public override object Command(string command, CommonItemCollection commandParam)
        {
            switch (command)
            {
                case "CPLFINDLIB": /* 검체검사 결과 파인드 */
                    ...
                    {
                        this.grdResult.SetItemValue(grdResult.CurrentRowNumber, "cpl_result",
                            commandParam["cpl_result"].ToString());
                    }
        ...
        private void grdResult_GridButtonClick(object sender, IHIS.Framework.GridButtonClickEventArgs e)
        {
            ...
            XScreen.OpenScreenWithParam(this, "CPLS", "CPLFINDLIB", IHIS.Framework.ScreenOpenStyle.ResponseSizable,
  ...
  //          multiResultView.ModifyDW();
        ...
        private void grdResult_RowFocusChanged(object sender, IHIS.Framework.RowFocusChangedEventArgs e)
        {
            //if (pnlSigeyul.Size.Height > 0)
            //{
            //    if (this.grdResult.GetItemString(e.CurrentRow, "group_hangmog") !=
            //        this.grdResult.GetItemString(e.PreviousRow, "group_hangmog"))
            //    {
            //        if (tabSigeyul.SelectedIndex == 0)
            //        {
            //            //그룹항목 시계열 자동 조회
            //            this.multiResultView.SetSigeyul(grdResult.GetItemString(grdResult.CurrentRowNumber, "bunho"),
            //                grdResult.GetItemString(grdResult.CurrentRowNumber, "group_hangmog"));
            //        }
            //        else if (tabSigeyul.SelectedIndex == 1)
            //        {
            //            //그룹항목 그래프 자동 조회
            //            this.graphResultView.SetGraph(grdResult.GetItemString(grdResult.CurrentRowNumber, "bunho"),
            //                grdResult.GetItemString(grdResult.CurrentRowNumber, "group_hangmog"));
            //        }
            //    }
            //}
        ...
        private void grdPa_QueryStarting(object sender, CancelEventArgs e)
        {
            ...
            this.grdPa.SetBindVarValue("f_jundal_gubun", this.fbxJundalGubun.GetDataValue());
        }
        ...
        private void grdResult_QueryStarting(object sender, CancelEventArgs e)
        {
            ...
            this.grdResult.SetBindVarValue("f_specimen_ser",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "specimen_ser"));
            this.grdResult.SetBindVarValue("f_jundal_gubun",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "jundal_gubun"));
        }
        ...
        private void dsvNote_QueryStarting(object sender, CancelEventArgs e)
        {
            ...
            this.dsvNote.SetBindVarValue("f_specimen_ser",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "specimen_ser"));
            this.dsvNote.SetBindVarValue("f_jundal_gubun",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "jundal_gubun"));
        }
        ...
        private void fbxJundalGubun_DataValidating(object sender, DataValidatingEventArgs e)
        {
            ...
            if (this.vsvJundalGubun.GetItemValue("jundal_gubun_name").ToString() == "")
            {
                e.Cancel = true;
                SetMsg(Resource.msg, MsgType.Error);
                return;
            }
        ...
        private void fbxNote_DataValidating(object sender, DataValidatingEventArgs e)
        {
            ...
            if (this.grdPa.RowCount > 0)
                this.vsvNote.SetBindVarValue("f_jundal_gubun",
                    this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "jundal_gubun"));
            ...
            {
                e.Cancel = true;
                SetMsg(Resource.msg2, MsgType.Error);
                return;
            }
            ...
            this.grdNoteUpdate.SetItemValue(0, "jundal_gubun",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "jundal_gubun"));
            this.grdNoteUpdate.SetItemValue(0, "specimen_ser",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "specimen_ser"));
        ...
        private void grdResult_PreSaveLayout(object sender, GridRecordEventArgs e)
        {
            ...
            {
                this.grdResult.SetItemValue(e.RowNumber, "gumsaja", this.fbxActor.GetDataValue());
            }
        }
        ...
        private void grdResult_SaveEnd(object sender, SaveEndEventArgs e)
        {
            ...
            if (!Service.ExecuteProcedure("PR_OCSO_CHK_RESULT_MSG", inputList, outputList))
            {
        ...
        {
            private CPL3020U00 parent;

            public XSavePerformer(CPL3020U00 parent)
            {
                this.parent = parent;
            }
                    ...
                    case '1':
                        ...
                        if (item.RowState == DataRowState.Modified)
                        {
                            ...
                            if (item.BindVarList["f_cpl_result"].VarValue == "")
                            {
                                ...
                                if (
                                    !Service.ExecuteProcedure("PR_OCS_UPDATE_RESULT", t_in_out_gubun, t_fkocs,
                                        DBNull.Value, DBNull.Value))
                                {
                                    XMessageBox.Show(Resource.XMessageBox2 + Service.ErrFullMsg,
                                        Resource.XMessageBox_caption, MessageBoxIcon.Error);
                                    return false;
                                }
                            }
                            else
                            {
                                ...
                                {
                                    XMessageBox.Show(Resource.XMessageBox3 + Service.ErrFullMsg,
                                        Resource.XMessageBox_caption, MessageBoxIcon.Error);
                                    return false;
                                }
                                ...
                                {
                                    XMessageBox.Show(Resource.XMessageBox4 + Service.ErrFullMsg,
                                        Resource.XMessageBox_caption, MessageBoxIcon.Error);
                                    return false;
                                }
                                ...
                                if (
                                    !Service.ExecuteProcedure("PR_OCS_UPDATE_RESULT", t_in_out_gubun, t_fkocs, "CPL",
        ...
        private void fwkNote_QueryStarting(object sender, CancelEventArgs e)
        {
            ...
            this.fwkNote.SetBindVarValue("f_jundal_gubun",
                this.grdPa.GetItemString(this.grdPa.CurrentRowNumber, "jundal_gubun"));
        }
        ...
        private void fwkResult_QueryStarting(object sender, CancelEventArgs e)
        {
            ...
            /*string cmdText = @"SELECT 'Y'                                 
                                 ...
                                 WHERE EXISTS ( SELECT 'X'                       
                                                  FROM CPL0155                   
                                                 WHERE HOSP_CODE = :f_hosp_code AND RESULT_CODE_GUBUN = :f_result_form) ";
        ...
        private void CPL3020U00_Closing(object sender, CancelEventArgs e)
        {
            if (!mIsSaveSuccess)
                e.Cancel = true;
        ...
        {
            this.fwkActor.FormText = Resource.fwkActorText;
            this.fwkActor.ColInfos[0].HeaderText = Resource.fwkActorHeaderText;
            this.fwkActor.ColInfos[0].ColWidth = 80;
            this.fwkActor.ColInfos[1].HeaderText = Resource.fwkActorHeaderText2;
        ...
        private void fbxActor_DataValidating(object sender, DataValidatingEventArgs e)
        {
            ...
            // Connect to cloud
            CPL3020U00LayCommonArgs args = new CPL3020U00LayCommonArgs();
            args.UserId = user_id;
            CPL3020U00LayCommonResult result =
                CloudService.Instance.Submit<CPL3020U00LayCommonResult, CPL3020U00LayCommonArgs>(args);
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success &&
                !TypeCheck.IsNull(result.UserName))
            {
                this.dbxActor_name.SetDataValue(result.UserName);
            }
            else
            {
                this.fbxActor.Clear();
            ...
            string aSpecimentSer, string aSpecimenSer, string aJundalGubun)
        {
            ...
            vCPL3020U00GrdPaRowFocusChangedResult =
            ...
            return vCPL3020U00GrdPaRowFocusChangedResult;
        }
        ...
        /// <summary>
        /// ExecuteQuery FwkJundalGubun
        /// </summary>
        /// <param name="var"></param>
        /// <returns></returns>
        private IList<object[]> ExecuteQueryFwkJundalGubun(BindVarCollection var)
        {
            List<object[]> res = new List<object[]>();
            CPL3020U00FwkJundalGubunArgs args = new CPL3020U00FwkJundalGubunArgs();
            args.CodeType = "01";
            ComboResult comboResult = CloudService.Instance.Submit<ComboResult, CPL3020U00FwkJundalGubunArgs>(args);
        ...
        /// <param name="bc"></param>
        /// <returns></returns>
        private IList<object[]> ExecuteQueryGrdPa(BindVarCollection bc)
        {
            IList<object[]> res = new List<object[]>();
            CPL3020U00GrdPaArgs vCPL3020U00GrdPaArgs = new CPL3020U00GrdPaArgs();
            vCPL3020U00GrdPaArgs.Gubun = bc["f_gubun"] != null ? bc["f_gubun"].VarValue : "";
            vCPL3020U00GrdPaArgs.JundalGubun = bc["f_jundal_gubun"] != null ? bc["f_jundal_gubun"].VarValue : "";
            vCPL3020U00GrdPaArgs.FromDate = bc["f_from_date"] != null ? bc["f_from_date"].VarValue : "";
            vCPL3020U00GrdPaArgs.ToDate = bc["f_to_date"] != null ? bc["f_to_date"].VarValue : "";
            CPL3020U00GrdPaResult result =
                CloudService.Instance.Submit<CPL3020U00GrdPaResult, CPL3020U00GrdPaArgs>(vCPL3020U00GrdPaArgs);
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success)
            {
                foreach (CPL3020U00GrdPaListItemInfo item in result.GrdPaItem)
                {
                    object[] objects =
                    {
                        item.LabNo,
        ...
        private IList<object[]> ExecuteQueryGrdResult(BindVarCollection var)
        {
            ...
            CPL3020U00GrdResultArgs args = new CPL3020U00GrdResultArgs();
            args.JundalGubun = var["f_jundal_gubun"].VarValue;
            args.LabNo = var["f_lab_no"].VarValue;
            args.SpecimenSer = var["f_specimen_ser"].VarValue;
            args.CodeType = "03";

            CPL3020U00GrdResultResult result =
                CloudService.Instance.Submit<CPL3020U00GrdResultResult, CPL3020U00GrdResultArgs>(args);
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success)
            {
                List<CPL3020U00GrdResultListItemInfo> lstItemInfos = result.GrdResultItem;
        ...
        /// <param name="bc"></param>
        /// <returns></returns>
        private IList<object[]> ExecuteQueryVSVJubsuja(BindVarCollection bc)
        {
            IList<object[]> res = new List<object[]>();
            ...
            CPL3010U00VSVJubsujaResult result =
                CloudService.Instance.Submit<CPL3010U00VSVJubsujaResult, CPL3010U00VSVJubsujaArgs>(
                    vCPL3010U00VSVJubsujaArgs);
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success)
            {
        ...
        /// <param name="bc"></param>
        /// <returns></returns>
        private IList<object[]> ExecuteQueryVSVJundalGubun(BindVarCollection bc)
        {
            IList<object[]> res = new List<object[]>();
            ...
            CPL3010U00VSVJundalGubunResult result =
                CloudService.Instance.Submit<CPL3010U00VSVJundalGubunResult, CPL3010U00VSVJundalGubunArgs>(
                    vCPL3010U00VSVJundalGubunArgs);
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private UpdateResult CPL3020U00SavePerformer()
        {
            CPL3020U00SavePerformerArgs args = new CPL3020U00SavePerformerArgs();
            args.UserId = UserInfo.UserID;
            args.GrdNoteUpdateItem = CreateListGrdNoteUpdate();
            args.GrdResultItem = CreateListCPL3020U00GrdResultItem();
            return CloudService.Instance.Submit<UpdateResult, CPL3020U00SavePerformerArgs>(args);
        }
        ...
        private List<CPL3020U00GrdResultListItemInfo> CreateListCPL3020U00GrdResultItem()
        {
            ...
            for (int i = 0; i < grdResult.RowCount; i++)
            {
                if (grdResult.GetRowState(i) == DataRowState.Added || grdResult.GetRowState(i) == DataRowState.Modified)
                {
                    ...
                    {
                        grdResultListItemInfo.Gumsaja = this.fbxActor.GetDataValue();
                    }

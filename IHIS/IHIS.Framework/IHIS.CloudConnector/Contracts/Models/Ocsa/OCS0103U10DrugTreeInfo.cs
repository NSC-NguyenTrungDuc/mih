...
{
    [Serializable]
	public class OCS0103U10DrugTreeInfo
	{
		...
		public OCS0103U10DrugTreeInfo() { }

		public OCS0103U10DrugTreeInfo(String code, String codeName, String code1, String codeName1)
		{
			this._code = code;

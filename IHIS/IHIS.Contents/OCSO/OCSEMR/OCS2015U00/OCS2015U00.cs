...
namespace IHIS.OCSO
{
    ...
    using IHIS.DRGS;
    public partial class OCS2015U00 : IHIS.Framework.XScreen, IMainScreen
    {
        ...
        public string oldMmlContent;
        private List<GridModule> loadedGridModules = new List<GridModule>();
        private MdiDialog pendingPatient;
        private string protocolId = "";
        private OCS2015U11 _orderBox;
        ...
        private CommonOcsLib ocsLib;
        string cacheDataDiscuss = "";
        public bool EnableBtnList = true;
        private bool _isPostLoad = false;
        private IHIS.X.Magic.Menus.PopupMenu mPopupMenuBtnLeftScreen = new IHIS.X.Magic.Menus.PopupMenu();
        private int _mainLocationXBtnList = 0;
        private bool _isSetLocationForBtnList = true;
        private bool _isShowBtnOrderGuide = true;
        private bool _isShowBtnOpenOutSang = true;
        private bool _isShowbBtnPrescriptionPrint = true;
        private bool _isShowBtnSetOrder = true;
        private bool _isShowBtnOCS1003Q09 = true;
        private bool _isShowBtnEportViewer = true;
        private int _lastLocationBtnList = 0;
        private int _countButtonVisible = 0;
        private List<int> lstLocation = new List<int>();
        private int _firstLocation = 0;
        private bool _isShowBtnDiscuss = false;
        private Dictionary<string, string> dicListBtnShow = new Dictionary<string, string>();
        private int countLstBtnShow = 0;
        private const int _minSizeShowLstBtn = 638;
        private const string GOOGLE_CHROME = "Google Chrome";
        private const string FIREFOX = "FIREFOX";
        private const string IEXPLORE = "IEXPLORE";
        ...
        /* Precsiption*/
        public CommonOcsLib OcsLib
        {
            get
            {
                if (ocsLib == null) ocsLib = new CommonOcsLib();
                return ocsLib;
            }
        }
        ...
        public OCS2015U11 OrderBox
        {
            get
            {
                if (_orderBox == null)
                {
                    _orderBox = new OCS2015U11(this);
                }
                return _orderBox;
            }
        }
        ...
        public OCS2015U00()
        {
            try
            {
                ...
                // https://sofiamedix.atlassian.net/browse/MED-9441
                InitLogicLayout();
                InitCloud();
                _mainLocationXBtnList = this.btnList.Location.X;
                this.SuspendLayout();
                ...
                CheckHideButton();
                UpdateGUIForResolution(this.Size);

                //SetOutSangForKinki();

                //https://sofiamedix.atlassian.net/browse/MED-11852 && https://sofiamedix.atlassian.net/browse/MED-10687
                //Reset size and location for U02 control
                cldExamDates.SetSizeAndLocationForControl();
                ...
                //Set hide colum grdOutSang
                grdOutSang.AutoSizeColumn(xEditGridCell1.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell2.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell90.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell3.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell4.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell5.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell6.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell7.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell8.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell9.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell10.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell68.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell11.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell12.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell13.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell14.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell16.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell20.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell21.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell22.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell23.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell24.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell25.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell26.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell27.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell28.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell29.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell30.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell31.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell32.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell33.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell34.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell35.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell36.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell37.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell38.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell39.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell40.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell41.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell42.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell1764.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell92.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell93.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell94.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell43.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell44.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell45.Col, 0);


                //Thu
                //grdOutSang.AutoSizeColumn(xEditGridCell15.Col, 0);
                grdOutSang.AutoSizeColumn(xEditGridCell17.Col, 132);
                grdOutSang.AutoSizeColumn(xEditGridCell18.Col, 85);
                grdOutSang.AutoSizeColumn(xEditGridCell19.Col, 85);
                grdOutSang.AutoSizeColumn(xEditGridCell46.Col, 60);
            }
            catch (Exception ex)
            {
        ...
        #region MED-9441
        private void InitLogicLayout()
        {
            this.pnlTopLeft.Size = new System.Drawing.Size(pnlTop.Size.Width - pnlSang.Size.Width, 152);
            this.pnlProblemList.Size = new System.Drawing.Size(this.pnlTopLeft.Size.Width - this.pnlProblemInfo.Size.Width + 5, 152);
            this.grdPatientInfo.Location = new System.Drawing.Point(this.xLabel3.Size.Width + this.fbxBunho.Size.Width, this.paInfoBox.Size.Height);
            this.cldExamDates.Location = new System.Drawing.Point(this.xPanel1.Location.X, this.xPanel1.Location.Y + this.xPanel1.Size.Height + 1);
            this.tvExamHist.Location = new System.Drawing.Point(0, this.cldExamDates.Location.Y + this.cldExamDates.Size.Height + 1);
            this.tvBookmarkList.Location = new System.Drawing.Point(0, this.tvExamHist.Location.Y + this.tvExamHist.Size.Height + 1);
            this.pnlProblemList.Location = new System.Drawing.Point(this.pnlProblemInfo.Location.X, 0);
            this.tvExamHist.Size = new System.Drawing.Size(this.cldExamDates.Size.Width, 200);
            this.tvBookmarkList.Size = new System.Drawing.Size(this.cldExamDates.Size.Width, 174);
            this.xPanelLeft.Size = new System.Drawing.Size(this.xPanel2.Size.Width + this.xPanel5.Size.Width, 633);
            ...
            //this.ctlOCS2015U07.TagLst = ((System.Collections.Generic.List<EmrDocker.Models.TagInfo>)(resources.GetObject("ctlOCS2015U07.TagLst")));

            this.lbSuname.BorderStyle = BorderStyle.None;
            this.lbSunameName.BorderStyle = BorderStyle.None;
            this.timer1.Interval = 30 * 60 * 1000;
            ApplyMultiLanguageGridOutSang();
        }

        private void InitCloud()
        {
            this.grdOutSang.ParamList = new List<string>(new string[] { "f_bunho", "f_naewon_date", "f_gwa" });
            this.layQueryLayout.ParamList = new List<string>(new string[] { "f_hosp_code" });
        }
        #endregion
        ...
        private void UpdateGUI()
        {
            ...
            this.pnlSang.Size = new Size(this.pnlTop.Width * 2 / 10 + 170, 152);
            ...
            /*UpdateGUIForResolution(mainSize);*/
        }

        private void UpdateGUIForResolution(Size mainSize)
        {
            if (mainSize.Width < 1400)
            {
                ctlEmrDocker.Viewer.EnableMenuPopup(true);
                ctlEmrDocker.Editor.EnableMenuPopup(true);
            }
            else
            {
                ctlEmrDocker.Viewer.EnableMenuPopup(false);
                ctlEmrDocker.Editor.EnableMenuPopup(false);
            }

            if (mainSize.Height < 638 && countLstBtnShow >= 22)
            {
                if (_isSetLocationForBtnList)
                {
                    this.cbxMsgSysYN.Location = new Point(this.cbxMsgSysYN.Location.X - 103, this.cbxMsgSysYN.Location.Y);
                    this.btnList.Location = new Point(this.btnList.Location.X - 103, this.btnList.Location.Y);
                    _isSetLocationForBtnList = false;
                }

                this.btnMore.Visible = true;
                /*this.btnMore.Location = new Point(mainSize.Width - 103, this.btnEtcOrder.Location.Y + 30);*/
                SetEnableBtnForResolution(false);
            }
            else
            {
                this.btnMore.Visible = false;
                SetEnableBtnForResolution(true);
            }
        }

        private void SetEnableBtnForResolution(bool value)
        {
            ActionCheckHideButton();
            btnOrderGuide.Visible = _isShowBtnOrderGuide && value;
            btnOpenOutSang.Visible = _isShowBtnOpenOutSang && value;
            btnSetOrder.Visible = _isShowBtnSetOrder && value;
            btnDoOrder.Visible = _isShowBtnOCS1003Q09 && value;
            btnPrescriptionPrint.Visible = _isShowbBtnPrescriptionPrint && value;
        }
        ...
        {
            Form frPatientSetting = new PatientProfileSetting(this);
        ...
        private void TvBunho_NodeMouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (node != null && node.GetValue("HospCode") != null && node.GetValue("HospName") != null)
            {
                ...
                EmrRefer emrRefer = new EmrRefer(hospCode, this.mSelectedPatientInfo.Parameter.Gwa, patientCode, NaewonKey, GetPatientModel());
        ...
        private void xPreMonthCalendar_DayDoubleClick(object sender, XCalendarDayClickEventArgs e)
        {
            ...
            {
                ProcessDayDoubleClickOnCalendar(e);
        ...
        private void calSchedule_DayDoubleClick(object sender, XCalendarDayClickEventArgs e)
        {
            if (this.MSelectedPatientInfo != null && this.MSelectedPatientInfo.Parameter.Bunho != "")
            {
                ...
                AdditionalBusiness.AdditionalBusiness.CalendarBehavior(sender, e, this.ctlEmrDocker, this.tvExamHist, this.cldExamDates);
            }
        }

        //MED-10884
        private void ProcessDayDoubleClickOnCalendar(XCalendarDayClickEventArgs e)
        {
            try
            {
                List<OCS1003P01GrdPatientListItemInfo> lstPatienInfos = new List<OCS1003P01GrdPatientListItemInfo>();
                //this.DtpNaewonDate.GetDataValue() //todayDate
                OCS1003P01GrdPatientResult lstGrdPatient = grdPatient_getData(e.DateItem.Date.ToString("yyyy/MM/dd").Trim(),
                    pendingPatient.PatientBox.FbxDoctor.GetDataValue());
                foreach (OCS1003P01GrdPatientListItemInfo info in lstGrdPatient.GrdPatientList)
                {
                    if (info.Bunho == MSelectedPatientInfo.Parameter.Bunho)
                    {
                        lstPatienInfos.Add(info);
                    }
                }

                if (lstPatienInfos.Count == 1)
                {
                    string aBunho = lstPatienInfos[0].Bunho;
                    string aGubun = lstPatienInfos[0].Gubun;
                    string aPkNaewon = lstPatienInfos[0].PkNaewon;

                    pendingPatient.PatientBox.ProcessMouseClick(aBunho, aGubun, aPkNaewon);
                }
                else if (lstPatienInfos.Count > 1)
                {
                    //open popup here
                    OCS2016U22 ocs2016U22 = new OCS2016U22(this, lstPatienInfos);
                    ocs2016U22.ShowDialog();
                }
            }
            catch (Exception ex)
            {
                Service.WriteLog("Error on Method: ProcessDayDoubleClickOnCalendar()" + ex.StackTrace);
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (currentForm != null)
            {
                Size maxSize = currentForm.Size;
                /*currentForm.MaximumSize = maxSize;*/
                currentForm.Size = maxSize;

                Size minSize = new Size(1200, 600);
                currentForm.MinimumSize = minSize;
            }
        ...
        private void OCS1003P01_ScreenOpen(object sender, XScreenOpenEventArgs e)
        {
            ...
            btnBackupEMR.Location = new Point(244, 645);
            btnDownloadEMR.Location = new Point(364, 645);
            ...
            //lblDownloadEMR.Location = new Point(485, 865);
            lblDownloadEMR.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            this.lblDownloadEMR.Location = new System.Drawing.Point(btnDownloadEMR.Location.X + 120 + 2, btnDownloadEMR.Location.Y + 1);
        ...
        private void btnPrescriptionPrint_Click(object sender, EventArgs e)
        {
            ...
            // string currentUrl = "file:///C:/ihis/OCS2015Presciption.html ";            
        ...
        private bool isUseMovieTalk()
        {
            ...
            if (result != null && result.ExecutionStatus == ExecutionStatus.Success && result.CodeName == "1")
            {
                return true;
            }
        ...
        private void btnMovieTalk_Click(object sender, EventArgs e)
        {
            ...
            if (!isUseMovieTalk())
            {
                string mbxMsg = Resources.Msg_HspDonotUseMovieTalk;
                string mbxCap = Resources.MSG029_CAP;
                XMessageBox.Show(mbxMsg, mbxCap, MessageBoxIcon.Warning);
                return;
            }

            ActionMovieTalk(true);
        }

        private void ActionMovieTalk(bool isModeMovieTalk)
        {
            string tokenHospcode = GetTokenHospCode();
            string patientCode = fbxBunho.GetDataValue();
            /*string sessionId = UserInfo.UserID;*/
            string sessionId = WebSocketClient.SessionId;
            string mode = isModeMovieTalk ? "2" : "1";

            //Open Web brower
            OpenLinkUrl(tokenHospcode, patientCode, sessionId, mode);
        }

        private void OpenLinkUrl(string pTokenHospCode, string pPatientCode, string pSessionId, string pMode)
        {
            try
            {
                string linkLinkMovieTalk = ConfigurationManager.AppSettings["LinkMovieTalk"];
                //http://ip_address:port/mss-web/doctor/generate-token?tokenHospCode=param.token_hospcode&patient_code=param.patient_code&session_id=param.session_id&mode=2

                string url = linkLinkMovieTalk + pTokenHospCode + "&patient_code=" + pPatientCode + "&session_id=" + pSessionId + "&mode=" + pMode;
                bool isExistChrome = false;
                bool isExistFireFox = false;
                ...
                {
                    if (browserName.ToUpper().StartsWith(GOOGLE_CHROME.ToUpper()))
                    {
                        isExistChrome = true;
                        break;
                    }
                    else if (browserName.ToUpper().StartsWith(FIREFOX.ToUpper()))
                    {
                        isExistFireFox = true;
                    }
                }
            ...
            {
                Service.WriteLog("Error of method: OpenLinkUrl()" + ex.StackTrace);
            }
        }

        private string GetTokenHospCode()
        {
            string tokenHospCode = "";
            ...
            try
            {
                ...
                using (StreamReader sr = new StreamReader(res.GetResponseStream()))
                {
                    ...
                    tokenHospCode = (string)genJson["data"]["descrypt_code"];
                }
            }
            catch
            {
                   ...
                   */
                    ...
                    case FunctionType.Update: // 저장
                        ...
                        try
                        {
                            ...
                            if (this.mDoctorLogin)
                            {
                                // MED-11018: Set action doctor of the patient
        ...
        private void ResetOcsEmrData(bool resetEditor)
        {
            //this.ctlEmrDocker.Viewer.ucGrid1.Reset();
        ...
        internal bool IsOrderDataModifed()
        {
            ...
            {
                //https://sofiamedix.atlassian.net/browse/MED-12032
                this.mMsg = Properties.Resources.MSG016_MSG;//"保存していないデータが存在します。変更された内容を保存しますか？";
                this.mCap = Properties.Resources.MSG016_CAP;//"保存可否";
        ...
        internal void DislplayOrderDataWindow(string aInputGubun, string aInputTab, bool loadDoOrder)
        {
            ...
            OrderBox.GrdAllOrderList.Reset();
            ...
            if (aInputTab.Equals("%"))
            {
                OrderBox.GrdAllOrderList.Visible = true;
                OrderBox.GrdAllOrderList.Dock = DockStyle.Fill;

                foreach (DataRow dr in this.layDisplayLayout.LayoutTable.Rows)
                {
                    int i = OrderBox.GrdAllOrderList.InsertRow(-1);
                    OrderBox.GrdAllOrderList.SetItemValue(i, "input_gubun", dr["input_gubun"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "order_gubun", dr["order_gubun"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "mix_info", dr["order_mark"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "wonyoi_order_yn", dr["wonyoi_order_yn"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "order_info", dr["hangmog_name"].ToString() + " " + dr["order_info"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "order_detail", dr["order_detail"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "dv_name", dr["dv_name"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "acting_date", dr["acting_date"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "bogyong_code_yn", dr["bogyong_code_yn"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "ocs_flag", dr["ocs_flag"].ToString());
                    OrderBox.GrdAllOrderList.SetItemValue(i, "sunab_yn", dr["sunab_yn"].ToString());
                }
                OrderBox.GrdAllOrderList.DisplayData();
            }
            else
                OrderBox.GrdAllOrderList.Visible = false;
        ...
        {
            param.Add("mOrderBiz", OcsLib.mOrderBiz);
            param.Add("mOrderFunc", OcsLib.mOrderFunc);
            param.Add("mPatientInfo", OcsLib.mPatientInfo);
            param.Add("mHangmogInfo", OcsLib.mHangmogInfo);
            param.Add("mInputControl", OcsLib.mInputControl);
            param.Add("mCommonForms", OcsLib.mCommonForms);
            param.Add("mColumnControl", OcsLib.mColumnControl);
            param.Add("mInterface", OcsLib.mInterface);
        }
        ...
        {
            float PnlInputTabWith = Size.Width - xPanel5.Size.Width;
            ...
            //OcsEMRLoadComboInputTabResult res = CloudService.Instance.Submit<OcsEMRLoadComboInputTabResult, OcsEMRLoadComboInputTabArgs>(args);
            if (res.ExecutionStatus == ExecutionStatus.Success && res.CboItem.Count > 0)
            {
                ...
                if (res.CboItem.Count > 0)
                {
                    ...
                    //rbnButton.Font = new Font("Meiryo", (float)9.75, FontStyle.Bold);
                    rbnButton.Font = new Font("Arial", (float)9.75, FontStyle.Bold);
                ...
                foreach (ComboListItemInfo item in res.CboItem)
                {
                    ...
                    if (item.CodeName != "複合")
                    {
                        ...
                        /*if ((OrderBox.PnlInputTab.Size.Width - this.mInputTabDefaultXLoc -
                             (this.mInputTabDefaultWidth * (count + 2))) < this.mInputTabDefaultWidth)*/
        ...
        private void ResetOrderGrid()
        {
            ...
            OrderBox.UCOCS2015U18Control.GrdOrder.Reset();
            OrderBox.UCOCS2015U19Control.GrdOrder.Reset();*/
            //Service.WriteLog("Begin ResetOrderGrid");
            ...
            if (OrderBox.UCOCS2015U19Control.GrdOrder.LayoutTable != null && OrderBox.UCOCS2015U19Control.GrdOrder.LayoutTable.Rows.Count > 0)
                OrderBox.UCOCS2015U19Control.GrdOrder.Reset();
            //Service.WriteLog("End ResetOrderGrid");
        }
            ...
            switch (command)
            {
                ...
                case "OCS0301Q09":
                    if (commandParam.Contains("OCS0303"))
                    {
                        ...
                        //Order by group_ser
                        //if (layJusaOrder_Do.LayoutTable.Rows.Count > 2)
                        //{
                        //    layJusaOrder_Do.LayoutTable.s
                        //    layJusaOrder_Do.LayoutTable. = layJusaOrder_Do.LayoutTable.DefaultView.ToTable();
                        //}
        ...
        */
        ...
        #region Resolution btnGroup left screen

        private void InitBtnGroupLeft()
        {
            mPopupMenuBtnLeftScreen.MenuCommands.Clear();
            IHIS.X.Magic.Menus.MenuCommand popUpMenu;

            /*if (_isShowBtnOrderGuide)*/
            if (dicListBtnShow.ContainsKey("btn_OCS1003R02"))
            {
                popUpMenu = new IHIS.X.Magic.Menus.MenuCommand(XMsg.GetField("this.btnOrderGuide.Text"),
                    (Image)this.ImageList.Images[23], new EventHandler(btnOrderGuide_Click));
                popUpMenu.Tag = "1";
                mPopupMenuBtnLeftScreen.MenuCommands.Add(popUpMenu);
            }
            /*if(_isShowBtnPrescriptionPrint)*/
            /*if (_isShowBtnOpenOutSang)*/
            if (dicListBtnShow.ContainsKey("btn_OUTSANGU00"))
            {
                popUpMenu = new IHIS.X.Magic.Menus.MenuCommand(XMsg.GetField("this.btnOpenOutSang.Text"),
                (Image)this.ImageList.Images[16], new EventHandler(btnOpenOutSang_Click));
                popUpMenu.Tag = btnOrderGuide.Visible ? "2" : "1";
                mPopupMenuBtnLeftScreen.MenuCommands.Add(popUpMenu);
            }

            /*if (_isShowBtnSetOrder)*/
            if (dicListBtnShow.ContainsKey("btn_OCS0301Q09"))
            {
                popUpMenu = new IHIS.X.Magic.Menus.MenuCommand(XMsg.GetField("this.btnSetOrder.Text"),
                (Image)this.ImageList.Images[31], new EventHandler(btnSetOrder_Click));
                if (!_isShowBtnOrderGuide && !_isShowBtnOpenOutSang)
                {
                    popUpMenu.Tag = "1";
                }
                else if (_isShowBtnOrderGuide && !_isShowBtnOpenOutSang)
                {
                    popUpMenu.Tag = "2";
                }
                else
            ...
            /*if (_isShowBtnOCS1003Q09)*/
            if (dicListBtnShow.ContainsKey("btn_OCS1003Q09"))
            {
                popUpMenu = new IHIS.X.Magic.Menus.MenuCommand(XMsg.GetField("this.btnDoOrder.Text"),
                (Image)this.ImageList.Images[31], new EventHandler(btnDoOrder_Click));
                if (!_isShowBtnOrderGuide && !_isShowBtnOpenOutSang && !_isShowBtnSetOrder)
                {
                    popUpMenu.Tag = "1";
                }
                else if (_isShowBtnOrderGuide && !_isShowBtnOpenOutSang && !_isShowBtnSetOrder)
                {
                    popUpMenu.Tag = "2";
                }
                else if (_isShowBtnOrderGuide && _isShowBtnOpenOutSang && !_isShowBtnSetOrder)
            ...
            if (dicListBtnShow.ContainsKey("btn_PRESCRIPTION"))
            {
                popUpMenu = new IHIS.X.Magic.Menus.MenuCommand(XMsg.GetField(("this.btnPrescriptionPrint.Text")),
                    (Image)this.ImageList.Images[23], new EventHandler(btnPrescriptionPrint_Click));
                if (!_isShowBtnOrderGuide && !_isShowBtnOpenOutSang && !_isShowBtnSetOrder && !_isShowBtnOCS1003Q09)
                {
                    popUpMenu.Tag = "1";
                }
                else if (_isShowBtnOrderGuide && !_isShowBtnOpenOutSang && !_isShowBtnSetOrder && !_isShowBtnOCS1003Q09)
                {
                    popUpMenu.Tag = "2";
                }
                else if (_isShowBtnOrderGuide && _isShowBtnOpenOutSang && !_isShowBtnSetOrder && !_isShowBtnOCS1003Q09)
        ...
        private void EnsureFolder(string path, bool isOpenEPortViewer)
        {
            ...
            {
                if (isOpenEPortViewer) XMessageBox.Show(Resources.OCS2015U00_EnsureFolder_Don_t_exist_folder + path);
            }
        }
            ...
            if (lstGridOutSangInfo != null && lstGridOutSangInfo.Count > 0)
            {
                foreach (OcsoOCS1003P01GridOutSangInfo gridOutSangInfo in lstGridOutSangInfo)
                {
                    lstObject.Add(new object[]
                    {
                        ...
                        //gridOutSangInfo.PreModifierName + " " + gridOutSangInfo.SangName + " " + gridOutSangInfo.PostModifierName,
        ...
        private List<OCS1003P01LaySaveLayoutListItemInfo> LoadListFromLaySaveLayout()
        {
            ...
            if (laySaveLayout.LayoutTable.Rows.Count > 0)
            {
                ...
                foreach (DataRow row in laySaveLayout.LayoutTable.Rows)
                {
                    ...
                    if (row["jusa_spd_gubun"].ToString().Length > 1)
                    {
                        info.JusaSpdGubun = "1";
                    }
                    else
        ...
        /// </summary>
        private void OCS2015U01BindData()
        {
        ...
        /// </summary>
        public void OCS2015U04BindData(bool isResetEditor)
        {
        ...
        private void FunUpdatedListComment(object sender, BookmarkEventArgs e)
        {
            //update only UcView
        ...
        private void ReEnableControlOfEmrDocker()
        {
        ...
        private void ActionCheckHideButton()
        {
            CheckHideButtonArgs args = new CheckHideButtonArgs();
            args.CodeType = "btn_OCSEMR_YN";
            //CheckHideButtonResult res = CloudService.Instance.Submit<CheckHideButtonResult, CheckHideButtonArgs>(args);
            CheckHideButtonResult res = CacheService.Instance.Get<CheckHideButtonArgs, CheckHideButtonResult>(args,
                delegate(CheckHideButtonResult r) { return r.ExecutionStatus == ExecutionStatus.Success && r.Dt.Count > 0; });
            int index = 0;
            if (res != null && res.ExecutionStatus == ExecutionStatus.Success)
            {
                ...
                /* for (int i = 0; i < 24; i++)
                 {
                     listLocation.Add(new Point(1, 1 + i * 27));
                 }*/
                for (int i = 0; i < 25; i++)
                {
                    listLocation.Add(new Point(1, 1 + i * 27));
                ...
                dicListBtnShow.Clear();
                countLstBtnShow = 0;
                foreach (CheckHideButtonInfo itemInfo in res.Dt)
                {
                    if (itemInfo.CodeName.Equals("Y"))
                    {
                        if (!dicListBtnShow.ContainsKey(itemInfo.Code))
                            dicListBtnShow.Add(itemInfo.Code, itemInfo.SortKey);
                        else
                            dicListBtnShow[itemInfo.Code] = itemInfo.SortKey;
                        countLstBtnShow++;
                    }
                }
                ...
                lst1.Add(btn2015U21.Location);
                lst1.Add(btnJinryoReser.Location);
                lst1.Add(btnApprove.Location);
                lst1.Add(btnKensaReser.Location);
                lst1.Add(btnOrderPrint.Location);
                lst1.Add(btnConsult.Location);
                lst1.Add(btnConsultAnswer.Location);
                if (NetInfo.Language == LangMode.Jr)
                {
                    lst1.Add(btnDiscuss.Location);
                }
                else
                {
                    btnDiscuss.Location = new Point(2, 145);
                    lst1.Add(btnDiscuss.Location);
                }
                List<Point> lst2 = new List<Point>();
                lst2.Add(btnOrderGuide.Location);
                lst2.Add(btnOpenOutSang.Location);
                lst2.Add(btnSetOrder.Location);
                lst2.Add(btnDoOrder.Location);
                lst2.Add(btnDrgOrder.Location);
                lst2.Add(btnJusaOrder.Location);
                lst2.Add(btnCplOrder.Location);
                lst2.Add(btnReha.Location);
                lst2.Add(btnPfeOrder.Location);
                lst2.Add(btnAplOrder.Location);
                lst2.Add(btnXrtOrder.Location);
                lst2.Add(btnChuchiOrder.Location);
                lst2.Add(btnSusulOrder.Location);
                lst2.Add(btnEtcOrder.Location); */
                #endregion

                CheckHideButtonInfo item;
                /*item = GetItemHideButton(res.Dt, "btn_OCS2015U21");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS2015U21"))
                {
                    btn2015U21.Visible = true;
                    btn2015U21.Location = listLocation[index];
                    index++;
                }
                else
                    btn2015U21.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_RES1001U00");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_RES1001U00"))
                {
                    btnJinryoReser.Visible = true;
                    btnJinryoReser.Location = listLocation[index];
                    index++;
                }
                else
                    btnJinryoReser.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCSAPPROVE");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCSAPPROVE"))
                {
                    btnApprove.Visible = true;
                    btnApprove.Location = listLocation[index];
                    index++;
                ...
                /*item = GetItemHideButton(res.Dt, "btn_NUR1001R98");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_NUR1001R98"))
                {
                    btnKensaReser.Visible = true;
                    btnKensaReser.Location = listLocation[index];
                    index++;
                }
                else
                    btnKensaReser.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS1003R00");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS1003R00"))
                {
                    btnOrderPrint.Visible = true;
                    btnOrderPrint.Location = listLocation[index];
                    index++;
                }
                else
                    btnOrderPrint.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0503U00");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0503U00"))
                {
                    btnConsult.Visible = true;
                    btnConsult.Location = listLocation[index];
                    index++;
                }
                else
                    btnConsult.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0503U01");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0503U01"))
                {
                    btnConsultAnswer.Visible = true;
                    btnConsultAnswer.Location = listLocation[index];
                    index++;
                }
                else
                ...
                if (_isShowBtnDiscuss)
                {
                    btnDiscuss.Location = listLocation[index];
                    pbxNotifyON.Location = new Point(btnDiscuss.Location.X + 5, btnDiscuss.Location.Y + 5);
                    index++;
                }
                else
                ...
                //btnMovieTalk
                if (dicListBtnShow.ContainsKey("btn_MOVIETALK"))
                {
                    btnMovieTalk.Visible = true;
                    btnMovieTalk.Location = listLocation[index];
                    index++;
                }
                else
                ...
                //=================================================================================
                //list 2
                /*item = GetItemHideButton(res.Dt, "btn_OCS1003R02");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS1003R02"))
                {
                    _isShowBtnOrderGuide = true;

                    if (CheckSizeMainPass()) //638
                    {
                        btnOrderGuide.Visible = true;
                        btnOrderGuide.Location = listLocation[index];
                        index++;
                    }
                    else
                    {
                        btnOrderGuide.Visible = false;
                        _isShowBtnOrderGuide = false;
                    }
                }
                else
                {
                ...
                if (dicListBtnShow.ContainsKey("btn_PRESCRIPTION"))
                {
                    _isShowbBtnPrescriptionPrint = true;

                    if (CheckSizeMainPass()) //638
                    {
                        btnPrescriptionPrint.Visible = true;
                        btnPrescriptionPrint.Location = listLocation[index];
                        index++;
                    }
                    else
                    {
                ...
                {
                    btnPrescriptionPrint.Visible = false;
                    _isShowbBtnPrescriptionPrint = false;
                }

                /*btnPrescriptionPrint*/

                /*item = GetItemHideButton(res.Dt, "btn_OUTSANGU00");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OUTSANGU00"))
                {
                    _isShowBtnOpenOutSang = true;

                    if (CheckSizeMainPass()) //638
                    {
                        btnOpenOutSang.Visible = true;
                        btnOpenOutSang.Location = listLocation[index];
                        index++;
                    }
                    else
                    {
                        btnOpenOutSang.Visible = false;
                        _isShowBtnOpenOutSang = false;
                    }
                }
                else
                {
                ...
                /*item = GetItemHideButton(res.Dt, "btn_OCS0301Q09");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0301Q09"))
                {
                    _isShowBtnSetOrder = true;

                    if (CheckSizeMainPass()) //638
                    {
                        btnSetOrder.Visible = true;
                        btnSetOrder.Location = listLocation[index];
                        index++;
                    }
                    else
                    {
                        btnSetOrder.Visible = false;
                        _isShowBtnSetOrder = false;
                    }
                }
                else
                {
                ...
                /*item = GetItemHideButton(res.Dt, "btn_OCS1003Q09");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS1003Q09"))
                {
                    _isShowBtnOCS1003Q09 = true;

                    if (CheckSizeMainPass()) //638
                    {
                        btnDoOrder.Visible = true;
                        btnDoOrder.Location = listLocation[index];
                        index++;
                    }
                    else
                    {
                        btnDoOrder.Visible = false;
                        _isShowBtnOCS1003Q09 = false;
                    }
                }
                else
                {
                ...
                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U10");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U10"))
                {
                    btnDrgOrder.Visible = true;
                    btnDrgOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnDrgOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U12");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U12"))
                {
                    btnJusaOrder.Visible = true;
                    btnJusaOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnJusaOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U13");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U13"))
                {
                    btnCplOrder.Visible = true;
                    btnCplOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnCplOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U11");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U11"))
                {
                    btnReha.Visible = true;
                    btnReha.Location = listLocation[index];
                    index++;
                }
                else
                    btnReha.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U14");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U14"))
                {
                    btnPfeOrder.Visible = true;
                    btnPfeOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnPfeOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U15");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U15"))
                {
                    btnAplOrder.Visible = true;
                    btnAplOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnAplOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U16");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U16"))
                {
                    btnXrtOrder.Visible = true;
                    btnXrtOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnXrtOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U17");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U17"))
                {
                    btnChuchiOrder.Visible = true;
                    btnChuchiOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnChuchiOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U18");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U18"))
                {
                    btnSusulOrder.Visible = true;
                    btnSusulOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnSusulOrder.Visible = false;

                /*item = GetItemHideButton(res.Dt, "btn_OCS0103U19");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_OCS0103U19"))
                {
                    btnEtcOrder.Visible = true;
                    btnEtcOrder.Location = listLocation[index];
                    index++;
                }
                else
                    btnEtcOrder.Visible = false;

                //Set location btnMore
                /*if (this.Size.Height < 638 && countLstBtnShow >= 22)*/
                if (!btnOrderGuide.Visible && dicListBtnShow.ContainsKey("btn_OCS1003R02")
                    || !btnOpenOutSang.Visible && dicListBtnShow.ContainsKey("btn_OUTSANGU00")
                    || !btnSetOrder.Visible && dicListBtnShow.ContainsKey("btn_OCS0301Q09"))
                {
                    btnMore.Visible = true;
                    /*btnMore.Location = listLocation[index];*/
                    btnMore.Location = new Point(this.Size.Width - 103, btnEtcOrder.Location.Y + 30);
                    index++;
                }
                else
                {
                ...
                /*item = GetItemHideButton(res.Dt, "btn_EPORTVIEWER");
                if (item != null && item.CodeName.Equals("Y"))*/
                if (dicListBtnShow.ContainsKey("btn_EPORTVIEWER"))
                {
            ...
            //CheckMinLocationButton();
        }

        private bool CheckSizeMainPass()
        {
            return this.Size.Height > _minSizeShowLstBtn || (this.Size.Height < _minSizeShowLstBtn && countLstBtnShow < 18);
        }

        public int CheckMinLocationButton()
        {
            List<int> lstMinLocation = new List<int>();
            for (int i = 0; i < lstLocation.Count; i++)
            {
                if (lstLocation[i] > 0)
                {
                    lstMinLocation.Add(lstLocation[i]);
                }
            }
            _firstLocation = lstMinLocation[0];
            for (int i = 1; i < lstMinLocation.Count; i++)
            {
                if (_firstLocation > lstMinLocation[i])
                {
                    _firstLocation = lstMinLocation[i];
                }
            }
        ...
        public void CheckDiscuss(string gwa)
        {
            ...
            if (res.ExecutionStatus == ExecutionStatus.Success)
            {
                if (res.Result != null && res.Result.Trim() == "Y")
                {
                    ...
                    {
                        pbxNotifyON.Location = new Point(5, 150);
                    }*/
                    _isShowBtnDiscuss = true;
                ...
                else
                {
                    //if (NetInfo.Language == LangMode.Vi)
                    //{
                    //    pbxNotifyON.Location = new Point(1, 163);
                    //}
                    _isShowBtnDiscuss = false;
                    btnDiscuss.Visible = false;
                    this.pbxNotifyON.Visible = false;
                }
        ...
        {
            this.toolTip1.SetToolTip(this.btnDoctorView, XMsg.GetField("this.btnDoctorView.Text"));
            ...
            if (NetInfo.Language != LangMode.Jr)
            {
                ...
                this.btnBackupEMR.Location = new System.Drawing.Point(356, 645);

                this.btnDownloadEMR.Location = new System.Drawing.Point(557, 645);
                this.lblDownloadEMR.Location = new System.Drawing.Point(btnDownloadEMR.Location.X + 120 + 2, btnDownloadEMR.Location.Y);

                this.btnDownloadEMR.Location = new System.Drawing.Point(btnBackupEMR.Location.X + btnBackupEMR.Size.Width + 2, 645);
                lblDownloadEMR.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
        ...
        private void LoadDiscussNotify()
        {
            ...
            if (result.ExecutionStatus == ExecutionStatus.Success)
            {
                ...
                string a = CacheService.Instance.Get<string>(CACHE_LAST_MSG_TIME);
        ...
        private void btnMore_Click(object sender, EventArgs e)
        {
            ...
            if (button != null)
                this.mPopupMenuBtnLeftScreen.TrackPopup(this.PointToScreen(new Point(button.Location.X, button.Location.Y + 28)));
        }
    ...
    {
        private OCS2015U00 parent = null;
        private IHIS.OCS.OrderBiz mOrderBiz = new OrderBiz("OCS2015U00");

        public XSavePeformer(OCS2015U00 parent)
        {
            this.parent = parent;
        }

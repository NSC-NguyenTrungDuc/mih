...
/**
 * The persistent class for the BAS0103 database table.
 * 
 */
@Entity
@NamedQuery(name="Bas0103.findAll", query="SELECT b FROM Bas0103 b")
public class Bas0103 extends BaseEntity {

...
/**
 * The persistent class for the DRG5030 database table.
 * 
 */
@Entity
@NamedQuery(name="Drg5030.findAll", query="SELECT d FROM Drg5030 d")
public class Drg5030 extends BaseEntity {
	...
	public double getPkdrg5030() {
		return this.pkdrg5030;
	}

	public void setPkdrg5030(double pkdrg5030) {
		this.pkdrg5030 = pkdrg5030;
	}

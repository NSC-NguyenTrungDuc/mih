namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U03C : UserControl
    {
        public OCS2015U03C()
        {
            InitializeComponent();
        ...
        public void GetEmrClinicRefer(string bunho)
        {
            ...
            {
                Service.WriteLog("Exception on Method GetEmrClinicRefer(): " + ex.StackTrace);
            }
        }
        ...
        private void GenerateExamTreeview(string gwa)
        {
            ...
            {
                Service.WriteLog("Exception on Method GenerateExamTreeview(): " + ex.StackTrace);
            }
        }
        ...
        private void BindingIntruduceLetterToTreeView()
        {
            ...
            {
                Service.WriteLog("Exception on Method BindingIntruduceLetterToTreeView(): " + ex.StackTrace);
            }
        }

...
/**
 * The persistent class for the PHY2000 database table.
 * 
 */
@Entity
@NamedQuery(name="Phy2000.findAll", query="SELECT p FROM Phy2000 p")
public class Phy2000 extends BaseEntity {
	...
	public double getPkphy2000() {
		return this.pkphy2000;
	}

	public void setPkphy2000(double pkphy2000) {
		this.pkphy2000 = pkphy2000;
	}

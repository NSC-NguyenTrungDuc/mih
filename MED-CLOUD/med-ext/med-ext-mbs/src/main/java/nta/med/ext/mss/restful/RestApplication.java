package nta.med.ext.mss.restful;
...
public class RestApplication extends Lifecyclet {
    ...
    @Override
    protected long doStop(long l, TimeUnit timeUnit) throws Exception {
        return 0;
    }
    ...
    final class XResourceConfig extends ResourceConfig {
        ...
        public XResourceConfig() {
            ...
            packages("nta.med.ext.mss.restful");

            property(ServerProperties.METAINF_SERVICES_LOOKUP_DISABLE, true);
            property("contextConfigLocation", "classpath:/META-INF/spring/spring-master-mss.xml");

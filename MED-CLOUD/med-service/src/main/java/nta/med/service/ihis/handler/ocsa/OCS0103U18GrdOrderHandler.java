...
import nta.med.service.ihis.proto.OcsaServiceProto.OCS0103U18GrdOrderRequest;
import nta.med.service.ihis.proto.OcsaServiceProto.OCS0103U18GrdOrderResponse;
...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class OCS0103U18GrdOrderHandler
	extends ScreenHandler<OcsaServiceProto.OCS0103U18GrdOrderRequest, OcsaServiceProto.OCS0103U18GrdOrderResponse> {                     
	private static final Log LOGGER = LogFactory.getLog(OCS0103U18GrdOrderHandler.class);                                    
	@Resource                                                                                                       
	private Ocs1003Repository ocs1003Repository;                                                                    
	                                                                                                                
	@Override                   
	@Transactional(readOnly = true)
	public OCS0103U18GrdOrderResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId, OCS0103U18GrdOrderRequest request)
			throws Exception {                                                                   
  	   	OcsaServiceProto.OCS0103U18GrdOrderResponse.Builder response = OcsaServiceProto.OCS0103U18GrdOrderResponse.newBuilder();                      
		List<OCS0103U13GrdOrderListInfo> listGrdOrder = ocs1003Repository.getOCS0103U13GrdOrderListInfo(getHospitalCode(vertx, sessionId), getLanguage(vertx, sessionId),
				request.getOrderMode(),request.getMemb(),request.getYaksokCode(),request.getInputTab(),CommonUtils.parseDouble(request.getFkInOutKey()),"OCS0103U18GrdOrderRequest");
		if(!CollectionUtils.isEmpty(listGrdOrder)){
			for(OCS0103U13GrdOrderListInfo item : listGrdOrder){
				...
				response.addGridOrderInfo(info);
			}
		}        

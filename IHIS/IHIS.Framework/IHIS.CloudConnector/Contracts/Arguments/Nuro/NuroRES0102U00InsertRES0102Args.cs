...
namespace IHIS.CloudConnector.Contracts.Arguments.Nuro
{
    ...
    {
        protected bool Equals(NuroRES0102U00InsertRES0102Args other)
        {
            return string.Equals(_userId, other._userId) && string.Equals(_doctor, other._doctor) && string.Equals(_avgTime, other._avgTime) && string.Equals(_amStartHhmm1, other._amStartHhmm1) && string.Equals(_amStartHhmm5, other._amStartHhmm5) && string.Equals(_amEndHhmm1, other._amEndHhmm1) && string.Equals(_amEndHhmm5, other._amEndHhmm5) && string.Equals(_pmStartHhmm1, other._pmStartHhmm1) && string.Equals(_pmStartHhmm5, other._pmStartHhmm5) && string.Equals(_pmEndHhmm1, other._pmEndHhmm1) && string.Equals(_pmEndHhmm5, other._pmEndHhmm5) && string.Equals(_amGwaRoom1, other._amGwaRoom1) && string.Equals(_amGwaRoom5, other._amGwaRoom5) && string.Equals(_pmGwaRoom1, other._pmGwaRoom1) && string.Equals(_pmGwaRoom5, other._pmGwaRoom5) && string.Equals(_resAmStartHhmm1, other._resAmStartHhmm1) && string.Equals(_resAmStartHhmm5, other._resAmStartHhmm5) && string.Equals(_resAmEndHhmm1, other._resAmEndHhmm1) && string.Equals(_resAmEndHhmm5, other._resAmEndHhmm5) && string.Equals(_resPmStartHhmm1, other._resPmStartHhmm1) && string.Equals(_resPmStartHhmm5, other._resPmStartHhmm5) && string.Equals(_resPmEndHhmm1, other._resPmEndHhmm1) && string.Equals(_resPmEndHhmm5, other._resPmEndHhmm5) && string.Equals(_docResLimit, other._docResLimit) && string.Equals(_gwa, other._gwa) && string.Equals(_jinryoBreakYn, other._jinryoBreakYn) && string.Equals(_amStartHhmm2, other._amStartHhmm2) && string.Equals(_amStartHhmm6, other._amStartHhmm6) && string.Equals(_amEndHhmm2, other._amEndHhmm2) && string.Equals(_amEndHhmm6, other._amEndHhmm6) && string.Equals(_pmStartHhmm2, other._pmStartHhmm2) && string.Equals(_pmStartHhmm6, other._pmStartHhmm6) && string.Equals(_pmEndHhmm2, other._pmEndHhmm2) && string.Equals(_pmEndHhmm6, other._pmEndHhmm6) && string.Equals(_amGwaRoom2, other._amGwaRoom2) && string.Equals(_amGwaRoom6, other._amGwaRoom6) && string.Equals(_pmGwaRoom2, other._pmGwaRoom2) && string.Equals(_pmGwaRoom6, other._pmGwaRoom6) && string.Equals(_resAmStartHhmm2, other._resAmStartHhmm2) && string.Equals(_resAmStartHhmm6, other._resAmStartHhmm6) && string.Equals(_resAmEndHhmm2, other._resAmEndHhmm2) && string.Equals(_resAmEndHhmm6, other._resAmEndHhmm6) && string.Equals(_resPmStartHhmm2, other._resPmStartHhmm2) && string.Equals(_resPmStartHhmm6, other._resPmStartHhmm6) && string.Equals(_resPmEndHhmm2, other._resPmEndHhmm2) && string.Equals(_resPmEndHhmm6, other._resPmEndHhmm6) && string.Equals(_etcResLimit, other._etcResLimit) && string.Equals(_startDate, other._startDate) && string.Equals(_amStartHhmm3, other._amStartHhmm3) && string.Equals(_amStartHhmm7, other._amStartHhmm7) && string.Equals(_amEndHhmm3, other._amEndHhmm3) && string.Equals(_amEndHhmm7, other._amEndHhmm7) && string.Equals(_pmStartHhmm3, other._pmStartHhmm3) && string.Equals(_pmStartHhmm7, other._pmStartHhmm7) && string.Equals(_pmEndHhmm3, other._pmEndHhmm3) && string.Equals(_pmEndHhmm7, other._pmEndHhmm7) && string.Equals(_amGwaRoom3, other._amGwaRoom3) && string.Equals(_amGwaRoom7, other._amGwaRoom7) && string.Equals(_pmGwaRoom3, other._pmGwaRoom3) && string.Equals(_pmGwaRoom7, other._pmGwaRoom7) && string.Equals(_resAmStartHhmm3, other._resAmStartHhmm3) && string.Equals(_resAmStartHhmm7, other._resAmStartHhmm7) && string.Equals(_resAmEndHhmm3, other._resAmEndHhmm3) && string.Equals(_resAmEndHhmm7, other._resAmEndHhmm7) && string.Equals(_resPmStartHhmm3, other._resPmStartHhmm3) && string.Equals(_resPmStartHhmm7, other._resPmStartHhmm7) && string.Equals(_resPmEndHhmm3, other._resPmEndHhmm3) && string.Equals(_resPmEndHhmm7, other._resPmEndHhmm7) && string.Equals(_endDate, other._endDate) && string.Equals(_amStartHhmm4, other._amStartHhmm4) && string.Equals(_amEndHhmm4, other._amEndHhmm4) && string.Equals(_pmStartHhmm4, other._pmStartHhmm4) && string.Equals(_pmEndHhmm4, other._pmEndHhmm4) && string.Equals(_amGwaRoom4, other._amGwaRoom4) && string.Equals(_pmGwaRoom4, other._pmGwaRoom4) && string.Equals(_resAmStartHhmm4, other._resAmStartHhmm4) && string.Equals(_resAmEndHhmm4, other._resAmEndHhmm4) && string.Equals(_resPmStartHhmm4, other._resPmStartHhmm4) && string.Equals(_resPmEndHhmm4, other._resPmEndHhmm4) && string.Equals(_hospCode, other._hospCode);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NuroRES0102U00InsertRES0102Args) obj);
        }

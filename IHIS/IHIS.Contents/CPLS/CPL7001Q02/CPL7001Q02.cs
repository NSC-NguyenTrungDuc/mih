...
namespace IHIS.CPLS
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CPL7001Q02 : IHIS.Framework.XScreen
    {
  ...
  //      private IHIS.Framework.XDataWindow dwMonthlyReport;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CPL7001Q02));
            ...
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Query, System.Windows.Forms.Shortcut.None, global::IHIS.CPLS.Properties.Resources.BTN_QUERY, -1, ""),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Preview, System.Windows.Forms.Shortcut.None, global::IHIS.CPLS.Properties.Resources.BTN_PREVIEW, -1, ""),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Print, System.Windows.Forms.Shortcut.None, global::IHIS.CPLS.Properties.Resources.BTN_PRINT, -1, ""),
            new IHIS.Framework.CustomFunctionItem(IHIS.Framework.FunctionType.Close, System.Windows.Forms.Shortcut.None, global::IHIS.CPLS.Properties.Resources.BTN_CLOSE, -1, "")});
        ...
        {
            base.OnLoad(e);
            ApplyMultiLangueDataWindow();

            this.btnList.PerformClick(FunctionType.Query);
        }

        private void ApplyMultiLangueDataWindow()
        {
            //dwMonthlyReport
            ...
            //dwMonthlyReport.Modify(string.Format("t_10.text = '{0}'", Properties.Resources.DW_TXT_047));
            ...
            //    dwMonthlyReport.Modify("t_4.Font.Height='18'");
...
//                                                       TO_CHAR(TO_DATE(X.YYYYMM, 'YYYYMM'), 'YYYY/MM')           YYYYMM
...
//                                                  FROM
//                                                      (SELECT DECODE(GROUPING(SUBSTR(TO_CHAR(NVL(A.RESER_DATE, A.ORDER_DATE), 'YYYYMMDD'), 0, 6))
...
//                                                            , DECODE(GROUPING(A.HANGMOG_CODE) , 1, '合計' , A.HANGMOG_CODE)  HANGMOG_CODE
//                                                            , DECODE(GROUPING(A.HANGMOG_CODE) , 1, ' ', MAX(B.GUMSA_NAME)) GUMSA_NAME
...
//                                                GROUP BY X.YYYYMM, X.HANGMOG_CODE
//                                                ORDER BY X.YYYYMM, X.HANGMOG_CODE";
            #endregion

            // Updated by Cloud
            layMonthlyReport.ExecuteQuery = GetLayMonthlyReport;
            ...
            this.layMonthlyReport.SetBindVarValue("f_uitak_code", this.cboPart.GetDataValue());
    ...
    //        dwMonthlyReport.Refresh();
        ...
        private void btnList_ButtonClick(object sender, IHIS.Framework.ButtonClickEventArgs e)
        {
            switch( e.Func )
            {
                ...
                case FunctionType.Print:
                    ...
                    //{
                    //    //this.dwMonthlyReportPrn.FillData(this.layMonthlyReport.LayoutTable);

                    //    //this.dwMonthlyReportPrn.Refresh();

                    //    //this.dwMonthlyReportPrn.Print();
        ...
        #region GetLayMonthlyReport
        /// <summary>
        /// GetLayMonthlyReport
        /// </summary>
        /// <param name="bvc"></param>
        /// <returns></returns>
        private IList<object[]> GetLayMonthlyReport(BindVarCollection bvc)
        {
            IList<object[]> lObj = new List<object[]>();

            CPL7001Q02LayMonthlyReportArgs args = new CPL7001Q02LayMonthlyReportArgs();
            ...
            CPL7001Q02LayMonthlyReportResult res = CloudService.Instance.Submit<CPL7001Q02LayMonthlyReportResult,
                CPL7001Q02LayMonthlyReportArgs>(args);

            if (res.ExecutionStatus == ExecutionStatus.Success)
            {
                res.ListItem.ForEach(delegate(CPL7001Q02LayMonthlyReportInfo item)
                {
                    lObj.Add(new object[]
                    {
                        item.Yyyymm,

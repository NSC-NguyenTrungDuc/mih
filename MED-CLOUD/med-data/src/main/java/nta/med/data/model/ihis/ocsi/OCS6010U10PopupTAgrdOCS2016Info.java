...
public class OCS6010U10PopupTAgrdOCS2016Info {
	...
	public OCS6010U10PopupTAgrdOCS2016Info(Double pkocs2016, Double fkocs2015, Double seq, String hangmogCode,
			String hangmogName, Double suryang, Double nalsu, String ordDanui, String bogyongCode, String jusaCode,
			String jusaSpdGubun, Double dv, String dvTime, Double fkocs2003, String bomYn, Double bomSourceKey,
			String dataRowStage) {
		super();

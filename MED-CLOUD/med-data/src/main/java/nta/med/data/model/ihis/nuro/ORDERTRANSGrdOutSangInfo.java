...
public class ORDERTRANSGrdOutSangInfo {
	...
	private String postModifier_name    ;
	private Date sangStartDate       ;
	private String sangStartDateJp    ;
	private Date sangEndDate         ;
	private String sangEndDateJp      ;
	private String sangEndSayu         ;
	private String sangEndSayuName    ;
	private String juSangYn            ;
	private String contKey              ;
	public ORDERTRANSGrdOutSangInfo(String bunho, String gwa, String gwaName,
			String ioGubun, Double pkSeq, Double ser, String sangCode,
			String preName, String sangName, String preModifier1,
			String preModifier2, String preModifier3, String preModifier4,
			String preModifier5, String preModifier6, String preModifier7,
			String preModifier8, String preModifier9, String preModifier10,
			String preModifierName, String postModifier1, String postModifier2,
			String postModifier3, String postModifier4, String postModifier5,
			String postModifier6, String postModifier7, String postModifier8,
			String postModifier9, String postModifier10,
			String postModifier_name, Date sangStartDate,
			String sangStartDateJp, Date sangEndDate, String sangEndDateJp,
			String sangEndSayu, String sangEndSayuName, String juSangYn,
			String contKey) {
		super();
		this.bunho = bunho;
		this.gwa = gwa;
		...
		this.postModifier_name = postModifier_name;
		this.sangStartDate = sangStartDate;
		this.sangStartDateJp = sangStartDateJp;
		this.sangEndDate = sangEndDate;
		this.sangEndDateJp = sangEndDateJp;
	...
	public String getPostModifier_name() {
		return postModifier_name;
	}
	public void setPostModifier_name(String postModifier_name) {
		this.postModifier_name = postModifier_name;
	}
	...
	public String getSangStartDateJp() {
		return sangStartDateJp;
	}
	public void setSangStartDateJp(String sangStartDateJp) {
		this.sangStartDateJp = sangStartDateJp;
	}
	...
	public String getSangEndDateJp() {
		return sangEndDateJp;
	}
	public void setSangEndDateJp(String sangEndDateJp) {
		this.sangEndDateJp = sangEndDateJp;
	}

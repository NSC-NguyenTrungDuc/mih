...
/**
 * The persistent class for the BAS0310_1025 database table.
 * 
 */
@Entity
@Table(name="BAS0310_1025")
@NamedQuery(name="Bas03101025.findAll", query="SELECT b FROM Bas03101025 b")
public class Bas03101025 extends BaseEntity {

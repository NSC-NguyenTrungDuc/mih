...
{
    public class OUTSANGU00GrdOCS0301Info
    {
        ...
        public OUTSANGU00GrdOCS0301Info() { }

        public OUTSANGU00GrdOCS0301Info(String memb, String pkSeq, String yaksokGubun, String yaksokGubunName, String yaksokCode, String yaksokName, String inputTab, String pkYaksok, String inputTabName)
        {
            this._memb = memb;
            this._pkSeq = pkSeq;

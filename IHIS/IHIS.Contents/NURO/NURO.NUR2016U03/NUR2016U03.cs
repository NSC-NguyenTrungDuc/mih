...
namespace IHIS.NURO
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class NUR2016U03 : IHIS.Framework.XScreen
    {
        #region 화면변수
        ...
        private XDictComboBox cboTime1;
        private XCheckBox cbxAutoSent;
        private XButton btnDisplayOrderTran;
        ...
        public NUR2016U03()
        {
            ...
            {
                grdPatientList.AutoSizeColumn(xEditGridCell36.Col, 50);
                grdPatientList.AutoSizeColumn(xEditGridCell2.Col, 190);
                grdPatientList.AutoSizeColumn(xEditGridCell3.Col, 190);
                grdPatientList.AutoSizeColumn(xEditGridCell7.Col, 120);
                grdPatientList.AutoSizeColumn(xEditGridCell14.Col, 55);
                grdPatientList.AutoSizeColumn(xEditGridCell15.Col, 47);
                grdPatientList.AutoSizeColumn(xEditGridCell20.Col, 70);
                grdPatientList.AutoSizeColumn(xEditGridCell21.Col, 54);
                grdPatientList.AutoSizeColumn(xEditGridCell22.Col, 260);
                grdPatientList.AutoSizeColumn(xEditGridCell25.Col, 49);
            }
        }
        #endregion
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NUR2016U03));
            ...
            this.cboTime1 = new IHIS.Framework.XDictComboBox();
            this.cbxAutoSent = new IHIS.Framework.XCheckBox();
            ...
            this.btnDisplayOrderTran = new IHIS.Framework.XButton();
            ...
            // pnlBottom
            // 
            this.pnlBottom.Controls.Add(this.cboTime1);
            this.pnlBottom.Controls.Add(this.cbxAutoSent);
            ...
            // cboTime1
            // 
            resources.ApplyResources(this.cboTime1, "cboTime1");
            this.cboTime1.ExecuteQuery = null;
            this.cboTime1.Name = "cboTime1";
            this.cboTime1.ParamList = ((System.Collections.Generic.List<string>)(resources.GetObject("cboTime1.ParamList")));
            this.cboTime1.SQLType = IHIS.Framework.XComboSQLType.UserSQL;
            this.cboTime1.MouseMove += new System.Windows.Forms.MouseEventHandler(this.cboTime1_MouseMove);
            this.cboTime1.SelectedValueChanged += new System.EventHandler(this.cboTime_SelectedValueChanged);
            // 
            // cbxAutoSent
            // 
            resources.ApplyResources(this.cbxAutoSent, "cbxAutoSent");
            this.cbxAutoSent.Name = "cbxAutoSent";
            this.cbxAutoSent.UseVisualStyleBackColor = false;
            this.cbxAutoSent.CheckedChanged += new System.EventHandler(this.cbxAutoSent_CheckedChanged);
            this.cbxAutoSent.MouseMove += new System.Windows.Forms.MouseEventHandler(this.cboTime1_MouseMove);
            // 
            // cboTime
            // 
            ...
            this.grdPatientList.ColPerLine = 19;
            this.grdPatientList.Cols = 20;
            ...
            this.grdPatientList.HeaderHeights.Add(39);
            ...
            // xEditGridCell37
            // 
            this.xEditGridCell37.CellName = "order_status";
            ...
            this.xEditGridCell36.HeaderImageAlign = System.Drawing.ContentAlignment.MiddleCenter;
            ...
            this.xEditGridCell22.RowDrawMode = IHIS.Framework.XCellDrawMode.Vertical;
            ...
            this.xEditGridCell27.CellWidth = 72;
            ...
            this.pnlOtherClinic.Controls.Add(this.btnDisplayOrderTran);
            ...
            this.btnAction.ImageIndex = 22;
            
            
            this.btnAction.ImageList = this.ImageList;
            ...
            // btnDisplayOrderTran
            // 
            resources.ApplyResources(this.btnDisplayOrderTran, "btnDisplayOrderTran");
            this.btnDisplayOrderTran.ImageList = this.ImageList;
            this.btnDisplayOrderTran.Name = "btnDisplayOrderTran";
            this.btnDisplayOrderTran.Click += new System.EventHandler(this.btnDisplayOrderTran_Click);
            // 
            // btnUpdateClinicsEmr
            // 
            ...
            // xEditGridCell38
            // 
            this.xEditGridCell38.CellName = "sys_id";
        ...
        private IList<object[]> GetPatientList(BindVarCollection list)
        {
            ...
            {
                // set arguments
                NUR2016U02NuroPatientListArgs nuroPatientListArgs = new NUR2016U02NuroPatientListArgs();
                ...
                // get results
                NUR2016U02NuroPatientListResult result =
                    CloudService.Instance.Submit<NUR2016U02NuroPatientListResult, NUR2016U02NuroPatientListArgs>(nuroPatientListArgs);
                gridList = new List<object[]>();
                IList<NUR2016U02NuroPatientListItemInfo> patientListItems = result.PatientListItem;
                foreach (NUR2016U02NuroPatientListItemInfo item in patientListItems)
                {
                    string actingDate = Resources.ResourceManager.GetString(item.ActingDate);
                    ...
                    gridList.Add(new object[]
                    {
                        ...
                        item.ReserYn,
                        item.IpwonYn,
                        //item.SunabYn, -- change by if_data_sent_yn
                        item.IfDataSentYn,
                        item.ComingStatus,
                        item.ReceptionType,
        ...
        private void grdPatientList_GridCellPainting(object sender, IHIS.Framework.XGridCellPaintEventArgs e)
        {
            ...
            else if (e.DataRow["reser_yn"].ToString() == "Y")
            {
        ...
        private void cboTime_SelectedValueChanged(object sender, EventArgs e)
        {
            if (this.cboTime.GetDataValue() != "")
                this.timer1.Interval = Int32.Parse(this.cboTime.GetDataValue());
            if (this.cboTime1.GetDataValue() != "")
                this.timer2.Interval = Int32.Parse(this.cboTime1.GetDataValue());
        ...
        private void btnJubsu_Click(object sender, EventArgs e)
        {
            ...
            JubsuForm jubsuForm = new JubsuForm(this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "pkout1001"), this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "bunho"));
        ...
        private class XSavePerformer : ISavePerformer
        {
            ...
            public XSavePerformer(NUR2016U03 parent)
            {
                this.parent = parent;
            }
        ...
        private InitializeComboListItemResult initializeComboListItem()
        {
            ...
            if (result != null)
            {
                ...
                cboTime1.SetDictDDLB(createListDataForCombo(result.ComboTimeItem));
        ...
        private void SyncPatientMisa()
        {
            ...
            DateTime currentDate = DateTime.ParseExact(dtpNaewonDate.Text, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
        ...
        #region Feature 1.3.4
        private void cboTime1_MouseMove(object sender, MouseEventArgs e)
        {
            this.timer2.Stop();
            this.timer2.Start();
        }

        private void cbxAutoSent_CheckedChanged(object sender, EventArgs e)
        {
            if (cbxAutoSent.Checked)
            {
                this.cboTime1.Enabled = true;
                this.timer2.Interval = Int32.Parse(this.cboTime1.GetDataValue());
            }
            else
            {
                this.cboTime1.Enabled = false;
            }
        }

        private void timer2_Tick(object sender, EventArgs e)
        {
            if (this.cbxAutoSent.Checked)
            {
                if (!String.IsNullOrEmpty(UserInfo.OrcaIp))
                {
                    try
                    {
                        //Open thread auto tranfer
                        //Thread thread = new Thread(new ThreadStart(autoTranferOrca));
                        //thread.Start();
                        autoTranferOrca();
                    }
                    catch (Exception ex)
                    {
                        Service.WriteLog("NUR2016U02 - ERROR:   " + ex);
                    }
                }
                
            }
        }
        private void autoTranferOrca()
        {            
        ...
        private void btnDisplayOrderTran_Click(object sender, EventArgs e)
        {
            ...
            if (grdPatientList.RowCount > 0)
            {
                param.Add("bunho", this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "bunho"));
                param.Add("naewon_date", this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "naewon_date"));
                //param.Add("io_gubun", this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "io_gubun")); 
                param.Add("io_gubun", "");

                if (this.grdPatientList.GetItemString(this.grdPatientList.CurrentRowNumber, "reser_yn").ToString() == "Y")
                {
                    XMessageBox.Show(Resources.MSG036_MSG, Resources.MSG036_CAP, MessageBoxIcon.Warning);
                }
                else
                {
                    XScreen.OpenScreenWithParam(this, "NURO", "ORDERTRANS", ScreenOpenStyle.ResponseSizable, param);
                }
            }
            else
            {
                XMessageBox.Show(Resources.MSG037_MSG, Resources.MSG037_CAP, MessageBoxIcon.Warning);
            }
        ...
        private bool ProcessTrans(out bool terminated)
        {
            ...
            try
            {
                ...
                List<NUR2016U02TranferInfo> listArgs = new List<NUR2016U02TranferInfo>();
                for (int j = 0; j < grdPatientList.RowCount; j++)
                {
                    if (grdPatientList.GetItemString(j, "sunab_yn") == "O" || grdPatientList.GetItemString(j, "order_end_yn") == "N" || grdPatientList.GetItemString(j, "order_status") == "未処理オーダ有り")
                    { 
                        continue; 
                    }
                    else
                    {
                        listArgs.Clear();
                        NUR2016U02TranferInfo item1 = new NUR2016U02TranferInfo();
                        item1.Bunho = grdPatientList.GetItemString(j, "bunho");
                        item1.Pkout1001 = grdPatientList.GetItemString(j, "pkout1001");
                        listArgs.Add(item1);


                        // Load base info
                        //NUR2016U02TranferArgs args = new NUR2016U02TranferArgs();

                        NUR2016U03TranferArgs args = new NUR2016U03TranferArgs();
                        args.ListItem = listArgs;
                        UpdateResult res = CloudService.Instance.Submit<UpdateResult, NUR2016U03TranferArgs>(args);
                        //NUR2016U02TranferResult res = CloudService.Instance.Submit<NUR2016U02TranferResult, NUR2016U02TranferArgs>(args);
                        ...
                        #region Update due to logic MED-13853
                        ...
                        //    header.Bunho = grdPatientList.GetItemString(j, "bunho");
                        //    // https://sofiamedix.atlassian.net/browse/MED-10921
                        ...
                        //        if (res.ListinfoItem.Count > 0)
                        //        {
                        //            for (int k = 0; k < res.ListinfoItem.Count; k++)
                        //            {

                        //                if (res.ListinfoItem[k].Bunho != grdPatientList.GetItemString(j, "bunho"))
                        //                {
                        //                    continue;
                        //                }
                        //                else
                        //                {
                        //                    List<NuroORDERTRANSUpdateOCS1003Info> dataList = new List<NuroORDERTRANSUpdateOCS1003Info>();
                        //                    if (res.ListinfoItem[k].ListItem.Count > 0)
                        //                    {
                        //                        for (int l = 0; l < res.ListinfoItem[k].ListItem.Count; l++)
                        //                        {
                        //                            NuroORDERTRANSUpdateOCS1003Info updItem = new NuroORDERTRANSUpdateOCS1003Info();
                        //                            updItem.Pkocs1003 = res.ListinfoItem[k].ListItem[l].Pkocs;
                        //                            updItem.SunabDate = dtpNaewonDate.GetDataValue().ToString();
                        //                            dataList.Add(updItem);
                        //                        }
                        ...
                        //                    updArgs.Pkout1001 = grdPatientList.GetItemString(j, "pkout1001");
                        //                    updArgs.Bunho = grdPatientList.GetItemString(j, "bunho");

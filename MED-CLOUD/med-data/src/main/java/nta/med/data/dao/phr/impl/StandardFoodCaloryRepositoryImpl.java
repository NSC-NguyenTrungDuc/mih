...
import nta.med.data.dao.phr.StandardFoodCaloryRepositoryCustom;
import nta.med.data.model.phr.StandardFoodCaloriesInfo;

public class StandardFoodCaloryRepositoryImpl implements StandardFoodCaloryRepositoryCustom{
	
	@PersistenceContext
	private EntityManager entityManager;

	@Override
	public List<StandardFoodCaloriesInfo> getPhrStandardFoodCaloryByprofileIdAndType(Long profileId, Long durationType) {
		
		StringBuilder sql = new StringBuilder();
		sql.append("     SELECT                                                                                           							    ");
		sql.append("       A.ID,                                                                                           								");
		sql.append("       A.RATING, A.EATING_TIME, SUM(A.KCAL),                                                                                                							");
...
//		}
		...
		sql.append("     FROM PHR_STANDARD_FOOD_CALORIES A                                                                                              ");
		...
		List<StandardFoodCaloriesInfo> standardFoodCalories = new JpaResultMapper().list(query, StandardFoodCaloriesInfo.class);
		return standardFoodCalories;
	}

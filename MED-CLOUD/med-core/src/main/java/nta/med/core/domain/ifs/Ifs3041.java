...
/**
 * The persistent class for the IFS3041 database table.
 * 
 */
@Entity
@NamedQuery(name="Ifs3041.findAll", query="SELECT i FROM Ifs3041 i")
public class Ifs3041 extends BaseEntity {
	...
	public double getPkifs3041() {
		return this.pkifs3041;
	}

	public void setPkifs3041(double pkifs3041) {
		this.pkifs3041 = pkifs3041;
	}

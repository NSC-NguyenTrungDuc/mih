...
namespace IHIS.CloudConnector.Contracts.Arguments.Nuro
{
    ...
    {
        protected bool Equals(NuroRES1001U00ReservationScheduleCondition2ListArgs other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NuroRES1001U00ReservationScheduleCondition2ListArgs) obj);
        }
        ...
        public NuroRES1001U00ReservationScheduleCondition2ListArgs(String doctorCode, String examPreDate, String hospCodeLink, Boolean tabIsAll)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.NuroRES1001U00ReservationScheduleCondition2ListRequest();
        }
    }
}
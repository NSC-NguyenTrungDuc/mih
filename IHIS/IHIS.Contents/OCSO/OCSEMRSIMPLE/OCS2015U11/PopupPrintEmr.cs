...
namespace EmrDocker
{
    public partial class PopupPrintEmr : Form
    {
        ...
        private void SaveFileHtml(string path, string data)
        {
            try
            {
                //file:///C:/ihis/OCSO/abcPlan_document_for_home_care.html
            ...
            {
                Service.WriteLog("Error on method: SaveFileHtml()" + ex.StackTrace);
            }
        }

...
/**
 * The persistent class for the OCS2019 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs2019.findAll", query="SELECT o FROM Ocs2019 o")
public class Ocs2019 extends BaseEntity {

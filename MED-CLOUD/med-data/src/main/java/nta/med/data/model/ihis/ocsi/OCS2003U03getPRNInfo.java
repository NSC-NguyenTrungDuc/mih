...
public class OCS2003U03getPRNInfo {
	...
	private String naslu;
	private String divide;
	private String ordSuryang;
	private String orderSuryang;
	...
	private String hodongOrdName;
	private String maxBannabYn;
	
	public OCS2003U03getPRNInfo( String bunho, Double drgBunho, Double groupSer, String jubsuDate, String orderDate, String jaeryoCode, String naslu, 
			String divide, String ordSuryang, String orderSuryang, String orderDanui, String subulDanui, String bogyongCode, String bogyongName, 
			String cautionName, String mixYn, String actYn, String dv, String dvTime, String dcYn, String bannabYn, String sourceFkocs2003, Double fkocs2003,
			String sunabDate, String pattern, String jaeryoName, String sunabNalsu, String wonyoiYn, String orderRemark, String actDate, String uiJusaYn,
			String subulSuryang, String serialV, String gwaName, String doctorName, String otherGwa, String hopeDate, String powderYn, String line,
			String ordDanui2, String bunryu1, String hoDong, String hoCode, String donbok, String tusuk, String magamGubun, String textColor, String changgo,
			String fromOrderDate, String toOrderDate, String dataGubun, String hodongOrdName, String maxBannabYn){
		this.bunho = bunho;
		...
		this.hodongOrdName = hodongOrdName;
		this.maxBannabYn = maxBannabYn;
	...
	public String getNaslu() {
		return naslu;
	}

	public void setNaslu(String naslu) {
		this.naslu = naslu;
	}
	...
	public String getOrdSuryang() {
		return ordSuryang;
	}

	public void setOrdSuryang(String ordSuryang) {
		this.ordSuryang = ordSuryang;
	}

	public String getOrderSuryang() {
		return orderSuryang;
	}

	public void setOrderSuryang(String orderSuryang) {
		this.orderSuryang = orderSuryang;
	}
	...
	public String getSourceFkocs2003() {
		return sourceFkocs2003;
	}

	public void setSourceFkocs2003(String sourceFkocs2003) {
		this.sourceFkocs2003 = sourceFkocs2003;
	}
	...
	public String getWonyoiYn() {
		return wonyoiYn;
	}

	public void setWonyoiYn(String wonyoiYn) {
		this.wonyoiYn = wonyoiYn;
	}
	...
	public String getUiJusaYn() {
		return uiJusaYn;
	}

	public void setUiJusaYn(String uiJusaYn) {
		this.uiJusaYn = uiJusaYn;
	}

	public String getSubulSuryang() {
		return subulSuryang;
	}

	public void setSubulSuryang(String subulSuryang) {
		this.subulSuryang = subulSuryang;
	}
	...
	public String getOtherGwa() {
		return otherGwa;
	}

	public void setOtherGwa(String otherGwa) {
		this.otherGwa = otherGwa;
	}
	...
	public String getOrdDanui2() {
		return ordDanui2;
	}

	public void setOrdDanui2(String ordDanui2) {
		this.ordDanui2 = ordDanui2;
	}
	...
	public String getTusuk() {
		return tusuk;
	}

	public void setTusuk(String tusuk) {
		this.tusuk = tusuk;
	}
	...
	public String getHodongOrdName() {
		return hodongOrdName;
	}

	public void setHodongOrdName(String hodongOrdName) {
		this.hodongOrdName = hodongOrdName;
	}

	public String getMaxBannabYn() {
		return maxBannabYn;
	}

	public void setMaxBannabYn(String maxBannabYn) {
		this.maxBannabYn = maxBannabYn;
	}
}

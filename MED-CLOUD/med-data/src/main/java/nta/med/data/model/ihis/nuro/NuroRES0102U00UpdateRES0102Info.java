...
public class NuroRES0102U00UpdateRES0102Info {
	...
	private String docResLimit;
	private String etcResLimit;
	private String endDate;
	private String doctor;
	private String startDate;
	private String outHospResLimit;//f_out_hosp_res_limit
	
	
	
	public NuroRES0102U00UpdateRES0102Info() {
		super();
	}

	public NuroRES0102U00UpdateRES0102Info(String userId, String avgTime,
			String jinryoBreakYn, String amStartHhmm1, String amStartHhmm2,
			String amStartHhmm3, String amStartHhmm4, String amStartHhmm5,
			String amStartHhmm6, String amStartHhmm7, String amEndHhmm1,
			String amEndHhmm2, String amEndHhmm3, String amEndHhmm4,
			String amEndHhmm5, String amEndHhmm6, String amEndHhmm7,
			String pmStartHhmm1, String pmStartHhmm2, String pmStartHhmm3,
			String pmStartHhmm4, String pmStartHhmm5, String pmStartHhmm6,
			String pmStartHhmm7, String pmEndHhmm1, String pmEndHhmm2,
			String pmEndHhmm3, String pmEndHhmm4, String pmEndHhmm5,
			String pmEndHhmm6, String pmEndHhmm7, String amGwaRoom1,
			String amGwaRoom2, String amGwaRoom3, String amGwaRoom4,
			String amGwaRoom5, String amGwaRoom6, String amGwaRoom7,
			String pmGwaRoom1, String pmGwaRoom2, String pmGwaRoom3,
			String pmGwaRoom4, String pmGwaRoom5, String pmGwaRoom6,
			String pmGwaRoom7, String resAmStartHhmm1, String resAmStartHhmm2,
			String resAmStartHhmm3, String resAmStartHhmm4,
			String resAmStartHhmm5, String resAmStartHhmm6,
			String resAmStartHhmm7, String resAmEndHhmm1, String resAmEndHhmm2,
			String resAmEndHhmm3, String resAmEndHhmm4, String resAmEndHhmm5,
			String resAmEndHhmm6, String resAmEndHhmm7, String resPmStartHhmm1,
			String resPmStartHhmm2, String resPmStartHhmm3,
			String resPmStartHhmm4, String resPmStartHhmm5,
			String resPmStartHhmm6, String resPmStartHhmm7,
			String resPmEndHhmm1, String resPmEndHhmm2, String resPmEndHhmm3,
			String resPmEndHhmm4, String resPmEndHhmm5, String resPmEndHhmm6,
			String resPmEndHhmm7, String docResLimit, String etcResLimit,
			String endDate, String doctor, String startDate) {
		super();
		this.userId = userId;
	...
	public String getDocResLimit() {
		return docResLimit;
	}

	public void setDocResLimit(String docResLimit) {
		this.docResLimit = docResLimit;
	}

	public String getEtcResLimit() {
		return etcResLimit;
	}

	public void setEtcResLimit(String etcResLimit) {
		this.etcResLimit = etcResLimit;
	}
	...
	public String getOutHospResLimit() {
		return outHospResLimit;
	}

	public void setOutHospResLimit(String outHospResLimit) {

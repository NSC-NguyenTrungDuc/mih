...
/**
 * The persistent class for the OCS0205 database table.
 * 
 */
@Entity
@NamedQuery(name="Ocs0205.findAll", query="SELECT o FROM Ocs0205 o")
@Table(name="OCS0205")
public class Ocs0205 extends BaseEntity {

...
public class DRG3041P06LabelInfo {
    ...
    private String cnt;
	public DRG3041P06LabelInfo(String bunho, String drgBunho, String orderDateText, String jubsuDate, String orderDate,
			String serialV, String serialText, String suname, String suname2, String sexAge, String hoCode,
			String hoDong, String bogyongName, String cnt) {
		super();
		this.bunho = bunho;

...
@Entity
@Table(name = "OCS1003C")
public class Ocs1003C extends BaseEntity {
	...
	public Double getPkocs1003c() {
		return pkocs1003c;
	}

	public void setPkocs1003c(Double pkocs1003c) {
		this.pkocs1003c = pkocs1003c;
	}
	...
	public String toString() {
		return "Ocs1003 [actBuseo=" + actBuseo + ", actDoctor=" + actDoctor + ", actGwa=" + actGwa + ", actingDate="
				+ actingDate + ", actingDay=" + actingDay + ", actingTime=" + actingTime + ", afterActYn=" + afterActYn
				+ ", amt=" + amt + ", antiCancerYn=" + antiCancerYn + ", approveDate=" + approveDate + ", approveId="
				+ approveId + ", approveTime=" + approveTime + ", approveYn=" + approveYn + ", bannabConfirm="
				+ bannabConfirm + ", bannabYn=" + bannabYn + ", bichiYn=" + bichiYn + ", bogyongCode=" + bogyongCode
				+ ", bogyongCodeSub=" + bogyongCodeSub + ", bomOccurYn=" + bomOccurYn + ", bomSourceKey=" + bomSourceKey
				+ ", bunho=" + bunho + ", chisik=" + chisik + ", dangilGumsaOrderYn=" + dangilGumsaOrderYn
				+ ", dangilGumsaResultYn=" + dangilGumsaResultYn + ", dcGubun=" + dcGubun + ", dcYn=" + dcYn
				+ ", displayYn=" + displayYn + ", doctor=" + doctor + ", drgBunho=" + drgBunho + ", drgPackYn="
				+ drgPackYn + ", dv=" + dv + ", dv1=" + dv1 + ", dv2=" + dv2 + ", dv3=" + dv3 + ", dv4=" + dv4
				+ ", dv5=" + dv5 + ", dv6=" + dv6 + ", dv7=" + dv7 + ", dv8=" + dv8 + ", dvTime=" + dvTime
				+ ", emergency=" + emergency + ", fkocs2003=" + fkocs2003 + ", fkout1001=" + fkout1001 + ", fkout1003="
				+ fkout1003 + ", generalDispYn=" + generalDispYn + ", gongbiCode=" + gongbiCode + ", groupSer="
				+ groupSer + ", gwa=" + gwa + ", hangmogCode=" + hangmogCode + ", hangmogName=" + hangmogName
				+ ", homeCareYn=" + homeCareYn + ", hopeDate=" + hopeDate + ", hopeTime=" + hopeTime + ", hospCode="
				+ hospCode + ", hubalChangeYn=" + hubalChangeYn + ", ifActSendYn=" + ifActSendYn + ", ifDataSendDate="
				+ ifDataSendDate + ", ifDataSendYn=" + ifDataSendYn + ", imsiDrugYn=" + imsiDrugYn + ", inputGubun="
				+ inputGubun + ", inputId=" + inputId + ", inputPart=" + inputPart + ", inputTab=" + inputTab
				+ ", insteadDate=" + insteadDate + ", insteadId=" + insteadId + ", insteadTime=" + insteadTime
				+ ", insteadYn=" + insteadYn + ", ioGubun=" + ioGubun + ", jaeryoJundalYn=" + jaeryoJundalYn
				+ ", jubsuDate=" + jubsuDate + ", jubsuTime=" + jubsuTime + ", jundalPart=" + jundalPart
				+ ", jundalTable=" + jundalTable + ", jusa=" + jusa + ", jusaSpdGubun=" + jusaSpdGubun + ", mixGroup="
				+ mixGroup + ", movePart=" + movePart + ", muhyo=" + muhyo + ", naewonType=" + naewonType + ", nalsu="
				+ nalsu + ", ndayYn=" + ndayYn + ", nurseConfirmDate=" + nurseConfirmDate + ", nurseConfirmTime="
				+ nurseConfirmTime + ", nurseConfirmUser=" + nurseConfirmUser + ", nurseRemark=" + nurseRemark
				+ ", ocsFlag=" + ocsFlag + ", ordDanui=" + ordDanui + ", orderDate=" + orderDate + ", orderGubun="
				+ orderGubun + ", orderRemark=" + orderRemark + ", pay=" + pay + ", pharmacy=" + pharmacy
				+ ", pkocs1003c=" + pkocs1003c + ", portableYn=" + portableYn + ", postapproveYn=" + postapproveYn
				+ ", powderYn=" + powderYn + ", printYn=" + printYn + ", regularYn=" + regularYn + ", reserDate="
				+ reserDate + ", reserTime=" + reserTime + ", resultDate=" + resultDate + ", returnRemark="
				+ returnRemark + ", seq=" + seq + ", sgCode=" + sgCode + ", sgYmd=" + sgYmd + ", slipCode=" + slipCode
				+ ", sortFkocskey=" + sortFkocskey + ", sourceFkocs1003=" + sourceFkocs1003 + ", specimenCode="
				+ specimenCode + ", subSusul=" + subSusul + ", subulDanui=" + subulDanui + ", subulSuryang="
				+ subulSuryang + ", sunabDate=" + sunabDate + ", sunabSuryang=" + sunabSuryang + ", sunabTime="
				+ sunabTime + ", sunabYn=" + sunabYn + ", suryang=" + suryang + ", sutakYn=" + sutakYn + ", sysDate="
				+ sysDate + ", sysId=" + sysId + ", telYn=" + telYn + ", updDate=" + updDate + ", updId=" + updId
				+ ", wonyoiOrderYn=" + wonyoiOrderYn + ", xrtDrYn=" + xrtDrYn + ", getActBuseo()=" + getActBuseo()
				+ ", getActDoctor()=" + getActDoctor() + ", getActGwa()=" + getActGwa() + ", getActingDate()="
				+ getActingDate() + ", getActingDay()=" + getActingDay() + ", getActingTime()=" + getActingTime()
				+ ", getAfterActYn()=" + getAfterActYn() + ", getAmt()=" + getAmt() + ", getAntiCancerYn()="
				+ getAntiCancerYn() + ", getApproveDate()=" + getApproveDate() + ", getApproveId()=" + getApproveId()
				+ ", getApproveTime()=" + getApproveTime() + ", getApproveYn()=" + getApproveYn()
				+ ", getBannabConfirm()=" + getBannabConfirm() + ", getBannabYn()=" + getBannabYn() + ", getBichiYn()="
				+ getBichiYn() + ", getBogyongCode()=" + getBogyongCode() + ", getBogyongCodeSub()="
				+ getBogyongCodeSub() + ", getBomOccurYn()=" + getBomOccurYn() + ", getBomSourceKey()="
				+ getBomSourceKey() + ", getBunho()=" + getBunho() + ", getChisik()=" + getChisik()
				+ ", getDangilGumsaOrderYn()=" + getDangilGumsaOrderYn() + ", getDangilGumsaResultYn()="
				+ getDangilGumsaResultYn() + ", getDcGubun()=" + getDcGubun() + ", getDcYn()=" + getDcYn()
				+ ", getDisplayYn()=" + getDisplayYn() + ", getDoctor()=" + getDoctor() + ", getDrgBunho()="
				+ getDrgBunho() + ", getDrgPackYn()=" + getDrgPackYn() + ", getDv()=" + getDv() + ", getDv1()="
				+ getDv1() + ", getDv2()=" + getDv2() + ", getDv3()=" + getDv3() + ", getDv4()=" + getDv4()
				+ ", getDv5()=" + getDv5() + ", getDv6()=" + getDv6() + ", getDv7()=" + getDv7() + ", getDv8()="
				+ getDv8() + ", getDvTime()=" + getDvTime() + ", getEmergency()=" + getEmergency() + ", getFkocs2003()="
				+ getFkocs2003() + ", getFkout1001()=" + getFkout1001() + ", getFkout1003()=" + getFkout1003()
				+ ", getGeneralDispYn()=" + getGeneralDispYn() + ", getGongbiCode()=" + getGongbiCode()
				+ ", getGroupSer()=" + getGroupSer() + ", getGwa()=" + getGwa() + ", getHangmogCode()="
				+ getHangmogCode() + ", getHangmogName()=" + getHangmogName() + ", getHomeCareYn()=" + getHomeCareYn()
				+ ", getHopeDate()=" + getHopeDate() + ", getHopeTime()=" + getHopeTime() + ", getHospCode()="
				+ getHospCode() + ", getHubalChangeYn()=" + getHubalChangeYn() + ", getIfActSendYn()="
				+ getIfActSendYn() + ", getIfDataSendDate()=" + getIfDataSendDate() + ", getIfDataSendYn()="
				+ getIfDataSendYn() + ", getImsiDrugYn()=" + getImsiDrugYn() + ", getInputGubun()=" + getInputGubun()
				+ ", getInputId()=" + getInputId() + ", getInputPart()=" + getInputPart() + ", getInputTab()="
				+ getInputTab() + ", getInsteadDate()=" + getInsteadDate() + ", getInsteadId()=" + getInsteadId()
				+ ", getInsteadTime()=" + getInsteadTime() + ", getInsteadYn()=" + getInsteadYn() + ", getIoGubun()="
				+ getIoGubun() + ", getJaeryoJundalYn()=" + getJaeryoJundalYn() + ", getJubsuDate()=" + getJubsuDate()
				+ ", getJubsuTime()=" + getJubsuTime() + ", getJundalPart()=" + getJundalPart() + ", getJundalTable()="
				+ getJundalTable() + ", getJusa()=" + getJusa() + ", getJusaSpdGubun()=" + getJusaSpdGubun()
				+ ", getMixGroup()=" + getMixGroup() + ", getMovePart()=" + getMovePart() + ", getMuhyo()=" + getMuhyo()
				+ ", getNaewonType()=" + getNaewonType() + ", getNalsu()=" + getNalsu() + ", getNdayYn()=" + getNdayYn()
				+ ", getNurseConfirmDate()=" + getNurseConfirmDate() + ", getNurseConfirmTime()="
				+ getNurseConfirmTime() + ", getNurseConfirmUser()=" + getNurseConfirmUser() + ", getNurseRemark()="
				+ getNurseRemark() + ", getOcsFlag()=" + getOcsFlag() + ", getOrdDanui()=" + getOrdDanui()
				+ ", getOrderDate()=" + getOrderDate() + ", getOrderGubun()=" + getOrderGubun() + ", getOrderRemark()="
				+ getOrderRemark() + ", getPay()=" + getPay() + ", getPharmacy()=" + getPharmacy() + ", getPkocs1003()="
				+ getPkocs1003c() + ", getPortableYn()=" + getPortableYn() + ", getPostapproveYn()="
				+ getPostapproveYn() + ", getPowderYn()=" + getPowderYn() + ", getPrintYn()=" + getPrintYn()
				+ ", getRegularYn()=" + getRegularYn() + ", getReserDate()=" + getReserDate() + ", getReserTime()="
				+ getReserTime() + ", getResultDate()=" + getResultDate() + ", getReturnRemark()=" + getReturnRemark()
				+ ", getSeq()=" + getSeq() + ", getSgCode()=" + getSgCode() + ", getSgYmd()=" + getSgYmd()
				+ ", getSlipCode()=" + getSlipCode() + ", getSortFkocskey()=" + getSortFkocskey()
				+ ", getSourceFkocs1003()=" + getSourceFkocs1003() + ", getSpecimenCode()=" + getSpecimenCode()
				+ ", getSubSusul()=" + getSubSusul() + ", getSubulDanui()=" + getSubulDanui() + ", getSubulSuryang()="
				+ getSubulSuryang() + ", getSunabDate()=" + getSunabDate() + ", getSunabSuryang()=" + getSunabSuryang()
				+ ", getSunabTime()=" + getSunabTime() + ", getSunabYn()=" + getSunabYn() + ", getSuryang()="
				+ getSuryang() + ", getSutakYn()=" + getSutakYn() + ", getSysDate()=" + getSysDate() + ", getSysId()="
				+ getSysId() + ", getTelYn()=" + getTelYn() + ", getUpdDate()=" + getUpdDate() + ", getUpdId()="
				+ getUpdId() + ", getWonyoiOrderYn()=" + getWonyoiOrderYn() + ", getXrtDrYn()=" + getXrtDrYn()

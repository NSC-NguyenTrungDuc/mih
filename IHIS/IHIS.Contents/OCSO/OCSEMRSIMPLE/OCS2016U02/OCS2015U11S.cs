...
namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U11S : XScreen
    {
        private OCS2016U02 mainScreen;

        #region Contructor
        public OCS2015U11S(OCS2016U02 mainScreen)
        {
        ...
        private void SetExpanded()
        {
            ...
            /*mainScreen.ctlEmrDocker.dockPanel3.Size = new Size(mainScreen.ctlEmrDocker.dockPanel3.Size.Width,
                mainScreen.MExpandedSize);*/
            mainScreen.ctlEmrDocker.dockPanel3.Size = new Size(mainScreen.ctlEmrDocker.dockPanel3.Size.Width,(this.mainScreen.Height - 20));                
        ...
        private void grdReserOrderList_QueryEnd(object sender, QueryEndEventArgs e)
        {
            ...
            else
            {
                ...
                this.pnlReserOrderList.Width = 33;
        ...
        {
            if (this.pnlReserOrderList.Width > 33)
            {
                /*this.pnlReserOrderList.Width = 50;*/
                this.pnlReserOrderList.Width = 33;
                this.btnReserListExpend.Image = this.ImageList.Images[46];
            ...
            {
                //this.pnlReserOrderList.Width = 277;
                this.pnlReserOrderList.Width = 220;
                this.btnReserListExpend.Image = this.ImageList.Images[45];
            }
        }
        ...
        {
            tooltip1.SetToolTip(pnlReserOrderList, Resources.OCS2015U11S_Tooltip_PnlReserOrderList);
            tooltip1.SetToolTip(btnReserListExpend, Resources.OCS2015U11S_Tooltip_PnlReserOrderList);
            tooltip1.SetToolTip(xLabel14, Resources.OCS2015U11S_Tooltip_PnlReserOrderList);
            tooltip1.SetToolTip(xPanel7, Resources.OCS2015U11S_Tooltip_PnlReserOrderList);
            tooltip1.SetToolTip(grdReserOrderList, Resources.OCS2015U11S_Tooltip_PnlReserOrderList);

...
public class ChartAxisBase: ChartComponentBase
{
    ...
    // @QuyTM : Add property to draw a rectangle base on [min] and [max] value and [color] depend on Axis's value
    public var rangeViewMax         : CGFloat = 0.0
    public var rangeViewMin         : CGFloat = 0.0
    public var rangeViewColor       : NSUIColor? = NSUIColor.init(red: 0, green: 0, blue: 0, alpha: 0)
    public var drawRangeViewColor   : Bool = false

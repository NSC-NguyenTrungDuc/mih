...
public class MailServiceImpl implements MailService{
	...
	@Autowired
	public MailServiceImpl(JavaMailSender mailSender, SimpleMailMessage templateMessage, IhisMailTemplateRepository ihisMailTemplateRepository) {
		this.mailSender = mailSender;
		this.templateMessage = templateMessage;
		this.ihisMailTemplateRepository = ihisMailTemplateRepository;
	}
	...
	@Override
	@Async
	public void sendMail(String templateCode, String hospitalId, String language, MailInfo mailInfo, String email, String vpnPath) {
		try {
			Map<String, Object> templateVariables = new HashMap<String, Object>();
			IhisMailTemplate mailTemplate = new IhisMailTemplate();
	        templateVariables.put("mailInfo", mailInfo);
	        List<IhisMailTemplate> mailTemplateList = ihisMailTemplateRepository.findByMailTemplate(templateCode, language);
...
//                message.setFrom(new InternetAddress(templateMessage.getFrom(), "Tran Minh Hao"));

...
import nta.med.service.ihis.proto.SystemServiceProto.OBGetBogyongInfo1Request;
...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class OBGetBogyongInfo1Handler
	extends ScreenHandler<SystemServiceProto.OBGetBogyongInfo1Request, SystemServiceProto.OBGetBogyongResponse>{                     
	@Resource                                                                                                       
	...
	public OBGetBogyongResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId, OBGetBogyongInfo1Request request)
			throws Exception {                                                                  

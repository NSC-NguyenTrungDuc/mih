...
/**
 * The persistent class for the PFE0104 database table.
 * 
 */
@Entity
@NamedQuery(name="Pfe0104.findAll", query="SELECT p FROM Pfe0104 p")
public class Pfe0104 extends BaseEntity {

...
public class DRG3010P10DsvJusaLabel1Info {
	...
	public DRG3010P10DsvJusaLabel1Info(String bunho, String drgBunho, String orderDateText, String jubsuDate,
			String hopeDate, String orderDate, String serialV, String serialText, String suname, String suname2,
			String sexAge, String hoCode, String hoDong, String bogyongName, Double cnt) {
		super();
		this.bunho = bunho;

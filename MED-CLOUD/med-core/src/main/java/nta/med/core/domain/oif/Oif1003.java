...
/**
 * The persistent class for the OIF1003 database table.
 * 
 */
@Entity
@NamedQuery(name="Oif1003.findAll", query="SELECT o FROM Oif1003 o")
public class Oif1003 extends BaseEntity {

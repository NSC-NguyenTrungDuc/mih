...
@Service                                                                                                          
@Scope("prototype")
public class OUT1001P03GrdBeforeOrderHandler extends ScreenHandler<NuroServiceProto.OUT1001P03GrdBeforeOrderRequest, NuroServiceProto.OUT1001P03GrdBeforeOrderResponse> {                             
	@Resource                                                                                                       
	private Ocs0132Repository ocs0132Repository;                                                                    

	@Override
	@Transactional(readOnly = true)
	public NuroServiceProto.OUT1001P03GrdBeforeOrderResponse handle(Vertx vertx, String clientId,
			String sessionId, long contextId,
			NuroServiceProto.OUT1001P03GrdBeforeOrderRequest request) throws Exception {
		NuroServiceProto.OUT1001P03GrdBeforeOrderResponse.Builder response = NuroServiceProto.OUT1001P03GrdBeforeOrderResponse.newBuilder(); 

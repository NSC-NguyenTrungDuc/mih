...
/**
 * The persistent class for the OIF2101 database table.
 * 
 */
@Entity
@NamedQuery(name="Oif2101.findAll", query="SELECT o FROM Oif2101 o")
public class Oif2101 extends BaseEntity {

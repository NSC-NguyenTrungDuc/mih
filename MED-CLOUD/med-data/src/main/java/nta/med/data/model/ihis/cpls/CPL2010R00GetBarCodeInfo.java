...
public class CPL2010R00GetBarCodeInfo {
	...
	public CPL2010R00GetBarCodeInfo(String jundalGubun, String jundalGubunName,
			String specimenCode, String specimenName, String tubeCode,
			String tubeName, String inOutGubun, String specimenSer,
			String bunho, String suname, String gwaName, String dangerYn,
			String specimenSerBa, String jangbiCode, String jangbiName,
			String gumsaNameRe, String tubeCount, String tubeMaxAmt,
			String tubeNumbering) {
		super();

...
{[Serializable]
    ...
    {
    protected bool Equals(XRT1002U00LayOrderByJundalPartArgs other)
    {
        return string.Equals(_orderDate, other._orderDate) && string.Equals(_inOutGubun, other._inOutGubun) && string.Equals(_fkout1001, other._fkout1001) && string.Equals(_printDate, other._printDate) && string.Equals(_printOnly, other._printOnly) && string.Equals(_jundalPart, other._jundalPart) && string.Equals(_pkocs, other._pkocs) && string.Equals(_fkinp1001, other._fkinp1001);
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((XRT1002U00LayOrderByJundalPartArgs) obj);
    }
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            hashCode = (hashCode*397) ^ (_printDate != null ? _printDate.GetHashCode() : 0);

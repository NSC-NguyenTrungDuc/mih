...
@Service
@Scope("prototype")
public class INJ1002R01LayQuery1Handler extends ScreenHandler<InjsServiceProto.INJ1002R01LayQuery1Request, InjsServiceProto.INJ1002R01LayQueryResponse>{
	private static final Log LOG = LogFactory.getLog(INJ1002R01LayQuery1Handler.class);
	@Resource
	private Inj1002Repository inj1002Repository;
	
	@Override
	public boolean isValid(InjsServiceProto.INJ1002R01LayQuery1Request request, Vertx vertx, String clientId, String sessionId) {
	...
	public InjsServiceProto.INJ1002R01LayQueryResponse handle(Vertx vertx, String clientId,
			...
			InjsServiceProto.INJ1002R01LayQuery1Request request) throws Exception {
		InjsServiceProto.INJ1002R01LayQueryResponse.Builder response = InjsServiceProto.INJ1002R01LayQueryResponse.newBuilder();
		List<INJ1002R01LayQueryListItemInfo> listResult = inj1002Repository.INJ1002R01LayQuery1(getHospitalCode(vertx, sessionId), getLanguage(vertx, sessionId), request.getFromDate(), request.getToDate());

		...
		<div class="row">
            ...
            <div class="col-md-4 col-xs-offset-4">
            	<div class="error-page" align="center">  
                	<p class="error-sorry">Sorry, you don't have permission to access this page.Please contact Administrator!</p>
                    <h1 class="error-type">403<span>Access Denied</span></h1>   
                    
                    <%--<p class="error-reason">Page doesn't exist or some other error occured.<br />Go to our <a href="#">home page</a> or go back to <a href="#">previous page</a>.</p>--%>
                </div>                                
            </div>
		</div>
	</div>

...
@Service
@Scope("prototype")
public class DrgsDRG5100P01PaidJubsuListHandler extends ScreenHandler<DrgsServiceProto.DrgsDRG5100P01PaidJubsuListRequest, DrgsServiceProto.DrgsDRG5100P01PaidOrderListResponse> {
    private static final Log LOG = LogFactory.getLog(DrgsDRG5100P01PaidJubsuListHandler.class);
    @Resource
    private Drg2010Repository drg2010Repository;

    @Override
    public boolean isValid(DrgsServiceProto.DrgsDRG5100P01PaidJubsuListRequest request, Vertx vertx, String clientId, String sessionId) {
    ...
    public DrgsServiceProto.DrgsDRG5100P01PaidOrderListResponse handle(Vertx vertx, String clientId, String sessionId, long contextId, DrgsServiceProto.DrgsDRG5100P01PaidJubsuListRequest request) throws Exception {

...
namespace IHIS.OCSO.AdditionalBusiness
{
    ...
    internal static class AdditionalBusiness
    {
        ...
        public static void CalendarBehavior(object sender, XCalendarDayClickEventArgs e, EmrDocket ctlEmrDocker, OCS2015U03 tvExamHist, OCS2015U02 cldExamDates)
        {
        ...
        /// <returns></returns>
        private static int CheckNumberOfRequestInSelectedDate(DateTime dateTime, out List<NuroPatientReceptionHistoryListItemInfo> examList, OCS2015U02 cldExamDates)
        {
            int res = 0;

...
public class MailInfoModel implements Serializable{
	...
	/** The mail info list. */
	private List<MailInfoModel> mailInfoList;
	 ...
	 */
	public List<MailInfoModel> getMailInfoList() {
		return mailInfoList;
	}
	 ...
	 */
	public void setMailInfoList(List<MailInfoModel> mailInfoList) {

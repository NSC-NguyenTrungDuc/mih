...
public class OcsoOCS1003Q05DiseaseListItemInfo {
	...
	private Timestamp sangJindanDate;
	private String orderByKey;
	public OcsoOCS1003Q05DiseaseListItemInfo(String juSangYn, String sangCode,
			String gwaName, Double ser, String disSangName,
			Timestamp sangStartDate, Timestamp sangEndDate, String sangEndSayu,
			String sangEndSayuName, String bunho, Timestamp naewonDate,
			String gwa, String doctor, String naewonType, Double jubsuNo,
			String pkOrder, String sangName, String preModifier1,
			...
			String postModifierName, Timestamp sangJindanDate, String orderByKey) {
		super();
	...
	public Timestamp getSangEndDate() {
		return sangEndDate;
	}
	public void setSangEndDate(Timestamp sangEndDate) {
		this.sangEndDate = sangEndDate;
	}
	...
	public Timestamp getSangJindanDate() {
		return sangJindanDate;
	}
	public void setSangJindanDate(Timestamp sangJindanDate) {
		this.sangJindanDate = sangJindanDate;
	}

...
public class DRG3010P99OrdPrnSerialInfo {
	private String bunho;
	private String drgBunho;
	private String groupSer;
	private String jusbuDate;
	...
	public DRG3010P99OrdPrnSerialInfo( String bunho,
			 String drgBunho,
			 String groupSer,
			 String jusbuDate,
			 String orderDate,
			 ...
			 String toOrderDate,
			 String dataGubun,
			 String hodongOrdName,
			 String maxBannabYn){		
		this.bunho = bunho;
		this.drgBunho = drgBunho;
		this.groupSer = groupSer;
		this.jusbuDate = jusbuDate;
	...
	public String getJusbuDate() {
		return jusbuDate;
	}

	public void setJusbuDate(String jusbuDate) {
		this.jusbuDate = jusbuDate;
	}
	...
	public String getOrderDanui2() {
		return orderDanui2;
	}

	public void setOrderDanui2(String orderDanui2) {
		this.orderDanui2 = orderDanui2;
	}

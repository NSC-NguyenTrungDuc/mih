...
import nta.med.service.ihis.proto.SystemServiceProto.FormEnvironInfoSysDateRequest;
...
@Service                                                                                                          
@Scope("prototype")   
public class FormEnvironInfoSysDateHandler
	extends ScreenHandler<SystemServiceProto.FormEnvironInfoSysDateRequest, SystemServiceProto.StringResponse>{                     
	@Resource
	...
	public StringResponse handle(Vertx vertx, String clientId,
			...
			FormEnvironInfoSysDateRequest request) throws Exception {                                                                 
		...
		String result = commonRepository.getFormEnvironInfoSysDate(offset, DateUtil.PATTERN_YYMMDD);

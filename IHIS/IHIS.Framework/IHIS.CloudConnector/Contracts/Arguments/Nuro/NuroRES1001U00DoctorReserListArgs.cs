...
namespace IHIS.CloudConnector.Contracts.Arguments.Nuro
{
    ...
    {
        protected bool Equals(NuroRES1001U00DoctorReserListArgs other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NuroRES1001U00DoctorReserListArgs) obj);
        }
        ...
        public NuroRES1001U00DoctorReserListArgs(String patientCode, String hospCodeLink, Boolean tabIsAll)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.NuroRES1001U00DoctorReserListRequest();
        }
    }
}
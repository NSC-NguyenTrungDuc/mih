...
public class DRG3010P99PaPrnInfo {
	...
	public DRG3010P99PaPrnInfo( String bunho, String suname, String sex, String age, String resident, String doctorName, String magamYn, String hoDong,
			String hoDongName, String hoCode, String juninpYn, String hopeDate, String hopeTime, Double pkinp1001, String toiwonYn, String gwa, String orderDate,
			String emergency, String magamGubun, String jusaYn){
		this.bunho = bunho;
		this.suname = suname;
		this.sex = sex;
		this.age = age;

...
@Service                                                                                                          
@Scope("prototype")                                                                                 
public class OCS2015U09GetRootTagsForContextHandler extends ScreenHandler<EmrServiceProto.OCS2015U09GetRootTagsForContextRequest, EmrServiceProto.OCS2015U09GetRootTagsForContextResponse> {
	private static final Log LOGGER = LogFactory.getLog(OCS2015U09GetRootTagsForContextHandler.class);                                    
	@Resource                                                                                                       
	private EmrTagRepository emrTagRepository;

	@Override
	@Transactional(readOnly = true)
	public EmrServiceProto.OCS2015U09GetRootTagsForContextResponse handle(Vertx vertx, String clientId, String sessionId, long contextId, EmrServiceProto.OCS2015U09GetRootTagsForContextRequest request) throws Exception {
		EmrServiceProto.OCS2015U09GetRootTagsForContextResponse.Builder response = EmrServiceProto.OCS2015U09GetRootTagsForContextResponse.newBuilder();
		List<OCS2015U09GetTagsForContextInfo> list = emrTagRepository.getOCS2015U09GetTagsRootForContextInfo(getHospitalCode(vertx, sessionId));

...
public class ClickatellHttp {
	...
	public Message sendUnicodeMessage(String number, String messageContent, String unicode)
			throws Exception {
		// Build Parameters:
		String urlParameters = "user="
				+ URLEncoder.encode(this.userName, "UTF-8") + "&api_id="
				...
				+ URLEncoder.encode(this.password, "UTF-8") + "&to="
				+ URLEncoder.encode(number, "UTF-8") + "&text="
				+ URLEncoder.encode(messageContent, "UTF-8") +"&unicode="
				+ URLEncoder.encode(unicode, "UTF-8");

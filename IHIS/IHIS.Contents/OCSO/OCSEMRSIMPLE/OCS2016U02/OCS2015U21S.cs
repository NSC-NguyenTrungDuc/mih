...
namespace IHIS.OCSO
{
    ...
    public partial class OCS2015U21S : XScreen
    {
        private readonly OCS2016U02 mainScreen;
        bool flag = true;
        private int QueryTime;
        public OCS2015U21S(OCS2016U02 mainScreen)
        {
        ...
        internal void Control_DataValidating(object sender, DataValidatingEventArgs e)
        {
            ...
            switch (control.Name)
            {
                ...
                case "fbxBunho": // ★注意:TextBoxから直接入力される場合もあるので<< this.grdPatientList.CurrentRowNumber >>使用禁止
                    ...
                    mainScreen.ResetOcsEmrData(true);
                    ...
                    if (mainScreen.MDoctorLogin && approveOrderCnt > 0)
                    {
                        ...
                        /*mainScreen.btnApprove_Click(this, new EventArgs());*/
                    }
            ...
            if (e.Button == MouseButtons.Left && e.Clicks == 2)
            {
                ...
                if (rowNumber >= 0)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (MessageBox.Show("共通医受付患者です。診療を開始しますか？", "確認", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
                                return;
                            else
                            {
                                if (mainScreen.MDoctorLogin)

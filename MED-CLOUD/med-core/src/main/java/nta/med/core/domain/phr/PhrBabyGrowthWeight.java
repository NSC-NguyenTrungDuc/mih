...
/**
 * The persistent class for the phr_baby_growth_weight database table.
 * 
 */
@Entity
@Table(name="PHR_BABY_GROWTH_WEIGHT")
@NamedQuery(name="PhrBabyGrowthWeight.findAll", query="SELECT p FROM PhrBabyGrowthWeight p")
public class PhrBabyGrowthWeight extends PhrBaseEntity implements TimeLineDate {

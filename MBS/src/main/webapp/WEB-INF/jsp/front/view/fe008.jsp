...
<div class="modal-mt-history fade bs-example-modal-sm" id="confirmation" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                	 ...
                                	 <div class="table-responsive">
			                                ...
			                                <table id="tableAjax"  class="table table-bordered table-striped table-green">
			                                    <thead>
			                                      <tr>
			                                      	<th></th>
			                                        <th ><spring:message code="fed13.movieTalkHistory.department" /></th>
			                                        <th ><spring:message code="fed13.movieTalkHistory.dateExam" /></th>
			                                        <th ><spring:message code="fed13.movieTalkHistory.duration" /></th>
			                                        <th></th>
			                                        <th></th>
			                                      </tr>
			                                    </thead>
...
$(document).ready(function() {
   ...
   <script type="text/javascript" src="<c:url value='/assets/js/doctor/PatientMovietalkHistory.js'/>" ></script>
